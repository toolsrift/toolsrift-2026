  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="All 669+ ToolsRift tools are completely free during our launch. Pro plans with advanced features will be available soon." />
        <meta property="og:title" content="Pro Plans Coming Soon — ToolsRift" />
        <meta property="og:description" content="All 669+ tools are completely free during our launch. Pro plans coming soon." />
        ...
        <div style={{ textAlign: 'center', padding: '100px 20px 80px', position: 'relative' }}>
          ...
          <div style={{ position: 'relative', zIndex: 1, maxWidth: 560, margin: '0 auto' }}>
            ...
            <p style={{ fontSize: 16, color: S.muted, lineHeight: 1.8, marginBottom: 40 }}>
              All 669+ tools are completely free during our launch. Pro plans with advanced features will be available soon.
            </p>
