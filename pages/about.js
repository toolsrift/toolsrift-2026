...
const STATS = [
  { num: '1,136+', label: 'Free Tools', icon: '🛠️', color: '#6366F1' },
  { num: '24',   label: 'Categories', icon: '📂', color: '#10B981' },
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="ToolsRift is a free online tools platform with 1,136+ tools across 29 Categories. Built for speed, privacy and accessibility. No signup, no limits." />
        <meta property="og:title" content="About ToolsRift — Free Online Tools Platform" />
        <meta property="og:description" content="1,136+ free online tools built for speed, privacy and everyone. No signup required." />
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "description": "Free online tools platform with 1,136+ tools across 29 Categories.",
      ...
      <div style={{ background: C.bg, minHeight: '100vh', fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif", color: C.text }}>
        ...
        <section style={{ padding: '0 24px 72px', maxWidth: 780, margin: '0 auto' }}>
          ...
          <div style={{ background: C.surface, border: `1px solid ${C.borderLight}`, borderRadius: 20, padding: 'clamp(28px,4vw,48px)' }}>
            ...
            <p style={{ fontSize: 15, color: C.muted, lineHeight: 1.85, margin: '0 0 20px' }}>
              We built ToolsRift to fix that. Starting with 1,136 tools across 29 Categories — and growing toward 1,600+ — every tool on ToolsRift runs entirely in your browser. Your files never leave your device. Your data is never sold.
            </p>
        ...
        <section style={{ padding: '0 24px 72px', maxWidth: 860, margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: 40 }}>
            ...
            <h2 style={{ fontSize: 'clamp(22px,3.5vw,34px)', fontWeight: 800, color: C.text, fontFamily: "'Sora', sans-serif", margin: '0 0 12px' }}>29 Categories. 1,136 Tools.</h2>
