  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta property="og:image:alt" content="ToolsRift — 947+ Free Online Tools" />
        ...
        <meta name="twitter:image:alt" content="ToolsRift — 947+ Free Online Tools" />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              description: '947+ free online tools for everyone',
              inLanguage: 'en-US',
              potentialAction: {
                '@type': 'SearchAction',
