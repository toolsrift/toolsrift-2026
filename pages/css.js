...
const ToolsRiftCss = dynamic(() => import('../components/toolsrift-css'), { ssr: false, loading: CategoryLoading })
export default function Css() {
  return (<><Head>
      ...
      </Head><ToolsRiftCss /><CategoryContent data={categoryContent.css} /></>)
}
