...
const TOOL_CONTENT = {
  ...
  'fd-calc': {
    intro:
      'Calculates the maturity value of a fixed deposit using quarterly compounding, which is ' +
      'what Indian banks use, with a year-by-year breakdown of the interest earned.',
    sections: [
      {
        h: 'Quarterly compounding is why the return beats the headline rate',
        p: 'A 7% FD does not pay 7% a year. Interest is compounded quarterly, so the effective ' +
           'annual yield is (1 + 0.07/4)⁴ − 1 ≈ 7.19%. Over five years on ₹1,00,000 that difference ' +
           'is several thousand rupees against simple annual compounding. Banks advertise the ' +
           'nominal rate, so comparing two deposits means comparing effective yields — and a deposit ' +
           'compounding monthly beats one compounding quarterly at the same nominal rate, which is ' +
           'worth checking rather than assuming.',
      },
      {
        h: 'Cumulative and non-cumulative are different products',
        p: 'A cumulative FD reinvests the interest and pays everything at maturity, which is what ' +
           'this calculation models and what maximises the return. A non-cumulative FD pays interest ' +
           'out monthly, quarterly or annually, so nothing compounds and the total is lower — chosen ' +
           'by people who need the income stream, typically retirees. If you are comparing quoted ' +
           'maturity values between banks, check you are comparing the same type.',
      },
      {
        h: 'Tax is deducted at source and is not optional',
        p: 'Interest on an FD is fully taxable as income at your slab rate. Banks deduct TDS at 10% ' +
           'once interest across your deposits with them exceeds ₹40,000 in a financial year, or ' +
           '₹50,000 for senior citizens, and at 20% if PAN is not provided. TDS is not the final tax ' +
           '— if your slab is higher you owe the difference at filing, and if your total income is ' +
           'below the threshold you can file Form 15G or 15H to avoid deduction. The maturity figure ' +
           'here is pre-tax.',
      },
      {
        h: 'Breaking an FD early costs more than the lost interest',
        p: 'Premature withdrawal usually attracts a penalty of 0.5% to 1%, and — the part people ' +
           'miss — the interest is recalculated at the rate applicable for the period actually held, ' +
           'not the rate you booked. Break a five-year deposit at eighteen months and you earn the ' +
           'eighteen-month rate minus the penalty, which can be substantially less than expected. ' +
           'Laddering several smaller deposits with staggered maturities gives access to some of the ' +
           'money without breaking all of it.',
      },
    ],
    steps: [
      'Enter the principal amount.',
      'Enter the annual interest rate the bank quotes.',
      'Set the tenure in years.',
      'Read the maturity value, total interest and the year-by-year growth.',
    ],
    notes: [
      'Compounding is quarterly, the standard for Indian bank fixed deposits.',
      'The maturity figure is before tax; FD interest is taxed at your income slab rate.',
      'Senior citizens typically receive 0.25% to 0.50% above the standard rate.',
    ],
    faq: [
      ['How is FD interest calculated?',
       'Quarterly compounding at Indian banks: the maturity value is P × (1 + r/4)^(4t). A 7% ' +
       'nominal rate gives an effective annual yield of about 7.19%, because each quarter\'s ' +
       'interest earns interest for the rest of the term.'],
      ['Is FD interest taxable?',
       'Yes, fully, at your income tax slab rate. Banks deduct TDS at 10% once interest exceeds ' +
       '₹40,000 in a year (₹50,000 for senior citizens), but that is an advance payment rather ' +
       'than the final liability — you settle the difference when filing.'],
      ['What happens if I break an FD early?',
       'You pay a penalty, usually 0.5% to 1%, and the interest is recalculated at the rate for ' +
       'the period you actually held it rather than the booked rate. On a long deposit broken ' +
       'early that combination can cost considerably more than the penalty alone suggests.'],
    ],
  },
  'discount-calculator': {
    intro:
      'Works out the sale price after a discount, the amount saved, and the original price from ' +
      'a discounted one. Also handles stacked discounts, which do not add up the way people ' +
      'expect.',
    sections: [
      {
        h: 'Stacked discounts multiply, they do not add',
        p: '“20% off, then an extra 10% off” is not 30% off. The second discount applies to the ' +
           'already-reduced price, so ₹1,000 becomes ₹800 and then ₹720 — a total of 28%, not 30%. ' +
           'The arithmetic is 0.8 × 0.9 = 0.72. The gap widens with larger discounts: 50% then 50% ' +
           'is 75% off, not free. Retailers rely on this reading better than it computes, and the ' +
           'order of two percentage discounts makes no difference to the result, though the order of ' +
           'a percentage and a fixed amount does.',
      },
      {
        h: 'Working backwards from a sale price',
        p: 'To recover the original price, divide rather than adding the percentage back. A ₹720 ' +
           'item at 28% off was ₹1,000 — 720 ÷ 0.72 — and adding 28% to 720 gives ₹922, which is ' +
           'wrong. This is the same error as adding tax back to a tax-inclusive total, and it ' +
           'appears constantly in mispriced listings and invoice disputes. The rule: to remove a ' +
           'percentage that was applied, divide by (1 − rate).',
      },
      {
        h: 'Judging whether a discount is real',
        p: 'A discount is only meaningful against a price at which the item genuinely sold. ' +
           'Inflating a “was” price before a sale is restricted in many jurisdictions — EU rules ' +
           'require the advertised prior price to be the lowest charged in the previous 30 days, and ' +
           'the UK and India have comparable provisions — but enforcement varies and the practice ' +
           'persists. Price history tools tell you what an item actually cost before, which is the ' +
           'only number that makes a percentage meaningful.',
      },
    ],
    steps: [
      'Enter the original price and the discount percentage.',
      'Read the sale price and the amount saved.',
      'For stacked discounts, apply them one after another rather than adding them.',
    ],
    notes: [
      'Two stacked percentage discounts multiply: 20% then 10% is 28% off, not 30%.',
      'To recover an original price, divide by (1 − discount), never add the percentage back.',
      'A percentage-off and a fixed-amount-off give different results depending on the order ' +
       'applied.',
    ],
    faq: [
      ['How do I calculate 20% off a price?',
       'Multiply by 0.8, or work out 10% and double it to get the saving. ₹1,500 at 20% off is ' +
       '₹1,200, saving ₹300.'],
      ['If something is 20% off and then 10% off, is that 30% off?',
       'No — it is 28%. The second discount applies to the already-reduced price: 0.8 × 0.9 = ' +
       '0.72. Stacked discounts always total less than their sum, and the gap grows as the ' +
       'discounts get larger.'],
      ['How do I find the original price from a sale price?',
       'Divide by one minus the discount rate. An item at ₹720 after 28% off was ₹1,000, since ' +
       '720 ÷ 0.72 = 1000. Adding the percentage back gives the wrong answer.'],
    ],
  },
  ...
  'world-clock': {
    intro:
      'Shows the current time in cities around the world at once, for scheduling calls and ' +
      'knowing whether it is a reasonable hour to message someone.',
    sections: [
      {
        h: 'Offsets are not fixed, which is why fixed schedules drift',
        p: 'A recurring meeting set at a fixed UTC time drifts relative to everyone\'s local clock as ' +
           'daylight saving starts and ends — and it does not change on the same date everywhere. ' +
           'The US switches in March and November, the EU in late March and late October, and the ' +
           'southern hemisphere in the opposite season. For a few weeks each year the usual gap ' +
           'between two cities is an hour different from normal, which is the period when recurring ' +
           'calls quietly land at the wrong time for half the participants.',
      },
      {
        h: 'The offsets that catch people out',
        p: 'India is UTC+5:30, a half-hour offset shared by Sri Lanka and used with variations by ' +
           'Iran, Afghanistan and parts of Australia. Nepal is UTC+5:45, a quarter-hour offset. ' +
           'China spans five geographic time zones and uses one, so sunrise in Xinjiang is around ' +
           '10am by the clock. And the date line means a call between India and California crosses ' +
           'midnight in one direction — 9am in Bengaluru is 8:30pm the previous day in San ' +
           'Francisco.',
      },
      {
        h: 'Scheduling across many zones',
        p: 'The overlap between India and the US west coast is roughly two hours at either end of ' +
           'the working day, which is why Indian teams serving US clients commonly start late or ' +
           'finish late rather than finding a comfortable middle. When scheduling, name the time ' +
           'zone explicitly and prefer a calendar invitation over a stated time — the invitation ' +
           'converts for each recipient and survives daylight saving changes, which a written time ' +
           'does not. “3pm IST” in an email is a recurring source of missed meetings.',
      },
    ],
    steps: [
      'Read the current time across the listed cities.',
      'Find an hour that falls within working hours for everyone involved.',
      'Send a calendar invitation rather than a written time, so it converts correctly for each ' +
       'person.',
    ],
    notes: [
      'Daylight saving starts and ends on different dates by country, so the gap between two ' +
       'cities is not constant.',
      'India is UTC+5:30 and Nepal UTC+5:45 — half and quarter-hour offsets are common in Asia.',
      'Times update live from your device\'s clock.',
    ],
    faq: [
      ['What is the time difference between India and the US?',
       'India is UTC+5:30, so it is 9.5 to 12.5 hours ahead of the US mainland depending on the ' +
       'zone and whether daylight saving is in effect. The difference changes twice a year, ' +
       'because India does not observe daylight saving and the US does.'],
      ['Why does China have only one time zone?',
       'A political decision made in 1949 — the whole country runs on Beijing time despite ' +
       'spanning roughly five geographic zones. In the far west this means the sun rises around ' +
       '10am by the official clock, and some regions informally keep local time alongside it.'],
      ['How do I schedule a meeting across time zones?',
       'Send a calendar invitation rather than writing a time in a message. The invitation ' +
       'converts to each recipient\'s local zone automatically and handles daylight saving ' +
       'changes, which a written “3pm IST” does not.'],
    ],
  },
  ...
  'list-shuffler': {
    intro:
      'Randomises the order of a list using a Fisher–Yates shuffle, which produces every ' +
      'possible ordering with equal probability. For draw orders, team assignments, randomised ' +
      'task lists and study cards.',
    sections: [
      {
        h: 'Why the shuffle algorithm matters',
        p: 'The obvious approach — sorting with a comparator that returns a random value — does not ' +
           'produce a uniform shuffle. Sort algorithms assume a consistent comparator, and a random ' +
           'one breaks that assumption in ways that leave items statistically close to where they ' +
           'started, with some orderings far more likely than others. Fisher–Yates walks the list ' +
           'once, swapping each position with a randomly chosen earlier one, and provably produces ' +
           'every permutation with equal probability. It is also faster.',
      },
      {
        h: 'Shuffling is not the same as random picking',
        p: 'A shuffle is a permutation: every item appears exactly once, in a new order. Picking at ' +
           'random from a list draws independently, so items can repeat and some may never come up. ' +
           'Which you want depends on the situation — assigning a presentation order needs a ' +
           'shuffle, picking a prize winner needs a draw, and running through flashcards without ' +
           'repeats needs a shuffle that you re-run once exhausted.',
      },
      {
        h: 'The number of possible orderings is vast',
        p: 'Ten items have 3.6 million possible orders; twenty have more than two quintillion. This ' +
           'is why a shuffled playlist never repeats an ordering in practice, and why “that shuffle ' +
           'wasn\'t random” complaints are usually about human pattern-seeking rather than the ' +
           'algorithm. Genuine randomness produces clusters — three songs by the same artist in a ' +
           'row is unremarkable — and several music services deliberately de-randomise their shuffle ' +
           'to spread artists out, precisely because true randomness feels wrong to listeners.',
      },
    ],
    steps: [
      'Paste your list, one item per line.',
      'Shuffle, and copy the new order.',
      'Shuffle again for a different ordering — each is independent of the last.',
    ],
    notes: [
      'Uses a Fisher–Yates shuffle, so every ordering is equally likely.',
      'Every item appears exactly once — this is a reordering, not a random draw.',
      'Blank lines are ignored; the list stays in your browser.',
    ],
    faq: [
      ['Is this shuffle actually random?',
       'Yes. It uses Fisher–Yates, which provably produces every possible ordering with equal ' +
       'probability — unlike sorting with a random comparator, which is the common shortcut and ' +
       'is measurably biased.'],
      ['What is the difference between shuffling and picking randomly?',
       'A shuffle reorders the whole list with every item appearing exactly once. Random picking ' +
       'draws independently, so items can repeat and some may never be chosen. Use a shuffle for ' +
       'an order, a draw for a winner.'],
      ['Why does my shuffled list look like it has patterns?',
       'Because genuine randomness contains clusters, and people are very good at spotting ' +
       'patterns that are not there. Runs and groupings are expected; a shuffle that spread ' +
       'everything out evenly would in fact be the non-random one.'],
    ],
  },
  ...
  'uuid-gen': {
    intro:
      'Generates version 4 UUIDs in bulk, with optional uppercase and brace formatting. The ' +
      'identifier you use when two systems each need to invent a unique key without ' +
      'coordinating.',
    sections: [
      {
        h: 'Why you can generate them offline and still not collide',
        p: 'A v4 UUID carries 122 random bits, with six fixed for version and variant. The collision ' +
           'probability is so small that generating a billion a second for a century leaves the ' +
           'chance of a single duplicate negligible. That is what allows a phone in flight mode, a ' +
           'batch job and a server to each mint identifiers and merge them into a shared database ' +
           'later without a central allocator — which is the entire reason UUIDs exist rather than ' +
           'sequential integers.',
      },
      {
        h: 'The cost as a database primary key',
        p: 'Random UUIDs scatter inserts across a B-tree index instead of appending, which fragments ' +
           'pages and hurts write throughput and cache behaviour on large tables. They are also 16 ' +
           'bytes against 4 or 8 for an integer, multiplied across every foreign key and index. On a ' +
           'small table none of this is visible; at tens of millions of rows it is measurable. ' +
           'Version 7 UUIDs, standardised in 2024, put a millisecond timestamp in the high bits so ' +
           'they sort chronologically and append cleanly — the same offline generation with the ' +
           'index behaviour of a sequential key.',
      },
      {
        h: 'Storing them properly',
        p: 'Postgres has a native uuid type storing 16 bytes; MySQL can use BINARY(16). Storing the ' +
           '36-character text form instead more than doubles the space and slows every comparison ' +
           'and index operation. The text form is for transport and display, not storage — and when ' +
           'you do compare them, do it case-insensitively, since hex is conventionally lowercase but ' +
           'uppercase appears in Microsoft ecosystems.',
      },
      {
        h: 'Unguessable is not the same as protected',
        p: 'A v4 UUID in a URL is not enumerable, which is a genuine improvement over sequential ' +
           'integers that let anyone count your records. But anyone who obtains the URL has the ' +
           'resource — through a shared link, a referrer header, a browser history, a screenshot. ' +
           'Treat a UUID as an identifier that does not leak volume, not as an access control. ' +
           'Anything sensitive still needs an authorisation check.',
      },
    ],
    steps: [
      'Choose how many UUIDs you need.',
      'Toggle uppercase or braces if the target system expects them.',
      'Generate and copy individually or as a batch.',
    ],
    notes: [
      'Generated with crypto.getRandomValues, so these are cryptographically random.',
      'Version and variant bits are set correctly — the 13th character is 4, the 17th is 8, 9, ' +
       'a or b.',
      'Store as a native uuid or BINARY(16) type, not as a 36-character string.',
    ],
    faq: [
      ['Can two UUIDs ever collide?',
       'In principle yes, in practice no — you would need to generate around 2.7 quintillion ' +
       'before reaching a one-in-a-billion chance. The realistic failure mode is a weak random ' +
       'source, which is why these use the cryptographic generator rather than Math.random.'],
      ['Should I use a UUID as a database primary key?',
       'It depends on scale. Random v4 keys fragment indexes and cost storage, which is ' +
       'invisible on small tables and measurable on very large ones. Version 7 gives you offline ' +
       'generation with chronological ordering and is the better default for new systems.'],
      ['Is it safe to put a UUID in a public URL?',
       'It is unguessable, so it will not let someone enumerate your records the way sequential ' +
       'ids do. It is not access control — anyone with the link has the resource. Keep an ' +
       'authorisation check behind it for anything sensitive.'],
    ],
  },
  'fake-name-gen': {
    intro:
      'Generates realistic-looking names in bulk for test data, UI mockups and database seeding ' +
      '— so your staging environment does not display the same three placeholder names, or real ' +
      'customers\' details.',
    sections: [
      {
        h: 'Why real data does not belong in test environments',
        p: 'Copying a production database into staging is common and is a genuine compliance ' +
           'problem: under GDPR and comparable regimes, personal data in a test environment is still ' +
           'personal data, subject to the same obligations and the same breach reporting. Test ' +
           'environments are typically less hardened, more widely accessible and less monitored, ' +
           'which is exactly the combination that produces incidents. Generated names let you ' +
           'populate realistic-looking data with no subject behind it.',
      },
      {
        h: 'Test with names that break your assumptions',
        p: 'Most name fields are written by people whose own names are short, ASCII and in two ' +
           'parts, and they fail on everyone else. Real names contain apostrophes (O\'Brien), ' +
           'hyphens, accents, non-Latin scripts, particles (van der Berg), single names with no ' +
           'surname, and names longer than a 50-character column. Many cultures put the family name ' +
           'first. Seed your test data with those cases deliberately — they are where the bugs are, ' +
           'and they are the bugs that make real users feel unwelcome.',
      },
      {
        h: 'Generated names can still collide with real people',
        p: 'A plausible-sounding name is plausible because real people have it. That is fine for a ' +
           'seeded database and not fine in published material: a screenshot in documentation, a ' +
           'marketing example or a sample invoice with a generated name may match an actual person, ' +
           'who will not enjoy finding themselves in it. For anything public, use obviously ' +
           'fictional names or the conventional placeholders — the example.com domain is reserved ' +
           'for exactly this purpose.',
      },
    ],
    steps: [
      'Choose how many names you need.',
      'Generate and copy them into your seed data or mockup.',
      'Add awkward cases by hand — accents, apostrophes, single names, very long names.',
    ],
    notes: [
      'For test data and mockups, not for creating accounts or misrepresenting identity.',
      'Use example.com for accompanying email addresses — the domain is reserved for ' +
       'documentation.',
      'Generated names may coincide with real people; avoid them in published material.',
    ],
    faq: [
      ['Can I use generated names to sign up for services?',
       'No. Providing false identity information typically breaches terms of service and can be ' +
       'unlawful, particularly anywhere identity verification is required. These are for test ' +
       'databases and design mockups.'],
      ['What names should I test my forms with?',
       'The ones that break assumptions: apostrophes, hyphens, accented characters, non-Latin ' +
       'scripts, single names with no surname, names with particles like van or de, and names ' +
       'longer than your column allows. Most name-handling bugs live in exactly those cases.'],
      ['Is it safe to use production data in a test environment?',
       'No — it remains personal data with the same legal obligations, in an environment that is ' +
       'usually less secure and more widely accessible. Generate or anonymise instead; it is ' +
       'both safer and easier to work with.'],
    ],
  },
  ...
  'env-gen': {
    intro:
      'Generates a .env template with the variables your stack expects, so a new developer ' +
      'knows what to fill in. The template is committed; the filled-in file never is.',
    sections: [
      {
        h: 'Commit .env.example, never .env',
        p: 'The convention that works: a committed .env.example listing every variable name with a ' +
           'placeholder or empty value, and a git-ignored .env holding the real ones. That gives a ' +
           'new developer a complete checklist without exposing anything, and it documents the ' +
           'configuration surface in the repository where it belongs. The failure mode is a .env ' +
           'committed once early in a project\'s life — which puts the secrets in the history ' +
           'permanently, where ignoring the file afterwards does nothing.',
      },
      {
        h: 'If a secret was committed, rotate it',
        p: 'Removing it from the working tree does not remove it from history, and rewriting history ' +
           'means force-pushing every commit and breaking every clone — and forks, caches and ' +
           'third-party mirrors may keep a copy regardless. Assume anything pushed to a remote is ' +
           'compromised and rotate the credential. That is faster, more certain, and does not ' +
           'require coordinating with everyone who has cloned the repository.',
      },
      {
        h: 'Environment variables are not encrypted',
        p: 'They are readable by any process running as the same user, they appear in crash dumps ' +
           'and in some logging setups, and on a shared host they may be visible in the process ' +
           'table. They are a reasonable place for configuration and moderate secrets, and a poor ' +
           'place for anything truly sensitive in a shared environment. Production systems of any ' +
           'scale should use a secrets manager — Vault, AWS Secrets Manager, or the platform\'s own — ' +
           'which adds rotation, audit logging and access control that a file cannot.',
      },
      {
        h: 'The client-side prefix that catches people out',
        p: 'Build tools expose variables to browser code only when prefixed: NEXT_PUBLIC_ in ' +
           'Next.js, VITE_ in Vite, REACT_APP_ in Create React App. That is a safety mechanism, and ' +
           'it cuts both ways — a secret accidentally given one of those prefixes is compiled into ' +
           'the JavaScript bundle and shipped to every visitor. Anything with PUBLIC in its name ' +
           'should be treated as published, because it is.',
      },
    ],
    steps: [
      'Select your stack and the services you use.',
      'Save the generated template as .env.example and commit it.',
      'Copy it to .env, fill in real values, and confirm .env is git-ignored.',
    ],
    notes: [
      'Add .env to .gitignore before the first commit, not after.',
      'Variables prefixed NEXT_PUBLIC_, VITE_ or REACT_APP_ are compiled into the client ' +
       'bundle.',
      'Restart the dev server after changing .env — most frameworks read it only at startup.',
    ],
    faq: [
      ['Should I commit my .env file?',
       'Never. Commit a .env.example with the variable names and placeholder values so others ' +
       'know what to configure, and keep the real .env git-ignored. A committed .env puts ' +
       'secrets in the history permanently.'],
      ['I accidentally committed a secret. What do I do?',
       'Rotate it immediately — treat it as compromised. Removing it from history requires ' +
       'rewriting every commit and force-pushing, which breaks clones and still may not reach ' +
       'forks and caches. Rotation is faster and actually works.'],
      ['Are environment variables secure?',
       'Adequately for configuration, not for high-value secrets on shared infrastructure. They ' +
       'are readable by processes under the same user and can leak into crash dumps and logs. ' +
       'Use a secrets manager for production, which adds rotation and audit trails.'],
    ],
  },
  ...
  'html-formatter': {
    intro:
      'Reformats HTML with consistent indentation and line breaks, making a minified or badly ' +
      'structured document readable and showing its nesting clearly.',
    sections: [
      {
        h: 'Formatting reveals nesting bugs',
        p: 'The most useful thing a formatter does is make the tree visible. An unclosed div or a ' +
           'tag closed in the wrong order shows up immediately as indentation that runs away down ' +
           'the page or snaps back unexpectedly. Browsers silently repair malformed HTML, so a page ' +
           'can render perfectly and still have structure that breaks CSS selectors, confuses screen ' +
           'readers and falls apart when a JavaScript framework tries to manage it.',
      },
      {
        h: 'Where indentation changes what renders',
        p: 'HTML whitespace collapses in most places and not everywhere. Adding line breaks between ' +
           'inline elements introduces a rendered space, which can shift layout — the classic case ' +
           'being the gap that appears between inline-block elements when a formatter puts them on ' +
           'separate lines. Content in pre and textarea must be left exactly as it is. So formatting ' +
           'HTML is not quite as safe as formatting code, and the result is worth looking at rather ' +
           'than trusting.',
      },
      {
        h: 'Validate as well as format',
        p: 'A formatter shows you structure; the W3C validator tells you what is actually wrong — ' +
           'duplicate ids, invalid nesting such as a div inside a p, missing required attributes, ' +
           'and deprecated elements. Those are the issues that produce inconsistent behaviour ' +
           'between browsers and accessibility failures. The two tools answer different questions ' +
           'and are worth using together when something is behaving strangely.',
      },
    ],
    steps: [
      'Paste your HTML.',
      'Read the formatted output and follow the indentation to spot unclosed tags.',
      'Copy the result, checking any inline elements whose spacing matters.',
    ],
    notes: [
      'Line breaks between inline elements render as spaces and can shift layout.',
      'pre and textarea content must be preserved exactly.',
      'Formatting shows structure; a validator finds the actual errors.',
    ],
    faq: [
      ['Can formatting break my HTML?',
       'It can change rendering. Whitespace between inline elements becomes a rendered space, ' +
       'which is the usual cause of unexpected gaps, and content in pre and textarea must not be ' +
       'reindented. Check the rendered page, not only the markup.'],
      ['How do I find an unclosed tag?',
       'Format the document and follow the indentation. An unclosed element makes everything ' +
       'after it indent progressively deeper, and the point where that starts is where the tag ' +
       'is missing. A validator will name it precisely.'],
      ['Should I commit formatted or minified HTML?',
       'Formatted, always — minified HTML is unreadable and produces meaningless diffs. ' +
       'Minification belongs in the build, not in the source.'],
    ],
  },
  ...
  'emi-calc': {
    intro:
      'Calculates the equated monthly instalment on a loan from the principal, interest rate ' +
      'and tenure, with total interest and a year-by-year balance. The number that decides ' +
      'whether a loan is affordable — and the total interest, which decides whether it is ' +
      'sensible.',
    sections: [
      {
        h: 'What the EMI formula is doing',
        p: 'EMI = P × r × (1+r)ⁿ / ((1+r)ⁿ − 1), where r is the monthly rate and n the number of ' +
           'months. It solves for the constant payment that clears the loan exactly at the end of ' +
           'the term. The instalment stays the same every month, but its composition does not: early ' +
           'payments are mostly interest and late ones mostly principal, which is why the balance ' +
           'barely moves in the first years and why prepaying early saves so much more than ' +
           'prepaying late.',
      },
      {
        h: 'Longer tenure, smaller EMI, far more interest',
        p: 'This is the trade the EMI figure alone hides. A ₹10 lakh loan at 9% over 10 years is ' +
           'about ₹12,668 a month and ₹5.2 lakh of interest. Stretch it to 20 years and the EMI ' +
           'falls to roughly ₹8,997 — comfortable — while total interest rises to about ₹11.6 lakh, ' +
           'more than the loan itself. Lenders present the lower EMI because it sells; the total ' +
           'interest is the number to compare, and it is usually one screen further in.',
      },
      {
        h: 'Prepayment is worth most in the early years',
        p: 'Because early instalments are mostly interest, a lump sum paid in year two removes far ' +
           'more future interest than the same sum in year twelve. Reducing the tenure rather than ' +
           'the EMI saves considerably more, and most Indian lenders let you choose — though you ' +
           'often have to ask. Floating-rate home loans to individuals cannot carry a prepayment ' +
           'penalty under RBI rules; fixed-rate loans and most personal loans can, so check before ' +
           'planning around it.',
      },
      {
        h: 'What the EMI figure leaves out',
        p: 'Processing fees of 0.5–1%, documentation and legal charges, and insurance that is ' +
           'sometimes bundled in without being obvious. For home loans, add stamp duty and ' +
           'registration — 5–7% of property value in most states — which are not financed. Compare ' +
           'lenders on the total cost of credit rather than the headline rate, and treat a rate that ' +
           'is markedly below the market as an invitation to read the fee schedule carefully.',
      },
    ],
    steps: [
      'Enter the loan amount, annual interest rate and tenure in years.',
      'Read the EMI, the total interest and the year-by-year outstanding balance.',
      'Compare tenures: note how much the total interest changes while the EMI barely does.',
    ],
    notes: [
      'The rate is annual; the calculation converts it to a monthly rate internally.',
      'Total interest, not the EMI, is the figure that shows what a loan actually costs.',
      'Processing fees, insurance and stamp duty are not included.',
    ],
    faq: [
      ['How is EMI calculated?',
       'EMI = P × r × (1+r)ⁿ / ((1+r)ⁿ − 1), with r the monthly interest rate and n the number ' +
       'of monthly instalments. It is the fixed payment that exactly clears principal and ' +
       'interest over the term.'],
      ['Does a longer tenure save money?',
       'It lowers the monthly payment and increases the total cost, often dramatically. Doubling ' +
       'a tenure from 10 to 20 years can more than double the interest paid. Choose the shortest ' +
       'tenure whose EMI you can comfortably sustain.'],
      ['Is it better to reduce the EMI or the tenure when prepaying?',
       'Reducing the tenure saves substantially more interest, because you remove the most ' +
       'expensive months at the end while keeping the same payment. Reducing the EMI improves ' +
       'monthly cash flow instead. Most lenders offer both but default to reducing the EMI ' +
       'unless you ask.'],
    ],
  },
  'home-loan-emi-calc': {
    intro:
      'Calculates a home loan EMI with the amortisation schedule, so you can see how much of ' +
      'each year\'s payments clears principal against interest. On a 20-year loan the answer is ' +
      'uncomfortable for the first several years.',
    sections: [
      {
        h: 'Where the money goes in the early years',
        p: 'On a ₹50 lakh loan at 8.5% over 20 years, the EMI is about ₹43,391. In the first year ' +
           'roughly ₹4.2 lakh of the ₹5.2 lakh paid is interest, and the outstanding balance falls ' +
           'by about ₹1 lakh. The crossover — where the principal portion of each instalment exceeds ' +
           'the interest portion — comes around year eleven. That shape is the single most useful ' +
           'thing an amortisation schedule shows, and it is why the early years are where prepayment ' +
           'has leverage.',
      },
      {
        h: 'Floating rates and what actually changes',
        p: 'Most Indian home loans are floating, linked to an external benchmark — usually the RBI ' +
           'repo rate — plus a spread. When the benchmark moves, lenders typically hold the EMI ' +
           'constant and adjust the tenure instead, which is why a rate rise can quietly add years ' +
           'to your loan without changing anything you see monthly. You can usually request an EMI ' +
           'increase rather than a tenure extension; it costs more each month and far less overall.',
      },
      {
        h: 'The costs beyond the loan',
        p: 'Stamp duty and registration run 5–7% of property value depending on the state and are ' +
           'paid from your own funds, not financed. Add processing fees, legal and technical ' +
           'valuation charges, and often a year of property insurance. Lenders finance up to 75–90% ' +
           'of value depending on the loan size, so the real cash requirement is the down payment ' +
           'plus those charges — commonly 25–30% of the purchase price in total.',
      },
      {
        h: 'The tax position is worth understanding before you optimise for it',
        p: 'Under the old regime, Section 24(b) allows up to ₹2 lakh of interest on a self-occupied ' +
           'property and Section 80C up to ₹1.5 lakh of principal, within the overall 80C limit that ' +
           'your EPF and insurance may already fill. Under the new regime, which is now the default, ' +
           'neither is available for a self-occupied property. So the familiar advice that a home ' +
           'loan is tax-efficient depends entirely on which regime you are in — and for many people ' +
           'it no longer holds.',
      },
    ],
    steps: [
      'Enter the loan amount, interest rate and tenure.',
      'Read the EMI and the year-by-year split of principal and interest.',
      'Note the year where principal overtakes interest — prepayment before then has the most ' +
       'effect.',
    ],
    notes: [
      'Stamp duty, registration and processing fees are not financed and not included here.',
      'Floating-rate loans usually adjust tenure rather than EMI when rates change.',
      'Floating-rate home loans to individuals carry no prepayment penalty under RBI rules.',
    ],
    faq: [
      ['How much home loan can I get on my salary?',
       'Lenders generally cap total EMIs at 40–50% of net monthly income and finance 75–90% of ' +
       'property value depending on loan size. Both constraints apply, and the down payment plus ' +
       'stamp duty and fees typically means having 25–30% of the purchase price in hand.'],
      ['Should I prepay my home loan or invest instead?',
       'Compare the loan rate against the after-tax return you can reliably expect. Prepayment ' +
       'is a guaranteed, risk-free return equal to the interest rate, which is a higher bar than ' +
       'it looks. Under the old regime the interest deduction lowers the effective rate; under ' +
       'the new regime it does not.'],
      ['Why did my loan tenure increase without my EMI changing?',
       'Floating-rate loans are linked to an external benchmark, and when it rises most lenders ' +
       'extend the tenure rather than raise the EMI. You can usually ask to increase the EMI ' +
       'instead, which costs more monthly and considerably less in total interest.'],
    ],
  },
  'sip-calc': {
    intro:
      'Projects the future value of a monthly systematic investment plan at an assumed rate of ' +
      'return, with the split between what you invested and what compounding added.',
    sections: [
      {
        h: 'The number that surprises people is the split',
        p: '₹10,000 a month for 15 years at 12% is ₹18 lakh invested and roughly ₹50 lakh at the end ' +
           '— so about 64% of the final amount is growth rather than contribution. Extend to 25 ' +
           'years and ₹30 lakh invested becomes around ₹1.9 crore, with contributions now under a ' +
           'sixth of the total. Compounding is not linear in time, which is why starting five years ' +
           'earlier outperforms investing substantially more later.',
      },
      {
        h: 'The assumed rate is an assumption, not a forecast',
        p: '12% is the conventional figure for Indian equity projections because it approximates ' +
           'long-run index returns, and no fund delivers it smoothly. Real sequences include years ' +
           'of −30% and years of +40%, and the order they arrive in matters for anyone withdrawing. ' +
           'Run the projection at 10% and 14% as well as 12 — if the plan only works at the ' +
           'optimistic figure, it is not a plan. Debt funds and hybrid funds have quite different ' +
           'expectations, typically 6–8%.',
      },
      {
        h: 'Rupee cost averaging is a discipline, not a strategy',
        p: 'Investing a fixed amount monthly buys more units when prices are low and fewer when ' +
           'high, which smooths the average purchase price. Studies consistently find that investing ' +
           'a lump sum immediately beats staging it in, because markets rise more often than they ' +
           'fall — so SIP\'s real advantage is behavioural. It makes investing automatic, removes the ' +
           'impulse to time the market, and keeps contributions going during the falls when stopping ' +
           'feels most sensible and is most costly.',
      },
      {
        h: 'Inflation and tax are missing from the headline figure',
        p: '₹1 crore in 20 years is not ₹1 crore today — at 6% inflation it buys roughly what ₹31 ' +
           'lakh buys now. Project in real terms by using a return net of inflation, or apply an ' +
           'inflation calculator to the result. Equity mutual fund gains above ₹1.25 lakh in a year ' +
           'are taxed at 12.5% long-term, and each SIP instalment has its own holding period, so ' +
           'redeeming a long-running SIP mixes long and short-term gains.',
      },
    ],
    steps: [
      'Enter the monthly investment amount.',
      'Set an expected annual return — and run it again at two or three percentage points ' +
       'lower.',
      'Set the duration and read the invested total against the projected value.',
    ],
    notes: [
      'Returns are assumed constant; real market returns are not, and the sequence matters.',
      'The projection is nominal — adjust for inflation to see real purchasing power.',
      'Equity fund gains above ₹1.25 lakh a year are taxed at 12.5% long-term.',
    ],
    faq: [
      ['What return should I assume for a SIP?',
       '10–12% is the conventional range for Indian equity over long periods, 6–8% for debt. ' +
       'Always run a lower figure as well — a plan that only works at 12% is fragile, and no ' +
       'fund delivers a constant rate.'],
      ['Is SIP better than a lump sum investment?',
       'For returns, lump sum usually wins, because markets rise more often than they fall and ' +
       'time in the market beats staging in. SIP wins on behaviour: it automates investing, ' +
       'removes timing decisions, and matches how salaries actually arrive.'],
      ['How much should I invest monthly to reach ₹1 crore?',
       'At 12% over 20 years, roughly ₹10,000 a month. Over 15 years, about ₹20,000. Over 10 ' +
       'years, around ₹43,000. The steep difference is the value of starting early — time does ' +
       'more of the work than the amount does.'],
    ],
  },
  'gst-calc': {
    intro:
      'Adds GST to a base amount or extracts it from a GST-inclusive total, splitting the tax ' +
      'into CGST and SGST. The reverse calculation is the one people get wrong.',
    sections: [
      {
        h: 'Removing GST means dividing, not subtracting',
        p: 'To find the base amount in a ₹1,180 inclusive price at 18%, divide by 1.18 to get ₹1,000 ' +
           '— do not subtract 18% of 1,180, which gives ₹967.60 and is wrong by over ₹32. The error ' +
           'compounds on every line of an invoice and is a recurring cause of reconciliation ' +
           'disputes. The rule: to remove a percentage that was added, divide by (1 + rate).',
      },
      {
        h: 'CGST, SGST and IGST',
        p: 'Within a state, GST splits equally between the centre and the state — 18% becomes 9% ' +
           'CGST and 9% SGST, shown separately on the invoice. Across states it is a single IGST at ' +
           'the full 18%, which the centre later apportions. The total the customer pays is ' +
           'identical either way; what changes is the presentation and which government receives it. ' +
           'Union territories use UTGST in place of SGST.',
      },
      {
        h: 'The rate slabs, and why they matter for pricing',
        p: 'The main slabs are 5%, 12%, 18% and 28%, with 0% on many unprocessed foods and a cess on ' +
           'luxury and sin goods. Classification determines the rate and is frequently contested — ' +
           'whether a product is a biscuit or a confectionery, a paratha or a roti, has been ' +
           'litigated with real money at stake. If you sell across categories, getting the HSN code ' +
           'right matters more than the arithmetic.',
      },
      {
        h: 'Input tax credit is what makes GST a value-added tax',
        p: 'A registered business offsets the GST it paid on inputs against the GST it collected on ' +
           'sales, so tax is effectively paid only on the value added at each stage. That is why B2B ' +
           'customers care about a proper tax invoice with your GSTIN — without it they cannot claim ' +
           'the credit, and your price is effectively higher to them by the tax amount. Registration ' +
           'is mandatory above ₹40 lakh turnover for goods and ₹20 lakh for services in most states.',
      },
    ],
    steps: [
      'Enter the amount.',
      'Choose whether to add GST to it or extract GST from it.',
      'Set the rate, and read the base, the tax and the CGST/SGST split.',
    ],
    notes: [
      'To remove GST, divide by (1 + rate) — subtracting the percentage gives the wrong base.',
      'Intra-state transactions split into CGST and SGST; inter-state use a single IGST at the ' +
       'full rate.',
      'The customer pays the same total either way.',
    ],
    faq: [
      ['How do I remove GST from an inclusive price?',
       'Divide by 1 plus the rate. At 18%, a ₹1,180 inclusive price has a base of ₹1,000 and ' +
       '₹180 of GST. Subtracting 18% from the total is the common mistake and understates the ' +
       'base.'],
      ['What is the difference between CGST, SGST and IGST?',
       'Within a state the tax splits equally between centre (CGST) and state (SGST). Across ' +
       'states it is charged as a single IGST at the full rate. The customer pays the same ' +
       'amount; only the split and the recipient differ.'],
      ['What are the GST rates in India?',
       'The main slabs are 5%, 12%, 18% and 28%, with 0% on many essentials and an additional ' +
       'cess on luxury and sin goods. The applicable rate depends on the HSN classification of ' +
       'the specific product or service.'],
    ],
  },
  'income-tax-calc': {
    intro:
      'Compares income tax under the old and new regimes for a salaried individual, using the ' +
      'FY 2025-26 slabs, and tells you which is cheaper for your figures. The comparison is the ' +
      'point — the answer differs by person.',
    sections: [
      {
        h: 'The new regime is now the default, and it changed substantially',
        p: 'For FY 2025-26 the new regime has a nil slab to ₹4 lakh, then 5% to ₹8 lakh, 10% to ₹12 ' +
           'lakh, 15% to ₹16 lakh, 20% to ₹20 lakh, 25% to ₹24 lakh and 30% above. The Section 87A ' +
           'rebate means no tax at all up to ₹12 lakh of taxable income, and with the ₹75,000 ' +
           'standard deduction a salaried person earning up to ₹12.75 lakh pays nothing. Marginal ' +
           'relief prevents the cliff just above ₹12 lakh, where tax would otherwise exceed the ' +
           'extra income.',
      },
      {
        h: 'Which regime wins depends on your deductions',
        p: 'The old regime allows 80C, 80D, HRA, home loan interest and the rest; the new regime ' +
           'allows almost none of it but taxes at lower rates with a larger standard deduction. The ' +
           'crossover depends entirely on how much you genuinely claim. Someone with a large home ' +
           'loan, full 80C, health insurance and significant HRA may still be better off under the ' +
           'old regime; someone with a small 80C and no rent or loan is almost certainly better off ' +
           'under the new. This is why the calculator shows both rather than one answer.',
      },
      {
        h: 'Do not buy deductions to save tax',
        p: 'Spending ₹1.5 lakh on a product you would not otherwise choose, to save perhaps ₹45,000 ' +
           'in tax, is a poor trade — and it is how a great deal of underperforming insurance is ' +
           'sold each March. Claim deductions for things you were going to do anyway: EPF, a term ' +
           'plan you need, health insurance, a home loan you already have. If the new regime taxes ' +
           'you less without the paperwork, that is a legitimate answer.',
      },
      {
        h: 'What this estimate leaves out',
        p: 'It models a salaried individual with 80C and the standard deduction. It does not handle ' +
           'HRA exemption, which needs rent paid and city of residence; capital gains, which are ' +
           'taxed at their own rates; 80D health insurance; surcharge above ₹50 lakh income; NPS ' +
           'under 80CCD(1B); or senior citizen thresholds. Treat it as a comparison of the two ' +
           'regimes at a glance, not a return.',
      },
    ],
    steps: [
      'Enter your annual gross income.',
      'Enter your 80C deduction — capped at ₹1.5 lakh.',
      'Read the tax under both regimes and which is cheaper for you.',
    ],
    notes: [
      'Slabs are FY 2025-26 (AY 2026-27); the standard deduction is ₹50,000 old and ₹75,000 ' +
       'new.',
      'Includes the 4% health and education cess and marginal relief above ₹12 lakh.',
      'An estimate for a salaried individual — HRA, capital gains, 80D and surcharge are not ' +
       'modelled.',
    ],
    faq: [
      ['Which tax regime should I choose?',
       'Whichever costs less for your actual deductions, which is why this shows both. Broadly: ' +
       'large home loan interest, full 80C and significant HRA favour the old regime; few ' +
       'deductions favour the new. Recalculate each year, since slabs change.'],
      ['Is income up to ₹12 lakh tax-free under the new regime?',
       'Taxable income up to ₹12 lakh attracts no tax because of the Section 87A rebate, and ' +
       'with the ₹75,000 standard deduction a salaried person earning up to ₹12.75 lakh gross ' +
       'pays nothing. Above that, tax applies on the whole taxable amount, with marginal relief ' +
       'smoothing the transition.'],
      ['Can I switch between the old and new regimes?',
       'Salaried individuals without business income may choose each year when filing. Those ' +
       'with business income can move to the old regime only once, and cannot switch back ' +
       'freely. The new regime is the default if you do not opt out.'],
    ],
  },
  'inflation-calc': {
    intro:
      'Shows what a sum of money will be worth in future purchasing power at a given inflation ' +
      'rate, or what a past amount is worth today. The calculation that makes long-term ' +
      'financial projections honest.',
    sections: [
      {
        h: 'Inflation is compounding in reverse',
        p: 'At 6% a year, ₹1 lakh today buys what ₹55,840 buys in ten years and about ₹31,180 in ' +
           'twenty. The rule of 70 gives a quick estimate: divide 70 by the inflation rate to get ' +
           'the years for prices to double — so 6% doubles prices in under twelve years. That is why ' +
           'a retirement figure that sounds enormous today is frequently inadequate, and why “how ' +
           'much do I need” questions are meaningless without a date attached.',
      },
      {
        h: 'Your personal inflation rate is not the headline one',
        p: 'India\'s CPI averages a basket weighted for the whole population, with food a large ' +
           'component. Your own rate depends on what you actually buy: education and healthcare have ' +
           'run well above general inflation for years, often 8–12%, while electronics have fallen ' +
           'in real terms. A household planning for school fees and medical costs should use a ' +
           'higher figure than the headline CPI — using 6% for an education goal is optimistic.',
      },
      {
        h: 'Nominal and real returns',
        p: 'A fixed deposit at 7% during 6% inflation returns about 1% in real terms, before tax — ' +
           'and after tax at a 30% slab the real return is negative. This is the central argument ' +
           'for holding growth assets over long horizons: an instrument that merely keeps pace with ' +
           'inflation loses purchasing power once tax is applied. The approximate real return is ' +
           'nominal minus inflation; the exact form is (1+nominal)/(1+inflation) − 1, which matters ' +
           'at higher rates.',
      },
      {
        h: 'Use it to sanity-check every long-term projection',
        p: 'Any calculator that projects twenty years forward — SIP, retirement, education funding — ' +
           'produces a nominal figure. Running it through inflation tells you what that money ' +
           'actually buys, and the result is usually sobering enough to change the plan. The ' +
           'alternative is to project in real terms from the start by using a return net of ' +
           'inflation, which produces smaller, more honest numbers.',
      },
    ],
    steps: [
      'Enter the amount and the number of years.',
      'Set an inflation rate — higher than headline CPI for education and healthcare goals.',
      'Read the future purchasing power, or the equivalent past value.',
    ],
    notes: [
      'The rule of 70: divide 70 by the inflation rate for the years until prices double.',
      'India\'s long-run CPI has averaged roughly 5–6%; education and healthcare have run ' +
       'higher.',
      'Real return is approximately nominal minus inflation, and is often negative after tax on ' +
       'fixed income.',
    ],
    faq: [
      ['How much will ₹1 crore be worth in 20 years?',
       'At 6% inflation, about ₹31 lakh in today\'s purchasing power. At 7%, closer to ₹26 lakh. ' +
       'Which is why a retirement target set in today\'s rupees needs inflating to the date you ' +
       'will actually need it.'],
      ['What inflation rate should I use for planning?',
       '5–6% for general expenses in India, based on long-run CPI. Use 8–10% for education and ' +
       'healthcare, which have consistently outpaced the headline rate. Planning an education ' +
       'goal at 6% will leave you short.'],
      ['What is the real rate of return?',
       'The return after inflation. Approximately nominal minus inflation; precisely ' +
       '(1+nominal)/(1+inflation) − 1. A 7% deposit during 6% inflation earns about 1% real ' +
       'before tax, and less than nothing after tax at a high slab.'],
    ],
  },
  ...
  'video-trimmer': {
    intro:
      'Cuts a clip from a video between a start and end point, in your browser. Useful for ' +
      'extracting the part that matters before sharing, uploading or converting.',
    sections: [
      {
        h: 'Trimming can be lossless, and that depends on keyframes',
        p: 'Video is encoded as occasional complete frames (keyframes) with the frames between them ' +
           'stored as differences. A cut exactly on a keyframe can copy the streams without ' +
           're-encoding, which is instant and loses nothing. A cut between keyframes either has to ' +
           're-encode the affected section or shift your cut point to the nearest keyframe — which ' +
           'is why a trim sometimes starts a second or two from where you set it. Keyframes are ' +
           'typically two to ten seconds apart.',
      },
      {
        h: 'Trim before you convert',
        p: 'Every other operation — converting format, making a GIF, extracting audio — costs time ' +
           'proportional to the length of the video. Cutting first means everything afterwards runs ' +
           'on a fraction of the material, which matters a great deal when the processing happens in ' +
           'a browser tab. It also avoids the common mistake of converting a twenty-minute recording ' +
           'to extract a thirty-second clip.',
      },
      {
        h: 'Working in a browser has limits worth knowing',
        p: 'The file is held in memory while it is processed, so a large video can exhaust the tab ' +
           'before anything useful happens. Processing is single-threaded and cannot use your ' +
           'machine\'s hardware video encoder. The compensation is that nothing is uploaded — for a ' +
           'recording of a meeting, a medical scan, or anything unreleased, that is the entire ' +
           'reason to accept the slower route.',
      },
    ],
    steps: [
      'Choose your video.',
      'Set the start and end points.',
      'Trim, check the result, and download.',
    ],
    notes: [
      'Cut points may shift slightly to the nearest keyframe when copying streams without ' +
       're-encoding.',
      'Trim before converting or making a GIF — everything downstream runs faster on less ' +
       'material.',
      'Processing runs in your browser; the video is never uploaded.',
    ],
    faq: [
      ['Why did my trim start a bit before where I set it?',
       'Because a lossless cut has to land on a keyframe, and keyframes are typically seconds ' +
       'apart. Cutting exactly where you asked requires re-encoding that section, which takes ' +
       'longer and loses a little quality.'],
      ['Does trimming reduce video quality?',
       'Not when the streams are copied without re-encoding — the kept portion is ' +
       'byte-identical. Re-encoding, which is needed for frame-accurate cuts, costs a small ' +
       'amount of quality.'],
      ['Why is it slow with large files?',
       'The video is processed in a browser tab, in memory, single-threaded and without access ' +
       'to hardware encoding. For very large files a desktop tool is faster; the trade here is ' +
  ...
  'quotation-gen': {
    intro:
      'Builds a professional price quotation with line items, totals and a validity period, ' +
      'ready to print or save as a PDF. A quotation is an offer with a deadline — which is the ' +
      'part that makes it useful and the part most people leave off.',
    sections: [
      {
        h: 'Quotation, estimate, proforma — they are not synonyms',
        p: 'A quotation is a firm offer at a stated price: accept it within the validity period and ' +
           'that is the price. An estimate is an approximation that can change, and saying ' +
           '“estimate” when you mean a fixed price invites a dispute later. A proforma invoice is a ' +
           'quotation formatted as an invoice, used when a buyer needs a document to raise a ' +
           'purchase order or arrange payment before the real invoice exists. Using the right word ' +
           'on the document is not pedantry — it determines what you have committed to.',
      },
      {
        h: 'The validity period protects you',
        p: 'Without one, a client can accept a quotation eighteen months later at a price that no ' +
           'longer covers your costs, and in several jurisdictions an offer with no stated expiry ' +
           'remains open for a reasonable time. Thirty days is the common default; use shorter where ' +
           'material costs move. It also creates a legitimate reason to follow up, which is more ' +
           'useful than it sounds when a quotation has gone quiet.',
      },
      {
        h: 'Say what is not included',
        p: 'Most disputes come from scope rather than price. State what the figure covers, and ' +
           'explicitly what it does not: revisions beyond a number, travel, materials at cost, ' +
           'third-party fees, taxes. Write the assumptions the price depends on — access, client ' +
           'sign-off times, content supplied by a date — because when those slip the quotation is ' +
           'the document you will point at. A page of clear exclusions prevents more arguments than ' +
           'any contract clause.',
      },
      {
        h: 'Payment terms belong on the quotation, not on the invoice',
        p: 'By the time you invoice, the work is done and your leverage is gone. Put the terms on ' +
           'the quotation where they form part of what the client accepts: the deposit, the ' +
           'milestone schedule, the payment window, and what happens if it is missed. For a new ' +
           'client, a deposit before starting is normal and asking for it at quotation stage is far ' +
           'easier than introducing it after.',
      },
    ],
    steps: [
      'Enter your details and the client\'s.',
      'Add a line item for each element of the work, with quantity and rate.',
      'Set the validity period — 30 days unless your costs move faster.',
      'List exclusions and payment terms in the notes, then print or save as PDF.',
    ],
    notes: [
      'A quotation is a firm offer; an estimate is not. Label the document accurately.',
      'Number quotations sequentially so you can reference one when it converts to an invoice.',
      'Everything stays in your browser — client names and rates are not transmitted.',
    ],
    faq: [
      ['What is the difference between a quotation and an estimate?',
       'A quotation is a firm offer at a fixed price, binding if accepted within its validity ' +
       'period. An estimate is an approximation that may change. Labelling a fixed price as an ' +
       'estimate, or vice versa, is a common source of disputes.'],
      ['How long should a quotation be valid?',
       'Thirty days is the usual default. Use shorter where your input costs move, and be ' +
       'explicit either way — without a stated expiry an offer can remain open longer than you ' +
       'intended.'],
      ['Should I include tax in a quotation?',
       'State the position clearly either way: show the tax as a separate line, or write “prices ' +
       'exclusive of GST” prominently. Ambiguity here means the client budgets the lower figure ' +
       'and queries the invoice.'],
    ],
  },
  'business-card-gen': {
    intro:
      'Designs a business card with a live preview and several colour themes, ready to print or ' +
      'save. The constraint that shapes everything is size: a card is 85 by 55 millimetres, and ' +
      'most designs try to fit too much into it.',
    sections: [
      {
        h: 'Standard sizes differ by country',
        p: 'The international standard is 85 × 55 mm, used across Europe, India and most of Asia. ' +
           'The US and Canada use 3.5 × 2 inches, which is 89 × 51 mm — wider and shorter. Japan ' +
           'uses 91 × 55 mm. A card designed to one size and printed at another gets cropped or ' +
           'leaves white edges, and card holders and wallets are sized for the local standard. ' +
           'Design for where your cards will actually be handed out.',
      },
      {
        h: 'Bleed and safe margins are why cards come back wrong',
        p: 'Printing is cut after it is printed, and the cut is never perfect. Artwork that runs to ' +
           'the edge must extend 3 mm beyond the trim line — the bleed — or a slight misalignment ' +
           'leaves a white sliver. Equally, keep text at least 4–5 mm inside the trim, because a cut ' +
           'that wanders the other way will clip it. Almost every card that comes back from a ' +
           'printer looking wrong failed one of those two rules.',
      },
      {
        h: 'Less information, larger type',
        p: 'A card has one job: let someone contact you afterwards. Name, what you do, one phone ' +
           'number, one email. A postal address is rarely needed, a fax number never, and a QR code ' +
           'linking to a full profile does more than six lines of small print. Keep body text at 8 ' +
           'points or above — below that it is unreadable in poor light, which is where cards are ' +
           'usually read. The back of the card is free space most people waste.',
      },
      {
        h: 'Getting it printed',
        p: 'Send a PDF at 300 dpi in CMYK with bleed included, which is what printers ask for and ' +
           'what most people send incorrectly. Colours will not match your screen — that is the ' +
           'gamut difference, not a printing error — so check a saturated brand colour against a ' +
           'printed swatch before ordering a thousand. Card stock around 350 gsm feels substantial; ' +
           'below 300 feels cheap in the hand, which is a real impression given what the object is ' +
           'for.',
      },
    ],
    steps: [
      'Enter your name, title, company and contact details.',
      'Pick a theme and check the preview.',
      'Print or save as PDF — add 3 mm bleed before sending to a commercial printer.',
    ],
    notes: [
      '85 × 55 mm is the international standard; the US uses 89 × 51 mm.',
      'Keep text 4–5 mm inside the trim line and extend backgrounds 3 mm beyond it.',
      'Printed colours will differ from screen — check a brand colour against a physical ' +
       'swatch.',
    ],
    faq: [
      ['What size is a business card?',
       '85 × 55 mm in Europe, India and most of Asia; 3.5 × 2 inches (89 × 51 mm) in the US and ' +
       'Canada; 91 × 55 mm in Japan. Design for the standard where the cards will be used, since ' +
       'wallets and holders are sized to it.'],
      ['What is bleed and do I need it?',
       'Bleed is 3 mm of artwork extending past the trim line, so that a slightly imperfect cut ' +
       'does not leave a white edge. You need it whenever a background colour or image reaches ' +
       'the edge of the card.'],
      ['What should I put on a business card?',
       'Name, role, one phone number and one email — and little else. The card exists so someone ' +
       'can contact you later, and every additional line shrinks the type. A QR code to a fuller ' +
       'profile does more than a dense block of details.'],
    ],
  },
  ...
  'morse-code': {
    intro:
      'Translates between text and Morse code in both directions. A code from 1838 that remains ' +
      'the most robust way to get a message through a bad channel, which is why it outlived the ' +
      'technology it was built for.',
    sections: [
      {
        h: 'The code is length-optimised, which is why it still works',
        p: 'Samuel Morse and Alfred Vail assigned the shortest sequences to the commonest English ' +
           'letters — E is a single dot, T a single dash, while Q and Y take four elements each. ' +
           'They worked it out by counting type in a printer\'s font case. That is variable-length ' +
           'encoding by frequency, the same principle behind Huffman coding a century later, and it ' +
           'makes Morse roughly as efficient as anything hand-keyed could be.',
      },
      {
        h: 'Timing is the grammar',
        p: 'A dash is three dot-lengths. The gap within a character is one dot, between characters ' +
           'three, and between words seven. Those proportions are the entire structure — get them ' +
           'wrong and the message is unreadable even when every symbol is correct. Experienced ' +
           'operators do not decode dot by dot; they learn the rhythm of each letter as a sound ' +
           'shape, which is why the Farnsworth method teaches characters at full speed with longer ' +
           'gaps between them.',
      },
      {
        h: 'Where it is still in use',
        p: 'Aviation and maritime navigation beacons identify themselves in Morse, and pilots verify ' +
           'a VOR or NDB by listening to its code — an active, required skill today. Amateur radio ' +
           'operators use it because a CW signal gets through when voice cannot: it occupies a ' +
           'fraction of the bandwidth and remains readable far below the noise floor. It has been ' +
           'used by prisoners of war blinking on camera, and by patients with locked-in syndrome. ' +
           'SOS was chosen in 1906 precisely because three dots, three dashes, three dots is ' +
           'unmistakable and easy to send under stress — it stands for nothing.',
      },
      {
        h: 'Learning it, if you want to',
        p: 'Do not learn from a chart of dots and dashes — that builds a lookup habit which caps you ' +
           'around 10 words per minute. Learn by sound, at 15–20 wpm character speed from the start, ' +
           'with exaggerated spacing that you close up as you improve. The Koch method introduces ' +
           'two characters at full speed and adds one at a time as accuracy holds. Both approaches ' +
           'exist because the visual route is a dead end that is very hard to unlearn.',
      },
    ],
    steps: [
      'Type text to convert it to Morse, or paste Morse to convert it back.',
      'Use dots and dashes with spaces between characters and slashes between words.',
      'Copy the result.',
    ],
    notes: [
      'A dash is three dots long; gaps are one dot within a character, three between ' +
       'characters, seven between words.',
      'SOS is a single unbroken signal — three dots, three dashes, three dots — and is not an ' +
       'abbreviation.',
      'Punctuation and accented letters have limited or no Morse equivalents.',
    ],
    faq: [
      ['What does SOS stand for?',
       'Nothing. It was adopted in 1906 because the sequence — three dots, three dashes, three ' +
       'dots, sent as one unbroken signal — is distinctive and easy to send and recognise under ' +
       'stress. “Save Our Souls” was invented afterwards.'],
      ['Is Morse code still used today?',
       'Yes. Aviation and maritime navigation beacons identify themselves in Morse and pilots ' +
       'verify them by ear. Amateur radio operators use it because it gets through interference ' +
       'that defeats voice, in a fraction of the bandwidth.'],
      ['What is the fastest way to learn Morse code?',
       'By sound, not by sight. Learn characters at 15–20 words per minute with extended gaps ' +
       'between them, closing the gaps as you improve — the Farnsworth method. Learning from a ' +
       'written chart builds a lookup habit that caps your speed and is hard to unlearn.'],
    ],
  },
  ...
  'video-compressor': {
    intro:
      'Re-encodes a video at a lower bitrate or resolution to reduce its file size, in your ' +
      'browser. Compression is always a trade — the question is which quality you can afford to ' +
      'lose.',
    sections: [
      {
        h: 'The three levers, and which to pull first',
        p: 'Resolution matters most: halving the width and height quarters the pixel count, and a ' +
           '1080p file downscaled to 720p is typically less than half the size with little visible ' +
           'difference on a phone. Bitrate is the direct control — halve it and the file roughly ' +
           'halves, with artefacts appearing first in fast motion and fine detail. Frame rate is the ' +
           'third: 60fps to 30fps saves meaningfully and is unnoticeable for talking-head footage, ' +
           'though obvious for sport or gaming.',
      },
      {
        h: 'What bitrate is actually needed',
        p: 'Roughly: 1080p at 30fps looks good around 5 Mbps, 720p around 2.5 Mbps, and 480p around ' +
           '1 Mbps. Fast motion needs more, static footage far less — a screen recording of a slide ' +
           'deck can be a fraction of those numbers. Going above the source bitrate gains nothing at ' +
           'all: you cannot restore detail that the original encoding already discarded, and the ' +
           'result is simply a larger file with identical content.',
      },
      {
        h: 'Every re-encode loses something',
        p: 'Compression is lossy, so re-encoding an already-compressed video degrades it further. ' +
           'The visible result is generation loss — the smeared, blocky look of a clip that has been ' +
           'downloaded, re-uploaded and re-compressed repeatedly. Always compress from the highest ' +
           'quality source you have, and do it once with the right settings rather than iterating ' +
           'through several attempts on the output.',
      },
      {
        h: 'Codec choice, and what actually plays',
        p: 'H.264 is the compatibility default and plays everywhere. H.265 and VP9 achieve roughly ' +
           'the same quality at 25–50% smaller size, but H.265 carries licensing complications and ' +
           'patchier support outside Apple\'s ecosystem. AV1 is better again and slower to encode. ' +
           'For a file you are sending to someone, H.264 remains the safe answer; for a file you ' +
           'control the playback of, the newer codecs are worth the size saving.',
      },
    ],
    steps: [
      'Choose your video.',
      'Reduce the resolution first, then the bitrate.',
      'Compress, compare the result against the original, and adjust if the quality dropped too ' +
       'far.',
    ],
    notes: [
      'Re-encoding is lossy — always work from the original, never from a previous compression.',
      'Setting a bitrate above the source adds file size and no quality.',
      'Browser encoding is slow and single-threaded; the compensation is that nothing is ' +
       'uploaded.',
    ],
    faq: [
      ['How do I reduce a video file size without losing quality?',
       'You cannot, strictly — re-encoding always loses something. What you can do is lose very ' +
       'little: downscale the resolution to what it will actually be viewed at, which is usually ' +
       'the largest saving for the least visible difference.'],
      ['What bitrate should I use for 1080p?',
       'Around 5 Mbps for 30fps looks good for most content, 8 Mbps or more for fast motion, and ' +
       'far less for screen recordings and static footage. Never exceed the source bitrate.'],
      ['Why is compression so slow in the browser?',
       'Video encoding is computationally heavy and runs here as WebAssembly, single-threaded, ' +
       'without access to your machine\'s hardware encoder. A desktop tool is dramatically ' +
       'faster; the trade is that your file never leaves the device.'],
    ],
  },
  ...
  'random-picker': {
    intro:
      'Picks one item at random from a list you paste in, using the browser\'s cryptographic ' +
      'random source. For decisions, draws and any moment where the choice should visibly not ' +
      'be yours.',
    sections: [
      {
        h: 'Each draw is independent, which means repeats',
        p: 'A pick has no memory of previous picks, so the same item can be chosen twice in a row ' +
           'and some items may never come up across several draws. That is correct behaviour and it ' +
           'is frequently not what people want. If everyone should get a turn before anyone repeats, ' +
           'remove each item after it is drawn, or shuffle the whole list and work down it — a ' +
           'different operation with a different tool.',
      },
      {
        h: 'Duplicates are how you weight a draw',
        p: 'Listing an item twice gives it two chances. That is sometimes a mistake — a duplicated ' +
           'name in a raffle — and sometimes exactly what you want, as a simple way to weight ' +
           'outcomes without any weighting mechanism. If a draw needs to be provably fair, show the ' +
           'full list before drawing so everyone can see what is in it and how many times.',
      },
      {
        h: 'Running a draw people accept',
        p: 'The technical fairness is the easy part. What makes a draw credible is procedure: show ' +
           'the list first, draw once, and take the result. Re-rolling until you like the answer is ' +
           'the exact failure a random picker is supposed to prevent, and people notice. For ' +
           'anything with real stakes or legal weight, use a documented process with a verifiable ' +
           'seed — a web page cannot prove afterwards what it did.',
      },
    ],
    steps: [
      'Paste your list, one item per line.',
      'Pick, and accept the first result.',
      'Remove the chosen item before the next draw if repeats are not wanted.',
    ],
    notes: [
      'Selection uses crypto.getRandomValues, so it is not a predictable sequence.',
      'Blank lines are ignored; duplicates get proportionally more chances.',
      'The list stays in your browser and is not saved.',
    ],
    faq: [
      ['Is the pick genuinely random?',
       'Yes — every line has an equal chance on every draw, from the browser\'s cryptographic ' +
       'random generator. Note that an item appearing twice in the list has two chances, which ' +
       'can be deliberate or accidental.'],
      ['How do I avoid picking the same item twice?',
       'Remove each item once drawn, or use a shuffler instead — a shuffle reorders the whole ' +
       'list with every item appearing exactly once, which is what you want for turn order.'],
      ['Can I use this for a prize draw?',
       'For an informal one, yes — show the list first and take the first result. Promotions ' +
       'with legal requirements usually need a documented, auditable process, which a web page ' +
       'cannot provide.'],
    ],
  },
  ...
  'bold-text-generator': {
    intro:
      'Converts text into Unicode bold characters — 𝐛𝐨𝐥𝐝 𝐥𝐢𝐤𝐞 𝐭𝐡𝐢𝐬 — which keep their weight ' +
      'when pasted into a bio or a post that offers no formatting controls.',
    sections: [
      {
        h: 'These are different characters, not bold styling',
        p: 'The output uses the Mathematical Alphanumeric Symbols block, which Unicode encoded so ' +
           'that a bold variable in a formula is distinguishable from an ordinary one. Because the ' +
           'weight lives in the character rather than in markup, it survives being pasted anywhere — ' +
           'which is why it appears in LinkedIn posts and Instagram bios, neither of which offers a ' +
           'bold button.',
      },
      {
        h: 'The accessibility cost is larger than for other styles',
        p: 'Screen readers handle these badly, and the failure is worse than usual because bold is ' +
           'typically applied to the most important words. A heading rendered in Unicode bold may be ' +
           'announced character by character, or as “mathematical bold small a” repeatedly, or ' +
           'skipped entirely. So the emphasis you added makes the key line the least accessible part ' +
           'of the post. They are also unsearchable, which matters when the bold text is your name ' +
           'or your offer.',
      },
      {
        h: 'Where real formatting exists, use it',
        p: 'LinkedIn, X and Instagram offer no bold in posts, which is the legitimate use case. But ' +
           'many platforms do: Slack, Discord, WhatsApp and Notion all support markdown-style ' +
           'formatting, and using their own syntax gives you bold that is properly announced by ' +
           'screen readers and correctly indexed by search. Reaching for Unicode characters where ' +
           'real formatting is available trades function for a marginal visual gain.',
      },
    ],
    steps: [
      'Type or paste your text.',
      'Copy the bold version.',
      'Use it sparingly — a phrase, not a paragraph.',
    ],
    notes: [
      'Only A–Z, a–z and digits convert; punctuation and accented letters pass through ' +
       'unchanged.',
      'Unsearchable, and announced badly by screen readers — avoid it for names and key ' +
       'information.',
      'Use the platform\'s own formatting where it exists.',
    ],
    faq: [
      ['Will bold text work on LinkedIn and Instagram?',
       'Yes — both accept these characters in posts and bios, which is why the technique exists. ' +
       'Keep it to a short phrase: an entire post in Unicode bold is unsearchable and unreadable ' +
       'to anyone using a screen reader.'],
      ['Why does my bold text show as boxes?',
       'The device lacks a font containing those characters, so it draws the missing-glyph box. ' +
       'It is most common on older Android versions and in some desktop applications.'],
      ['Does bold text affect my reach?',
       'It cannot be matched by search, so any keyword you bold becomes invisible to platform ' +
       'search. Keep the words you want found in plain text and use the styling for emphasis on ' +
       'something else.'],
    ],
  },
  ...
  'code-beautifier': {
    intro:
      'Reformats source code with consistent indentation and spacing across several languages. ' +
      'Useful for reading something minified, inherited or pasted from a chat that mangled it.',
    sections: [
      {
        h: 'Formatting is a readability tool, not a correctness one',
        p: 'Whitespace changes nothing about what most languages do — with real exceptions. Python ' +
           'indentation *is* the block structure, so reformatting it can change behaviour rather ' +
           'than appearance. YAML is the same. In brace languages the risk is lower but not zero: ' +
           'JavaScript\'s automatic semicolon insertion means joining or splitting lines can alter ' +
           'parsing in a handful of cases. Read the output rather than trusting it, particularly for ' +
           'indentation-sensitive languages.',
      },
      {
        h: 'The argument about style is the point of automating it',
        p: 'Tabs against spaces, brace placement, line length — these have consumed an extraordinary ' +
           'amount of engineering attention over decades, and none of the answers matter. What ' +
           'matters is that a codebase is consistent, so that a diff shows what changed rather than ' +
           'who edited it. That is why the modern answer is an opinionated formatter with almost no ' +
           'options: Prettier, Black, gofmt, rustfmt. Removing the choice removes the argument.',
      },
      {
        h: 'Put it in the pipeline, not in a browser tab',
        p: 'For a project, run the formatter on save and in a pre-commit hook, with the ' +
           'configuration committed. Then formatting never appears in a pull request, every ' +
           'contributor produces identical output, and code review is about the code. A web ' +
           'formatter is for a snippet you are reading once — pasting project code into a browser to ' +
           'reformat it and pasting it back is a workflow that will eventually lose something.',
      },
    ],
    steps: [
      'Paste your code and select the language.',
      'Read the formatted output.',
      'Copy it back — and set up a real formatter for anything you maintain.',
    ],
    notes: [
      'Python and YAML are indentation-sensitive: reformatting can change meaning, not just ' +
       'layout.',
      'Formatting does not validate — syntax errors remain syntax errors.',
      'Code stays in your browser and is not transmitted.',
    ],
    faq: [
      ['Can formatting break my code?',
       'In Python and YAML, yes — indentation carries meaning there, so a reformat can change ' +
       'structure. In brace languages it is generally safe, with JavaScript\'s automatic ' +
       'semicolon insertion as the edge case worth knowing about.'],
      ['Tabs or spaces?',
       'Whichever your project already uses. The choice has no technical merit either way; ' +
       'consistency does, because it keeps diffs meaningful. Tabs have one genuine argument in ' +
       'their favour: readers can set their own indent width, which helps some people with low ' +
       'vision.'],
      ['Should I use this or a proper formatter?',
       'This for a snippet you are reading. Prettier, Black, gofmt or rustfmt for a project, run ' +
       'on save and in a pre-commit hook with the configuration committed — so formatting stays ' +
       'out of your diffs entirely.'],
    ],
  },
  ...
  'pdf-unlock': {
    intro:
      'Removes the password from a PDF you can already open, producing an unencrypted copy. It ' +
      'needs the password — this decrypts a document for your own convenience, it does not ' +
      'break encryption.',
    sections: [
      {
        h: 'Two kinds of PDF password',
        p: 'A user password encrypts the file and is required to open it at all. An owner password ' +
           'leaves the document readable but sets permission flags — no printing, no copying, no ' +
           'editing — which readers are merely asked to honour and many simply ignore. Removing an ' +
           'owner password is trivial because the content was never encrypted; removing a user ' +
           'password requires knowing it, which is why you are asked for it here.',
      },
      {
        h: 'Why the output is image-based',
        p: 'The in-browser PDF engine decrypts and renders the document, then rebuilds a fresh ' +
           'unencrypted file from those rendered pages — it cannot re-emit the original encrypted ' +
           'content streams. The practical consequence is that the result is a picture of the ' +
           'document: text is no longer selectable or searchable, and the file is usually larger. ' +
           'Where you need a searchable unlocked copy, open the original in a desktop reader with ' +
           'the password and export or print to PDF from there.',
      },
      {
        h: 'The legitimate uses, and the line',
        p: 'Your own documents whose password you know and no longer want; a bank statement or ' +
           'payslip that arrives encrypted with a predictable password you must type every time; a ' +
           'file a colleague protected and shared the password for. What this is not for is ' +
           'documents you do not have the password to — the tool cannot help with those, and ' +
           'circumventing access controls on material you are not entitled to read is an offence in ' +
           'most jurisdictions regardless of the technical means.',
      },
    ],
    steps: [
      'Choose the PDF and enter its password.',
      'Unlock and download the unencrypted copy.',
      'Keep the original if you need selectable text — the output is rendered pages.',
    ],
    notes: [
      'You must know the password; this decrypts, it does not crack.',
      'Output text is not selectable or searchable, because pages are rasterised and rebuilt.',
      'The file is processed in your browser and never uploaded.',
    ],
    faq: [
      ['Can this open a PDF if I do not know the password?',
       'No. It decrypts using the password you supply. Recovering an unknown password means ' +
       'brute-forcing the encryption, which this does not attempt — and doing so on a document ' +
       'you are not entitled to read is unlawful in most places.'],
      ['Why is the unlocked file larger and not searchable?',
       'Because the engine rebuilds the document from rendered pages rather than re-emitting the ' +
       'original content streams. For a searchable copy, open the original with its password in ' +
       'a desktop reader and export from there.'],
      ['What is the difference between a user and an owner password?',
       'A user password encrypts the file and is needed to open it. An owner password only sets ' +
       'permission flags such as no-printing, which many readers ignore — the content itself is ' +
       'not protected.'],
    ],
  },
  ...
  'text-to-speech': {
    intro:
      'Reads text aloud using the voices already installed on your device, with control over ' +
      'speed, pitch and volume. Nothing is sent anywhere — the speech synthesis is your ' +
      'operating system\'s, running locally.',
    sections: [
      {
        h: 'The voices come from your device, not from here',
        p: 'This uses the Web Speech API, which hands your text to whatever synthesiser the ' +
           'operating system provides. That means the available voices differ completely between a ' +
           'Mac, a Windows machine, an Android phone and an iPhone, and a voice you choose here will ' +
           'not exist for someone on another platform. It also means quality varies: recent macOS ' +
           'and Android voices are very good, older Windows ones noticeably robotic.',
      },
      {
        h: 'What it is genuinely useful for',
        p: 'Proofreading is the best use by a distance — hearing your own writing read back catches ' +
           'clumsy sentences, repeated words and missing ones that your eye skips over, because you ' +
           'wrote them and know what they should say. Beyond that: listening to an article while ' +
           'doing something else, checking how a name or a brand is pronounced, and accessibility ' +
           'support for reading difficulties, where hearing alongside reading measurably helps ' +
           'comprehension.',
      },
      {
        h: 'Rate, pitch and the limits of tuning',
        p: 'Most people prefer a rate slightly above the default once they are used to it, and ' +
           'regular listeners often run at 1.5× or more. Pitch adjustment is cruder and usually ' +
           'makes a voice sound worse rather than different. What you cannot fix with these controls ' +
           'is prosody: device voices place emphasis mechanically, so they mispronounce homographs, ' +
           'flatten questions and stumble on names. For anything published, record a person.',
      },
      {
        h: 'It is speech, not an audio file',
        p: 'The API speaks; it does not hand you a file. Saving the output means capturing it with ' +
           'recording software, and the licence terms on many system voices restrict redistributing ' +
           'their output. For a podcast, a video voiceover or anything commercial, use a service ' +
           'that licenses its voices for that purpose — and be aware that several now require ' +
           'disclosure when synthetic speech is presented as a person.',
      },
    ],
    steps: [
      'Paste or type your text.',
      'Choose a voice from the ones your device provides.',
      'Adjust rate and pitch, then play.',
    ],
    notes: [
      'Available voices depend entirely on your operating system and browser.',
      'The text is not transmitted — synthesis happens on your device.',
      'There is no download: the API speaks rather than producing a file.',
    ],
    faq: [
      ['Why are there different voices on my phone and my laptop?',
       'Because the voices belong to the operating system rather than to this page. Each ' +
       'platform ships its own set, so the list changes with the device and a voice chosen on ' +
       'one will not exist on another.'],
      ['Can I download the speech as an audio file?',
       'Not from the browser API, which speaks rather than producing a file. Capturing it ' +
       'requires recording software, and many system voices restrict redistribution of their ' +
       'output — use a licensed service for anything published.'],
      ['Is text-to-speech good for proofreading?',
       'It is one of the most effective proofreading techniques there is. Hearing your own ' +
       'writing read back exposes awkward phrasing, repeated words and omissions that you read ' +
       'past on screen, because you know what the sentence is supposed to say.'],
    ],
  },
  ...
  'wifi-qr-generator': {
    intro:
      'Turns your network name and password into a QR code that guests scan to join, instead of ' +
      'reading a long password aloud or typing it into someone\'s phone.',
    sections: [
      {
        h: 'What the code actually contains',
        p: 'A standard format: WIFI:T:WPA;S:NetworkName;P:Password;; — the security type, the SSID ' +
           'and the password, in plain text. Android has read it natively for years and iOS since ' +
           'iOS 11, so a guest points their camera at it and taps a prompt. Because the password is ' +
           'in the code in clear text, anyone who can photograph the code has the password: print ' +
           'one for the guest network, not the one your NAS is on, and do not post it where it is ' +
           'visible from outside.',
      },
      {
        h: 'Use a guest network',
        p: 'Most routers can run a separate guest SSID that reaches the internet and not your local ' +
           'devices. That is the right network to put on a QR code in a café, an office reception or ' +
           'a spare room, because a guest who joins it cannot see your printer, your file shares or ' +
           'your cameras. It also means changing the guest password later does not disconnect ' +
           'everything you own.',
      },
      {
        h: 'Details that stop it working',
        p: 'The SSID is case-sensitive and must match exactly, spaces included. Special characters ' +
           'in the password — semicolons, colons, commas, backslashes — need escaping in the format ' +
           'and are the usual reason a generated code fails silently. Hidden networks need a flag ' +
           'set, which many generators omit. And a code for a 5GHz-only SSID will not connect a ' +
           'device that only supports 2.4GHz, which looks like a broken code and is not.',
      },
    ],
    steps: [
      'Enter the network name exactly as it appears, and the password.',
      'Select the security type — WPA/WPA2 for almost all modern networks.',
      'Generate, test it with your own phone, then print it.',
    ],
    notes: [
      'The password is stored in the code as plain text — anyone who photographs it has it.',
      'Use a guest network for any code you display publicly.',
      'Generated in your browser; the password is never transmitted or stored.',
    ],
    faq: [
      ['Is my WiFi password safe in a QR code?',
       'The code is generated entirely in your browser and nothing is uploaded. But the password ' +
       'is embedded in the code in plain text, so anyone who photographs or copies the code can ' +
       'read it — display it only where that is acceptable, and prefer a guest network.'],
      ['Do iPhones support WiFi QR codes?',
       'Yes, since iOS 11 — the camera app recognises the format and offers to join. Android has ' +
       'supported it for longer and can also generate one for a network you are already on.'],
      ['Why will my WiFi QR code not connect?',
       'Most often the SSID does not match exactly — it is case-sensitive — or the password ' +
       'contains a character such as a semicolon that needs escaping. A 5GHz-only network will ' +
       'also fail to connect an older device regardless of the code.'],
    ],
  },
  ...
  'citation-generator': {
    intro:
      'Builds correctly formatted references in APA 7, MLA 9 and Chicago for books, journal ' +
      'articles, websites, chapters and videos. The formatting is mechanical; knowing which ' +
      'style and what to cite is not.',
    sections: [
      {
        h: 'The three styles, and who uses them',
        p: 'APA 7 is used across psychology, education, nursing and the social sciences, and puts ' +
           'the date immediately after the author because recency matters there. MLA 9 is used in ' +
           'literature and the humanities, where a text\'s date matters less than its page, so it ' +
           'leads with author and title. Chicago offers two systems — notes-bibliography, common in ' +
           'history and the arts, and author-date, used in some sciences. Using the wrong one is a ' +
           'visible error; check your department\'s requirement rather than assuming.',
      },
      {
        h: 'What a reference has to let a reader do',
        p: 'Find the source. Every element exists for that: author to attribute, date to identify ' +
           'the edition, title to locate it, container to say where it lives, and a DOI or URL to ' +
           'reach it directly. A DOI is preferred over a URL for journal articles because it does ' +
           'not rot — URLs move and disappear, which is why many styles now ask for an access date ' +
           'on web sources. If a reference does not let a reader reach the source, it has failed ' +
           'regardless of punctuation.',
      },
      {
        h: 'The parts a generator gets wrong',
        p: 'Capitalisation rules differ by style and by element, and metadata from a publisher is ' +
           'often in the wrong case already. Corporate and organisational authors, edited ' +
           'collections, translated works, multiple works by one author in the same year, and ' +
           'sources with no date or no author all have specific handling. A generator produces a ' +
           'good first pass and introduces errors of exactly this kind — check every reference ' +
           'against the style manual before submitting, because the marks lost are real.',
      },
      {
        h: 'In-text citations are half the job',
        p: 'A reference list without matching in-text citations does not attribute anything, and ' +
           'unattributed use of a source is plagiarism whether or not it appears in your ' +
           'bibliography. Each style has its own rules for two authors, three or more, repeated ' +
           'citation and direct quotation with page numbers. Cite as you write rather than ' +
           'reconstructing at the end — rebuilding citations from memory the night before a deadline ' +
           'is how sources get misattributed.',
      },
    ],
    steps: [
      'Choose the source type and the citation style your department requires.',
      'Enter the details — author, title, date, publisher or journal, DOI or URL.',
      'Copy the reference, then check it against the style manual.',
    ],
    notes: [
      'Prefer a DOI to a URL for journal articles — it remains valid when links move.',
      'Capitalisation, corporate authors and undated sources are where generators most often ' +
       'err.',
      'A reference list does not substitute for in-text citations.',
    ],
    faq: [
      ['Which citation style should I use?',
       'Whichever your department or journal specifies — it is not a preference. Broadly: APA ' +
       'for social sciences, nursing and education; MLA for literature and humanities; Chicago ' +
       'for history and the arts. Check the assignment brief.'],
      ['Are generated citations always correct?',
       'No. They handle the common cases well and reliably struggle with capitalisation, ' +
       'corporate authors, edited collections, translations and undated sources. Treat the ' +
       'output as a draft and verify it against the style manual.'],
      ['Do I need to cite a source I only paraphrased?',
       'Yes. Citation attributes ideas, not only wording. Paraphrasing without a citation is ' +
       'plagiarism in every style guide — the quotation marks are what change between quoting ' +
       'and paraphrasing, not whether you cite.'],
    ],
  },
  'periodic-table': {
    intro:
      'An interactive periodic table with each element\'s atomic number, mass, category and key ' +
      'properties. The arrangement itself carries most of the chemistry, which is what makes it ' +
      'worth exploring rather than looking things up in.',
    sections: [
      {
        h: 'The layout is the information',
        p: 'Elements are ordered by atomic number — protons in the nucleus — and wrapped into rows ' +
           'so that elements with the same outer electron configuration line up in columns. That is ' +
           'why a group behaves alike: the alkali metals in group 1 all have a single outer electron ' +
           'they shed easily, and the noble gases in group 18 have a full shell and react with ' +
           'almost nothing. Mendeleev built this in 1869 from properties alone, before anyone knew ' +
           'about protons, and left gaps for elements he predicted — gallium and germanium arrived ' +
           'within fifteen years and matched his predictions closely.',
      },
      {
        h: 'The trends worth carrying in your head',
        p: 'Atomic radius decreases across a period and increases down a group, because added ' +
           'protons pull the same shell tighter while new shells sit further out. Electronegativity ' +
           'runs the opposite way, peaking at fluorine. Ionisation energy broadly rises across a ' +
           'period. Metals sit left, non-metals right, with the metalloids on the staircase between ' +
           '— which is where the semiconductors live, and why silicon and germanium matter so much.',
      },
      {
        h: 'Atomic mass is an average, which is why it is not a whole number',
        p: 'Chlorine\'s 35.45 is not a chlorine atom; it is the weighted average of chlorine-35 and ' +
           'chlorine-37 as they occur naturally. Individual atoms have whole-number nucleon counts, ' +
           'and the mass on the table reflects natural isotopic abundance — which is why it differs ' +
           'slightly depending on where a sample was mined, and why IUPAC now gives ranges rather ' +
           'than single values for several elements.',
      },
      {
        h: 'The far end of the table',
        p: 'Everything past uranium is synthetic, made atom by atom in accelerators, and most exists ' +
           'for milliseconds. Oganesson, element 118, has been produced in quantities of a few atoms ' +
           'total. The seventh row was completed in 2016, and whether an eighth exists is an open ' +
           'question — there may be an \'island of stability\' near element 126 where nuclei last ' +
           'longer, which is a genuine prediction nobody has yet been able to test.',
      },
    ],
    steps: [
      'Select an element to see its properties.',
      'Note its group and period — the position predicts much of its behaviour.',
      'Compare down a group to see the trends.',
    ],
    notes: [
      'Atomic mass is a weighted average across naturally occurring isotopes, not a single ' +
       'atom.',
      'Group number indicates outer electron configuration, which is what drives reactivity.',
      'Elements beyond 92 are synthetic and most are intensely short-lived.',
    ],
    faq: [
      ['Why is atomic mass not a whole number?',
       'Because it averages the naturally occurring isotopes weighted by abundance. Chlorine\'s ' +
       '35.45 reflects a mix of chlorine-35 and chlorine-37; no individual chlorine atom has ' +
       'that mass.'],
      ['What do the groups and periods mean?',
       'A period is a row and corresponds to an electron shell. A group is a column, and ' +
       'elements in one share an outer electron configuration — which is why they react ' +
       'similarly. Group 1 metals are all violently reactive; group 18 noble gases barely react ' +
       'at all.'],
      ['How many elements are there?',
       '118 are confirmed, through oganesson. Everything beyond uranium (92) is synthetic, and ' +
       'the heaviest exist for fractions of a second in quantities of a few atoms.'],
    ],
  },
  ...
  'csv-viewer': {
    intro:
      'Opens a CSV file as a sortable, searchable table in your browser, without uploading it ' +
      'or waiting for a spreadsheet application to start.',
    sections: [
      {
        h: 'Why not just open it in Excel',
        p: 'Excel changes your data on the way in. Long numeric IDs become scientific notation, ' +
           'leading zeros vanish from postcodes and account numbers, and anything resembling a date ' +
           'is converted — which famously forced geneticists to rename several genes because SEPT2 ' +
           'kept becoming 2-Sep. A viewer shows the file as it actually is. For inspecting data ' +
           'before you process it, that is the difference between seeing the truth and seeing ' +
           'Excel\'s opinion of it.',
      },
      {
        h: 'Delimiters, encodings and the byte-order mark',
        p: 'Comma is the default, but exports from European locales usually use semicolons because ' +
           'the comma is their decimal separator. If the first column header appears with strange ' +
           'characters in front of it, the file starts with a UTF-8 byte-order mark. And a file ' +
           'saved as CSV from Excel on Windows may be Windows-1252 rather than UTF-8, which shows up ' +
           'as mangled accented letters — all three are file problems rather than viewer problems, ' +
           'and recognising which is which saves a lot of time.',
      },
      {
        h: 'Large files and browser limits',
        p: 'The file is held in memory, so a very large CSV can exhaust a browser tab. A few tens of ' +
           'megabytes is usually comfortable; hundreds are not. For genuinely large data, ' +
           'command-line tools stream rather than load — head, csvkit, or DuckDB, which queries a ' +
           'CSV in place with SQL and is remarkably fast. The advantage here is that nothing is ' +
           'uploaded, which matters when the file contains customer or financial data.',
      },
    ],
    steps: [
      'Choose your CSV file.',
      'Adjust the delimiter if the columns come out wrong.',
      'Sort and search to inspect the data.',
    ],
    notes: [
      'The file is read locally and never uploaded.',
      'Values are shown as they appear in the file — nothing is converted to dates or numbers.',
      'Very large files may exhaust browser memory; use a streaming tool for those.',
    ],
    faq: [
      ['Why does my CSV open as one column?',
       'It almost certainly uses semicolons rather than commas, which is standard in European ' +
       'locales where the comma is the decimal separator. Switch the delimiter.'],
      ['Why are there strange characters at the start of my file?',
       'A UTF-8 byte-order mark, which some applications write and others do not expect. It is ' +
       'harmless but will corrupt the first column name if a parser does not handle it.'],
      ['Is this better than opening the file in Excel?',
       'For inspection, yes. Excel silently converts long IDs to scientific notation, strips ' +
       'leading zeros and turns text that resembles dates into dates. A viewer shows what is ' +
       'actually in the file.'],
    ],
  },
  'bar-chart-maker': {
    intro:
      'Builds a bar chart from data you enter or paste, with labels and colours, ready to ' +
      'download. Bar charts are the most reliably readable chart type there is, which is why ' +
      'they are worth defaulting to.',
    sections: [
      {
        h: 'Start the axis at zero — for bars, always',
        p: 'A bar encodes its value by length, so truncating the axis makes a 3% difference look ' +
           'like a 50% one. This is the most common way charts mislead, deliberately or otherwise, ' +
           'and it is not a stylistic question: the visual comparison is simply wrong. Line charts, ' +
           'which encode position rather than length, may start elsewhere when the variation matters ' +
           'more than the absolute level — but bars start at zero.',
      },
      {
        h: 'Sort by value unless the order means something',
        p: 'Categories in alphabetical order or in the order they happened to be entered make a ' +
           'reader do the comparison work themselves. Sorting by value lets the ranking be read ' +
           'instantly, which is usually the point of the chart. The exceptions are real: time, and ' +
           'ordered categories like age bands or satisfaction scales, where the sequence carries ' +
           'meaning and reordering destroys it.',
      },
      {
        h: 'Horizontal bars for long labels',
        p: 'Rotated category labels are hard to read and waste vertical space. If your labels are ' +
           'country names, product names or anything longer than a few characters, turn the chart ' +
           'horizontal so the labels sit level and legible. This is also the right choice when there ' +
           'are many categories — a tall horizontal chart scrolls comfortably where a wide vertical ' +
           'one compresses into stripes.',
      },
      {
        h: 'Colour should mean something or nothing',
        p: 'Using a different colour for every bar implies the colours carry information, and when ' +
           'they do not it is noise. One colour for all bars is the honest default; a second colour ' +
           'to highlight one bar is the most effective use of colour in a chart. Reserve multiple ' +
           'colours for when they encode a real variable, and check that your palette works for the ' +
           'roughly 8% of men with colour vision deficiency.',
      },
    ],
    steps: [
      'Enter or paste your categories and values.',
      'Sort by value unless the category order is meaningful.',
      'Switch to horizontal bars if the labels are long.',
      'Download the chart.',
    ],
    notes: [
      'Bar charts must start at zero — a truncated axis misrepresents the comparison.',
      'Use one colour unless colour encodes a variable; a highlight colour for one bar is the ' +
       'exception.',
      'Data stays in your browser and is not uploaded.',
    ],
    faq: [
      ['Should a bar chart always start at zero?',
       'Yes. Bars encode value by length, so a truncated axis exaggerates differences and ' +
       'misrepresents the data. Line charts, which encode position, have more latitude.'],
      ['When should I use a horizontal bar chart?',
       'When the category labels are long, or when there are many categories. Horizontal bars ' +
       'keep labels level and readable, and a tall chart scrolls better than a wide one ' +
       'compresses.'],
      ['Bar chart or pie chart?',
       'A bar chart almost always. People compare lengths accurately and angles poorly, so a pie ' +
       'chart is harder to read for anything beyond two or three slices — and impossible to read ' +
       'when slices are close in size.'],
    ],
  },
  'pie-chart-maker': {
    intro:
      'Builds a pie chart from categories and values. Pie charts are widely criticised for good ' +
      'reasons — this page explains when one is nonetheless the right choice, and how to make ' +
      'it readable.',
    sections: [
      {
        h: 'Why pie charts are hard to read',
        p: 'People judge length accurately and angle poorly. Cleveland and McGill established the ' +
           'ranking experimentally in the 1980s: position along a common scale is read most ' +
           'accurately, then length, with angle and area well down the list. So two slices of 23% ' +
           'and 26% are nearly indistinguishable in a pie and obviously different as bars. The ' +
           'problem worsens with every additional slice, and a pie with ten categories communicates ' +
           'almost nothing.',
      },
      {
        h: 'When a pie is actually right',
        p: 'When the message is part-of-whole rather than comparison, and there are two or three ' +
           'slices. “Two thirds of our revenue comes from one product” reads instantly as a pie and ' +
           'requires thought as a bar chart, because the pie\'s whole is visually explicit. That is a ' +
           'narrow but genuine use. A donut is the same chart with a hole, which frees the centre ' +
           'for a total — often the most useful number on it.',
      },
      {
        h: 'Making one readable',
        p: 'Sort slices largest to smallest, starting at twelve o\'clock and going clockwise, so a ' +
           'reader can follow the ranking. Label slices directly with both the category and the ' +
           'percentage rather than using a legend, which forces the eye back and forth. Group ' +
           'anything below about 5% into \'Other\' — slices that small cannot be read and their labels ' +
           'collide. And make sure the values actually sum to a meaningful whole, because a pie of ' +
           'things that do not add up to 100% is a category error rather than a design flaw.',
      },
    ],
    steps: [
      'Enter your categories and values.',
      'Sort largest to smallest and group small slices into \'Other\'.',
      'Label slices directly rather than relying on a legend.',
      'Download the chart.',
    ],
    notes: [
      'Use for part-of-whole with two or three categories; use a bar chart for comparison.',
      'Values must sum to a meaningful whole, or a pie is the wrong chart entirely.',
      'Direct labels beat a legend — they remove the lookup the reader would otherwise do.',
    ],
    faq: [
      ['When should I use a pie chart?',
       'When showing parts of a whole with only two or three categories, and when the whole ' +
       'itself matters. For comparing values, a bar chart is read far more accurately — people ' +
       'judge length well and angle badly.'],
      ['How many slices is too many?',
       'More than five is usually too many, and beyond about seven a pie communicates very ' +
       'little. Group small categories into \'Other\' or switch to a horizontal bar chart.'],
      ['Is a donut chart better than a pie?',
       'Marginally, and mostly because the hole gives you space for a total, which is often the ' +
       'most useful number present. The angle-reading problem is unchanged — both are hard to ' +
       'compare accurately.'],
    ],
  },
  ...
  'line-chart-maker': {
    intro:
      'Builds a line chart from a series of values over time. Lines are for continuous change — ' +
      'using one for unordered categories implies a progression that is not there.',
    sections: [
      {
        h: 'The axis rule differs from bar charts',
        p: 'A line encodes position rather than length, so it does not have to start at zero — and ' +
           'often should not, because a stock price between 180 and 195 becomes a flat line on a ' +
           'zero-based axis and shows nothing. What matters is labelling the axis clearly so the ' +
           'reader sees the range. The honest test: would the reader draw a different conclusion if ' +
           'they saw the full range? If so, show it.',
      },
      {
        h: 'Use lines only for ordered data',
        p: 'The line between two points implies values exist in between and moved smoothly. That is ' +
           'true for time and for continuous variables, and false for categories — a line connecting ' +
           'sales by region suggests a journey from one region to the next that does not exist. ' +
           'Ordered categories such as age bands or satisfaction levels are a legitimate middle ' +
           'case. If the x-axis could be reordered without losing meaning, use bars.',
      },
      {
        h: 'Too many lines and nobody reads any of them',
        p: 'Four or five series is about the limit before a chart becomes a tangle. Beyond that, ' +
           'highlight the one or two that matter in colour and render the rest in light grey, which ' +
           'keeps the context and removes the noise. Direct labels at the end of each line beat a ' +
           'legend: a legend makes the reader match colours back and forth, and colour matching is ' +
           'exactly what some readers cannot do.',
      },
      {
        h: 'Gaps, and what a connected line claims',
        p: 'Connecting across missing data draws a line through values you do not have, which ' +
           'quietly asserts something false. Break the line at gaps, or mark interpolated sections ' +
           'visibly. The same applies to irregular intervals: plotting monthly and then yearly ' +
           'points at equal spacing distorts the shape of the trend, and the fix is to space the ' +
           'axis by actual time rather than by observation.',
      },
    ],
    steps: [
      'Enter your time points and values.',
      'Label the axis clearly, especially if it does not start at zero.',
      'Keep to a handful of series, highlighting the ones that matter.',
      'Download the chart.',
    ],
    notes: [
      'Unlike bars, lines need not start at zero — but the axis must be clearly labelled.',
      'Use lines only where the x-axis has a meaningful order.',
      'Break the line across missing data rather than interpolating silently.',
    ],
    faq: [
      ['Should a line chart start at zero?',
       'Not necessarily. Lines encode position, so a zero baseline often flattens the very ' +
       'variation the chart exists to show. Label the axis clearly and ask whether the full ' +
       'range would change the reader\'s conclusion.'],
      ['When should I use a line chart instead of bars?',
       'When the x-axis is continuous and ordered — time, above all. For unordered categories a ' +
       'line implies a progression that does not exist, and bars are the correct choice.'],
      ['How many lines can one chart hold?',
       'Four or five before it becomes unreadable. Beyond that, highlight one or two in colour ' +
       'and grey out the rest, which preserves context while making the point legible.'],
    ],
  },
  'csv-merger': {
    intro:
      'Combines several CSV files into one, matching columns by header so that files with the ' +
      'same fields in a different order still line up correctly.',
    sections: [
      {
        h: 'Header matching is what makes this safe',
        p: 'Stacking files by position breaks the moment one export has its columns in a different ' +
           'order, and the failure is silent — emails land in the phone column and nobody notices ' +
           'until someone tries to use the data. Matching on header names means a file with the same ' +
           'fields in any order merges correctly, and a file with an extra field gets a column with ' +
           'blanks elsewhere rather than corrupting the rows.',
      },
      {
        h: 'Check the headers before you merge',
        p: 'Near-identical headers are the usual problem: \'Email\' against \'email\' against \'E-mail\', ' +
           'or a trailing space that nobody can see. Each variant becomes its own column, and the ' +
           'result looks merged while being split. Normalise the headers across your files first — ' +
           'lowercase, trimmed, consistent spelling — which takes a minute and prevents an afternoon ' +
           'of reconciliation.',
      },
      {
        h: 'Merging is not deduplicating',
        p: 'Combining two exports that overlap gives you duplicate rows, and removing them needs a ' +
           'decision about what makes two rows the same. Identical across every column is easy; ' +
           'identical email address with different names is a judgement call about which record ' +
           'wins. Decide that before merging rather than discovering it afterwards, and keep the ' +
           'source files so you can redo it differently.',
      },
    ],
    steps: [
      'Select the CSV files to combine.',
      'Check the detected headers and normalise any near-duplicates first.',
      'Merge and download the combined file.',
    ],
    notes: [
      'Columns are matched by header name, not by position.',
      'Headers differing in case or whitespace become separate columns — normalise them first.',
      'Files are read locally; nothing is uploaded.',
    ],
    faq: [
      ['What if my files have different columns?',
       'Columns are matched by header, so a field present in only some files produces a column ' +
       'with blanks for the rows that lack it. Nothing is dropped and nothing is misaligned.'],
      ['Does merging remove duplicate rows?',
       'No — it combines. Deduplication is a separate step and needs a decision about what makes ' +
       'two rows the same, which depends on your data rather than on the file format.'],
      ['Why did one column split into two?',
       'The headers differ somewhere invisible — case, a trailing space, a hyphen against an ' +
       'underscore. Normalise the header row across all files before merging.'],
    ],
  },
  'csv-to-json-table': {
    intro:
      'Converts CSV into JSON and displays it as a table at the same time, so you can see the ' +
      'structure and the data together before using either.',
    sections: [
      {
        h: 'Seeing the shape is the point',
        p: 'A converter that only emits JSON leaves you checking the result by reading it. Showing ' +
           'the table alongside makes structural problems obvious immediately: a shifted column from ' +
           'an unquoted comma, a header row that was actually data, a trailing empty column from a ' +
           'stray delimiter. Those are all easier to spot in a grid than in nested braces.',
      },
      {
        h: 'Types are inferred, and inference is conservative here',
        p: 'A field becomes a number only when the entire value is one, so “12 Main St” stays a ' +
           'string rather than becoming 12. Leading-zero values such as postcodes stay strings, ' +
           'because converting them loses information, and integers beyond 2⁵³ stay strings because ' +
           'JSON numbers cannot represent them exactly. The result is per-cell rather than ' +
           'per-column, so a column can contain both — which is inherent to CSV having no type ' +
           'information at all.',
      },
      {
        h: 'What to do with the output',
        p: 'JSON from a spreadsheet export is a common way to seed a database, populate a test ' +
           'fixture or feed an API. Check the field names first: spreadsheet headers often contain ' +
           'spaces and capitals that make awkward JSON keys, and renaming them at this point is far ' +
           'easier than after the data is in a system. Empty cells become null rather than empty ' +
           'strings, which preserves the distinction between a missing value and a blank one.',
      },
    ],
    steps: [
      'Paste or upload your CSV.',
      'Check the table for shifted columns or a misread header row.',
      'Copy the JSON.',
    ],
    notes: [
      'Quoted fields may contain commas, newlines and doubled quotes.',
      'Empty cells become null; leading-zero values and very large integers stay as strings.',
      'Conversion runs in your browser — exported data is not uploaded.',
    ],
    faq: [
      ['Why is my number showing as a string?',
       'Because converting it would lose information — a leading zero would disappear, or the ' +
       'integer is beyond what a JSON number represents exactly. Both are deliberate.'],
      ['What happens to empty cells?',
       'They become null rather than an empty string, which keeps a missing value ' +
       'distinguishable from a deliberately blank one.'],
      ['Can I rename the JSON keys?',
       'Edit the header row in the CSV before converting — the headers become the keys. Doing it ' +
       'there is much easier than renaming fields once the data is loaded somewhere.'],
    ],
  },
  ...
  'flashcard-maker': {
    intro:
      'Creates flashcards from question and answer pairs and quizzes you on them. The format is ' +
      'old and the evidence behind it is unusually strong — provided you use it the hard way.',
    sections: [
      {
        h: 'Retrieval practice beats rereading, by a lot',
        p: 'Testing yourself produces substantially better retention than rereading the same ' +
           'material, and the effect is one of the most replicated findings in cognitive psychology. ' +
           'The catch is that rereading feels more productive, because the material is familiar and ' +
           'fluent, while retrieval feels effortful and error-prone. Students consistently rate the ' +
           'less effective method as the better one. The discomfort is the mechanism working.',
      },
      {
        h: 'Space the repetitions',
        p: 'Reviewing at increasing intervals — a day, three days, a week, two weeks — produces far ' +
           'better long-term retention than the same total time spent in one session. Cramming works ' +
           'for a test tomorrow and almost nothing survives a month. This is why spaced repetition ' +
           'software exists: it schedules each card individually based on how well you recalled it, ' +
           'which is impractical to do by hand across hundreds of cards.',
      },
      {
        h: 'One fact per card, and write the question properly',
        p: 'A card asking “everything about the French Revolution” cannot be graded honestly. Break ' +
           'material into single facts with unambiguous answers. Avoid cards where the question ' +
           'contains its own answer or where recognition substitutes for recall — the point is ' +
           'producing the answer from memory, not confirming you have seen it. Cards you wrote ' +
           'yourself outperform downloaded decks, because writing them is itself an encoding step.',
      },
      {
        h: 'Be honest when you grade yourself',
        p: 'The value comes from the difficulty, so marking a card correct because you almost had it ' +
           'defeats the exercise. If you had to think for ten seconds, it is not learned. Leech ' +
           'cards — the ones you keep failing — usually mean the card is badly written rather than ' +
           'that you are incapable: rewrite it, break it into smaller pieces, or add a mnemonic.',
      },
    ],
    steps: [
      'Add your question and answer pairs, one fact per card.',
      'Study the deck, answering before revealing.',
      'Grade yourself honestly, and review again after a day, then three days, then a week.',
    ],
    notes: [
      'Cards you write yourself work better than downloaded decks — writing them is part of the ' +
       'learning.',
      'Spacing reviews across days beats the same time in one session.',
      'Cards stay in your browser — export or note them down if you need them later.',
    ],
    faq: [
      ['Do flashcards actually work?',
       'Yes, and the evidence is unusually strong — retrieval practice consistently outperforms ' +
       'rereading. It also feels less effective while you are doing it, which is why people ' +
       'abandon it for methods that feel better and work worse.'],
      ['How often should I review?',
       'At expanding intervals: a day, then three, then a week, then two. Spaced review produces ' +
       'far better long-term retention than the same total time crammed into one session.'],
      ['Should I make my own cards or download a deck?',
       'Make your own where you can. Writing a card forces you to decide what the fact actually ' +
       'is and how to ask it, which is itself a substantial part of the learning.'],
    ],
  },
  'grade-calculator': {
    intro:
      'Works out a course grade from weighted assessment components, and what you need on what ' +
      'remains to reach a target.',
    sections: [
      {
        h: 'Weighting is what people get wrong',
        p: 'A grade is the sum of each component\'s score multiplied by its weight, not the average ' +
           'of the scores. Scoring 90% on a quiz worth 10% and 60% on a final worth 60% is not 75% — ' +
           'it is much closer to the final. This is why a strong start can be undone by one heavy ' +
           'assessment, and why checking the weightings at the beginning of a course tells you where ' +
           'the effort actually matters.',
      },
      {
        h: 'Work out what you need while you can still act on it',
        p: 'The useful calculation is the reverse one: given what you have scored so far, what does ' +
           'the remaining work have to average for a target grade? Doing that before the final ' +
           'rather than after tells you whether you need 55% or 95%, which are completely different ' +
           'amounts of preparation. If the required figure exceeds 100%, the target is gone and the ' +
           'honest response is to aim at the next one down rather than discovering it at results.',
      },
      {
        h: 'Check how your institution actually rounds',
        p: 'Some round 69.5 up to a 70, some do not round at all, and some have a discretionary band ' +
           'just below each boundary where borderline cases are reviewed. Whether a 69.4 becomes a ' +
           '70 is a policy question with a definite answer, published in your course handbook, and ' +
           'it is worth knowing before you conclude you are half a mark short. Dropped-lowest-score ' +
           'rules and resit caps also change the arithmetic substantially.',
      },
    ],
    steps: [
      'Enter each assessment with its score and weight.',
      'Read your current weighted grade.',
      'Enter a target to see what the remaining work must average.',
    ],
    notes: [
      'Weights should total 100%; a shortfall means an assessment is missing from the list.',
      'A required score above 100% means the target is no longer reachable.',
      'Check your institution\'s rounding and dropped-score policies — they change the result.',
    ],
    faq: [
      ['How do I calculate a weighted grade?',
       'Multiply each score by its weight as a decimal and add them. 90% on a component worth ' +
       '20% contributes 18 points, not 90 — which is why heavily weighted assessments dominate ' +
       'the result.'],
      ['What do I need on the final to pass?',
       'Enter your scores so far and your target, and the calculator solves for the remaining ' +
       'average. Do it before the exam, while the answer can still change how you prepare.'],
      ['Does my school round grades up?',
       'It varies, and it is published — check the course handbook. Some round at .5, some ' +
       'truncate, and many have a discretionary band just below each boundary for borderline ' +
       'cases.'],
    ],
  },
  'gpa-planner': {
    intro:
      'Calculates GPA from course grades and credit hours, and works out what future terms need ' +
      'to reach a target GPA.',
    sections: [
      {
        h: 'Credit hours weight everything',
        p: 'GPA is the sum of grade points times credits, divided by total credits — so a ' +
           'four-credit course affects it twice as much as a two-credit one. A poor grade in a heavy ' +
           'course costs considerably more than the same grade in a light one, and this is worth ' +
           'knowing when deciding where to spend limited time in a difficult term.',
      },
      {
        h: 'Later terms move the number less and less',
        p: 'Cumulative GPA averages across everything taken, so each additional term is a smaller ' +
           'share of the total. Raising a 2.5 after 30 credits is very achievable; raising it after ' +
           '100 credits requires sustained near-perfect performance across many terms. The planner ' +
           'makes this concrete, and the honest conclusion is sometimes that a target is out of ' +
           'reach — better established now than assumed until graduation.',
      },
      {
        h: 'Scales and conversions are not standard',
        p: 'The 4.0 scale is common in the US and far from universal. Some institutions use a 4.3 ' +
           'with an A+, India commonly uses a 10-point CGPA, and many European systems use entirely ' +
           'different scales. Converting between them is approximate and institution-specific — ' +
           'graduate schools and employers usually have their own conversion tables, and using a ' +
           'generic one on an application invites a discrepancy. Report your GPA on your own ' +
           'institution\'s scale and say which it is.',
      },
    ],
    steps: [
      'Enter each course with its grade and credit hours.',
      'Read your term and cumulative GPA.',
      'Set a target to see what future terms must average.',
    ],
    notes: [
      'Credit hours weight each course — a four-credit grade counts twice a two-credit one.',
      'Pass/fail courses usually carry credits without grade points; check whether yours do.',
      'Always state which scale your GPA is on; a bare number is ambiguous internationally.',
    ],
    faq: [
      ['How is GPA calculated?',
       'Multiply each course\'s grade points by its credit hours, add them, and divide by the ' +
       'total credits. The credit weighting is what makes heavy courses matter more.'],
      ['Can I raise my GPA significantly?',
       'It depends how many credits you have already taken. Early on, one strong term moves it a ' +
       'lot; after a hundred credits, each additional term is a small share of the average and ' +
       'change is slow.'],
      ['How do I convert my GPA to another country\'s scale?',
       'Approximately at best, and the receiving institution usually has its own table. Report ' +
       'your GPA on your own institution\'s scale, state the scale, and let them convert.'],
    ],
  },
  'quiz-generator': {
    intro:
      'Builds a multiple-choice quiz from questions and answers you enter, then runs it and ' +
      'scores the result. Useful for self-testing, teaching and revision groups.',
    sections: [
      {
        h: 'Writing questions that test understanding',
        p: 'A question answerable by recognising a phrase from the notes tests familiarity, not ' +
           'knowledge. Better questions ask for application — given a situation, what happens — or ' +
           'require distinguishing between things that are genuinely similar. The quickest test of a ' +
           'question\'s quality is whether someone who understood the material but read different ' +
           'notes could still answer it.',
      },
      {
        h: 'The distractors are the hard part',
        p: 'Wrong options that are obviously wrong make a question free. Good distractors are ' +
           'plausible and represent actual misconceptions — the mistake someone would really make. ' +
           'That also makes the quiz diagnostic: if everyone picks the same wrong answer, you have ' +
           'found a specific misunderstanding rather than general weakness. Avoid \'all of the ' +
           'above\', which usually gives the answer away, and keep options similar in length, since ' +
           'the longest is correct far more often than chance.',
      },
      {
        h: 'Testing is a learning method, not only an assessment',
        p: 'Being tested on material improves retention of it, beyond the effect of the time spent — ' +
           'the testing effect. That means a quiz used for practice is not merely measuring ' +
           'learning, it is producing it, and getting a question wrong and then seeing the right ' +
           'answer is particularly effective. Frequent low-stakes quizzing outperforms occasional ' +
           'high-stakes testing for both retention and anxiety.',
      },
    ],
    steps: [
      'Add each question with its options and the correct answer.',
      'Write distractors that represent real misconceptions.',
      'Run the quiz and review the questions you got wrong.',
    ],
    notes: [
      'Keep options similar in length — the longest option is correct more often than chance.',
      'Avoid \'all of the above\', which tends to signal the answer.',
      'Questions stay in your browser; note them down if you want to reuse them.',
    ],
    faq: [
      ['How do I write good multiple-choice questions?',
       'Test application rather than recognition, and make every distractor a plausible mistake ' +
       'someone would really make. A question whose wrong options are obviously wrong tests ' +
       'nothing.'],
      ['How many options should each question have?',
       'Four is conventional and three is fine. What matters is that every option is plausible — ' +
       'a fourth option nobody would choose adds nothing but reading time.'],
      ['Does taking a quiz help me learn?',
       'Yes, measurably. Retrieval improves retention beyond the time spent, and getting ' +
       'something wrong and then seeing the correct answer is especially effective. Frequent ' +
       'low-stakes quizzing works better than rare high-stakes tests.'],
    ],
  },
  ...
  'json-to-xml': {
    intro:
      'Converts JSON into XML. The two formats do not map cleanly onto each other, so the ' +
      'useful part is knowing which compromises any converter has to make.',
    sections: [
      {
        h: 'XML needs things JSON does not have',
        p: 'Every XML document requires exactly one root element, and a JSON array has no name for ' +
           'one — so a converter invents something like <root> or <item>. XML element names cannot ' +
           'start with a digit or contain spaces, which JSON keys frequently do, so those keys must ' +
           'be escaped or renamed. And XML has no native array: repeated elements imply a list, ' +
           'which means an array of one item is indistinguishable from a single value once ' +
           'converted.',
      },
      {
        h: 'Types disappear',
        p: 'JSON distinguishes the number 42 from the string "42", and true from "true". XML content ' +
           'is text, so that distinction is lost unless a schema restores it. Anything consuming the ' +
           'output has to know the types independently, which is why XML ecosystems lean so heavily ' +
           'on XSD. If you control both ends, this is manageable; if you are producing XML for ' +
           'someone else\'s parser, check what they expect.',
      },
      {
        h: 'Where you still need XML',
        p: 'Legacy enterprise integrations, SOAP services, government and banking interfaces, RSS, ' +
           'and document formats like DOCX and SVG. XML is not fashionable and it is far from dead, ' +
           'and it has genuine advantages JSON lacks: namespaces, attributes, comments, mixed ' +
           'content and mature schema validation. Converting JSON to XML is almost always about ' +
           'meeting a system that requires it rather than choosing it.',
      },
    ],
    steps: [
      'Paste your JSON.',
      'Copy the XML output.',
      'Check the root element name and any renamed keys against what the receiving system ' +
       'expects.',
    ],
    notes: [
      'A root element is invented because XML requires one and JSON does not supply it.',
      'Keys that are not valid XML element names must be escaped or renamed.',
      'Type information is lost — everything becomes text.',
    ],
    faq: [
      ['Why does my XML have an extra root element?',
       'Because XML permits exactly one root and JSON, particularly a top-level array, does not ' +
       'provide a name for it. The converter supplies one; rename it to whatever the receiving ' +
       'system expects.'],
      ['What happens to JSON arrays?',
       'They become repeated elements, which is XML\'s equivalent. The consequence is that an ' +
       'array containing one item looks identical to a single value, so consuming code needs a ' +
       'schema or prior knowledge to tell them apart.'],
      ['Can I convert the XML back to JSON?',
       'Approximately. Attributes, namespaces, comments and element order have no JSON ' +
       'equivalent, and types were already lost, so a round trip gives you something ' +
       'structurally similar rather than identical.'],
    ],
  },
  ...
  'regex-tester-adv': {
    intro:
      'Tests a regular expression against sample text with capture groups, named groups, all ' +
      'flags and a match breakdown. For patterns complex enough that building them by trial in ' +
      'code is too slow.',
    sections: [
      {
        h: 'Named groups make a pattern maintainable',
        p: '(?<year>\\d{4})-(?<month>\\d{2}) is readable in a way that $1 and $2 are not, and it ' +
           'survives someone adding a group in the middle — which silently renumbers every ' +
           'positional reference after it. Named groups are supported in every current browser and ' +
           'in most languages, and for any pattern you will look at again in six months they are ' +
           'worth the extra characters.',
      },
      {
        h: 'Lookarounds assert without consuming',
        p: 'A lookahead (?=...) or lookbehind (?<=...) checks that something is or is not present ' +
           'without including it in the match. That is how you match a number only when it follows a ' +
           'currency symbol, or find a word not followed by a particular suffix. Lookbehind was the ' +
           'last piece to arrive in JavaScript and is still unsupported in Safari versions people ' +
           'actually run, so check compatibility before relying on it in production.',
      },
      {
        h: 'Catastrophic backtracking is a denial-of-service vector',
        p: 'Nested quantifiers over overlapping alternatives — (a+)+$ being the canonical example — ' +
           'can take exponential time on an input that nearly matches. Thirty characters can hang a ' +
           'process for minutes, and this has caused real outages, including a Cloudflare incident ' +
           'in 2019. If a pattern is noticeably slow here on short input, it will be catastrophic on ' +
           'long input. Never run a user-supplied regex server-side without a timeout.',
      },
      {
        h: 'Know when to stop',
        p: 'Regular expressions are excellent for patterns and poor for structure. HTML, JSON and ' +
           'arbitrarily nested constructs are not regular languages, and no pattern handles them ' +
           'correctly — use a parser. The other limit is maintainability: a hundred-character ' +
           'pattern that works is a liability, and splitting it into several named steps is nearly ' +
           'always better than being clever in one line.',
      },
    ],
    steps: [
      'Enter your pattern and set the flags.',
      'Paste realistic test text, including cases that should NOT match.',
      'Check the captured groups and adjust.',
    ],
    notes: [
      'Syntax is JavaScript\'s; lookbehind support still varies in older Safari.',
      'Test negative cases — most regex bugs are false positives, not missed matches.',
      'A pattern that is slow on short input will be catastrophic on long input.',
    ],
    faq: [
      ['What is catastrophic backtracking?',
       'A pattern with nested quantifiers over overlapping alternatives can take exponential ' +
       'time on input that nearly matches, hanging a process on a very short string. Rewrite to ' +
       'avoid nesting, and never run untrusted patterns without a timeout.'],
      ['Should I use named or numbered capture groups?',
       'Named, for anything you will maintain. Adding a group in the middle of a pattern ' +
       'renumbers every positional reference after it, silently; named groups are unaffected and ' +
       'read far better.'],
      ['Can a regex parse HTML?',
       'Not correctly. HTML nesting is not a regular language, so no pattern handles it in ' +
       'general. For a quick extraction from known well-formed markup it sometimes suffices; for ' +
       'anything else use a parser such as the browser\'s DOMParser.'],
    ],
  },
  ...
  'rule-of-72-calc': {
    intro:
      'Estimates how long money takes to double at a given rate of return, by dividing 72 by ' +
      'the rate. A mental shortcut accurate enough to be genuinely useful and simple enough to ' +
      'do without a calculator.',
    sections: [
      {
        h: 'Why 72, and how accurate it is',
        p: 'The exact doubling time is ln(2)/ln(1+r), and ln(2) is about 0.693 — so 69.3 would be ' +
           'the mathematically natural numerator. 72 is used instead because it divides cleanly by ' +
           '2, 3, 4, 6, 8, 9 and 12, which is what makes the rule doable in your head. It is most ' +
           'accurate around 8%: at 8% the rule says 9 years against an exact 9.01. At 2% it ' +
           'overestimates slightly, and above about 20% it drifts noticeably.',
      },
      {
        h: 'Use it in both directions',
        p: 'The reverse is equally useful: 72 divided by the years you have gives the return you ' +
           'would need. To double money in six years requires about 12% a year, which immediately ' +
           'tells you whether a plan is plausible. Applied to inflation it tells you how fast prices ' +
           'double — at 6%, in twelve years — which is the fastest way to show why a long-term ' +
           'nominal figure is misleading.',
      },
      {
        h: 'It also works on debt, unpleasantly',
        p: 'Compound interest works identically against you. A credit card at 36% doubles what you ' +
           'owe in two years if nothing is paid. A personal loan at 18% doubles in four. Applying ' +
           'the rule to debt rather than investments is the clearest way to see why high-interest ' +
           'borrowing should be cleared before almost any investment is started — the guaranteed ' +
           'cost is higher than any reliable return.',
      },
    ],
    steps: [
      'Enter the annual rate of return.',
      'Read the estimated doubling time.',
      'Or enter a target number of years to see the rate required.',
    ],
    notes: [
      'Most accurate near 8%; drifts above about 20%.',
      'Assumes a constant annual rate — real returns vary, sometimes a great deal.',
      'Works identically on debt, which is where it is most sobering.',
    ],
    faq: [
      ['How accurate is the rule of 72?',
       'Very, in the range people use it. At 8% it gives 9 years against an exact 9.01. It ' +
       'drifts at very low and very high rates, where 69.3 or 70 is a closer numerator — but 72 ' +
       'divides cleanly, which is the whole point.'],
      ['How long to double money at 12%?',
       'About six years, since 72 ÷ 12 = 6. At 8% it is nine years, at 6% twelve, and at 4% ' +
       'eighteen — which shows how much difference a few percentage points make over a lifetime.'],
      ['Does the rule of 72 work for inflation?',
       'Yes, and it is one of the most useful applications. At 6% inflation prices double in ' +
       'twelve years, which is the quickest way to show why a large nominal figure two decades ' +
       'out is worth far less than it sounds.'],
    ],
  },
  ...
  'magic-8-ball': {
    intro:
      'A virtual Magic 8-Ball that returns one of the twenty classic answers at random. Ask it ' +
      'a yes-or-no question and shake.',
    sections: [
      {
        h: 'The twenty answers, and why they are split that way',
        p: 'The original toy, made since 1950, contains an icosahedron with twenty faces: ten ' +
           'affirmative, five non-committal and five negative. That distribution is deliberate — a ' +
           'two-to-one lean toward yes, with a quarter of answers refusing to commit at all. It ' +
           'makes the toy feel encouraging without being useless, which is a better piece of design ' +
           'than it gets credit for.',
      },
      {
        h: 'Each shake is independent',
        p: 'There is no memory between answers, so asking the same question repeatedly gives ' +
           'different results and the third answer is no more authoritative than the first. Shaking ' +
           'until you like the answer is the classic use, and it reveals what you wanted — which is ' +
           'genuinely the most useful thing the toy does. If “Don\'t count on it” makes you feel ' +
           'relieved, you have your answer and it is not the ball\'s.',
      },
      {
        h: 'Randomness that is not pretending',
        p: 'Answers are drawn using the browser\'s cryptographic random source, so the sequence is ' +
           'not reproducible or predictable. That is more randomness than the application requires, ' +
           'and it costs nothing — and it means nobody can claim the page is weighted. The physical ' +
           'toy is arguably less fair: the die can settle unevenly in the fluid and some faces are ' +
           'reported to come up more often.',
      },
    ],
    steps: [
      'Think of a yes-or-no question.',
      'Shake, and read the answer.',
      'Notice how you feel about it — that is the actually useful part.',
    ],
    notes: [
      'Twenty possible answers: ten positive, five non-committal, five negative.',
      'Each shake is independent — repeating a question does not refine the answer.',
      'Works offline once loaded.',
    ],
    faq: [
      ['How many answers does a Magic 8-Ball have?',
       'Twenty, on the faces of an icosahedron: ten affirmative, five non-committal and five ' +
       'negative. The lean toward yes is original to the 1950 design.'],
      ['Is the Magic 8-Ball random?',
       'This one is — each answer is drawn from the browser\'s cryptographic random generator. ' +
       'The physical toy is arguably less so, since the die can settle unevenly in the fluid.'],
      ['Can I ask the same question twice?',
       'You can, and the answers are independent, so the second is no more authoritative than ' +
       'the first. What re-asking does reveal is which answer you were hoping for.'],
    ],
  },
  'bingo-card-generator': {
    intro:
      'Generates bingo cards with randomised numbers or your own words, ready to print. For ' +
      'classrooms, fundraisers, team events and conference-call bingo.',
    sections: [
      {
        h: 'How a standard card is built',
        p: 'A 75-ball bingo card is 5×5 with a free centre square, and each column draws from its ' +
           'own range: B from 1–15, I from 16–30, N from 31–45, G from 46–60 and O from 61–75. That ' +
           'constraint is why the columns are labelled and why a number can only appear in one of ' +
           'them. 90-ball bingo, common in the UK, uses a completely different 9×3 ticket layout ' +
           'with fifteen numbers per ticket.',
      },
      {
        h: 'Every card must be different',
        p: 'Two identical cards in a room produce two simultaneous winners and an argument, which is ' +
           'the one failure mode that matters. Generating each card independently makes duplicates ' +
           'vanishingly unlikely — the number of possible 75-ball cards runs to the quintillions — ' +
           'but it is worth a glance across a printed set before handing them out, particularly with ' +
           'small word lists where the space of possible cards is far smaller.',
      },
      {
        h: 'Word bingo and how many words you need',
        p: 'For picture or word bingo you need meaningfully more words than squares, or cards start ' +
           'resembling each other. Twenty-four words for a 5×5 card produces near-identical cards ' +
           'differing only in arrangement; forty or more gives genuine variety. This is the usual ' +
           'reason a classroom set feels repetitive — not the generator, but the word list being too ' +
           'short for the number of squares.',
      },
    ],
    steps: [
      'Choose numbers or enter your own words.',
      'Set how many cards you need.',
      'Generate, check a few for duplicates, and print.',
    ],
    notes: [
      'Standard 75-ball cards are 5×5 with a free centre and column-specific number ranges.',
      'For word bingo, supply well over 24 words or the cards will look alike.',
      'Generated in your browser; nothing is uploaded.',
    ],
    faq: [
      ['How many numbers are on a bingo card?',
       'Twenty-four on a standard 75-ball card, plus a free centre square, arranged 5×5. Each ' +
       'column draws from its own range of fifteen numbers, which is why the columns are ' +
       'labelled B-I-N-G-O.'],
      ['Can I make bingo cards with words instead of numbers?',
       'Yes — enter your own list. Supply considerably more words than squares, ideally forty or ' +
       'more for a 5×5 card, or the cards will differ only in arrangement.'],
      ['Will any two cards be identical?',
       'With numbers, effectively never — there are quintillions of possible cards. With a short ' +
       'word list the space is much smaller, so check a printed set before distributing them.'],
    ],
  },
  'spinner-wheel': {
    intro:
      'A spinning wheel you fill with your own options, for picking one at random in front of ' +
      'an audience. The spin is theatre; the result is a fair draw.',
    sections: [
      {
        h: 'The animation is not the randomness',
        p: 'The winning segment is chosen before the wheel starts turning, using the browser\'s ' +
           'cryptographic random source, and the animation is then rendered to land on it. That is ' +
           'how essentially every digital wheel works, and it is more honest than simulating physics ' +
           '— which would introduce bias from the starting position and friction model. It also ' +
           'means spinning harder or at a particular moment changes nothing.',
      },
      {
        h: 'Why a wheel rather than a list picker',
        p: 'Identical mathematics, very different social effect. A result that appears instantly ' +
           'feels asserted; one that visibly settles after a spin feels drawn, and a room accepts it ' +
           'differently. That is the entire reason wheels are used in classrooms, on streams and at ' +
           'events — the ceremony is the product, and it does real work in making an arbitrary ' +
           'decision feel legitimate.',
      },
      {
        h: 'Weighting, and running a draw people trust',
        p: 'Listing an option more than once gives it proportionally more of the wheel, which is a ' +
           'simple way to weight a draw — and an easy accidental mistake if a name is duplicated. ' +
           'Show the full wheel before spinning so everyone can see what is on it, spin once, and ' +
           'take the result. Re-spinning until you like the answer is exactly what the wheel exists ' +
           'to prevent, and people notice immediately.',
      },
    ],
    steps: [
      'Enter your options, one per line.',
      'Show the wheel to everyone before spinning.',
      'Spin once and take the result.',
    ],
    notes: [
      'The result is drawn cryptographically before the animation begins.',
      'Duplicate entries occupy more of the wheel — useful deliberately, a problem ' +
       'accidentally.',
      'Options stay in your browser and are not saved.',
    ],
    faq: [
      ['Is the spinner wheel actually random?',
       'Yes. The winning segment is selected using the browser\'s cryptographic random generator ' +
       'before the animation runs, and the wheel is then drawn to land there. How you spin makes ' +
       'no difference.'],
      ['Can I make one option more likely?',
       'Enter it more than once — it then occupies proportionally more of the wheel. Watch for ' +
       'accidental duplicates for the same reason.'],
      ['Why use a wheel instead of just picking randomly?',
       'The mathematics is identical; the social effect is not. A visible spin makes an ' +
       'arbitrary decision feel legitimate to a room in a way an instant result does not.'],
    ],
  },
  ...
  'voice-recorder': {
    intro:
      'Records audio from your microphone in the browser and lets you download the result. ' +
      'Nothing is uploaded — the recording stays on your device.',
    sections: [
      {
        h: 'Permissions and what the indicator means',
        p: 'The browser asks before granting microphone access, and shows a recording indicator in ' +
           'the tab while it is active — both are enforced by the browser, not by the page. ' +
           'Microphone access requires a secure context, so this only works over HTTPS. If the ' +
           'prompt never appears, permission was likely denied previously and is remembered; reset ' +
           'it in the site settings rather than reloading repeatedly.',
      },
      {
        h: 'Getting a usable recording',
        p: 'Room acoustics matter more than equipment. A hard-surfaced room produces reflections ' +
           'that no processing fully removes, so record somewhere with soft furnishings — a wardrobe ' +
           'full of clothes genuinely outperforms an empty office. Keep the microphone close, around ' +
           'a hand\'s width, and slightly off-axis so plosives do not hit it directly. Record a few ' +
           'seconds of silence at the start: it gives noise-reduction tools a profile to work from.',
      },
      {
        h: 'Formats and what the browser gives you',
        p: 'Browsers record to WebM with Opus, or on Safari to MP4 with AAC — you do not choose, and ' +
           'the format depends on the browser. Both are lossy and both are fine for speech. If you ' +
           'need WAV for an editing workflow, convert afterwards, accepting that the quality lost at ' +
           'recording cannot be recovered. For speech, the default is entirely adequate.',
      },
      {
        h: 'Recording other people',
        p: 'Consent law varies and matters. Many US states require all parties to consent to ' +
           'recording a conversation; others require only one. The EU and UK treat a recording of an ' +
           'identifiable person as personal data. The practical rule that works everywhere: say you ' +
           'are recording and get agreement on the recording itself, which takes five seconds and ' +
           'removes the question entirely.',
      },
    ],
    steps: [
      'Allow microphone access when prompted.',
      'Record a few seconds of silence first, then speak.',
      'Stop, listen back, and download.',
    ],
    notes: [
      'Requires HTTPS and microphone permission; the browser shows a recording indicator.',
      'Output format is chosen by the browser — WebM/Opus, or MP4/AAC on Safari.',
      'Audio stays on your device and is not uploaded.',
    ],
    faq: [
      ['Why will my microphone not work?',
       'Usually permission was denied and the browser remembers it — reset it in the site ' +
       'settings rather than reloading. Microphone access also requires HTTPS, and another ' +
       'application may be holding the device exclusively.'],
      ['What format does it record in?',
       'Whatever the browser provides: typically WebM with Opus, or MP4 with AAC on Safari. You ' +
       'cannot choose, but both are perfectly adequate for speech.'],
      ['Is it legal to record a conversation?',
       'It depends where you are — some jurisdictions need every party\'s consent, others only ' +
       'one, and recordings of identifiable people are personal data under GDPR. Announcing that ' +
       'you are recording and getting agreement on tape resolves it everywhere.'],
    ],
  },
  ...
  'italic-text-generator': {
    intro:
      'Converts text into Unicode italic characters, which keep their slant when pasted into a ' +
      'bio or post that offers no formatting controls.',
    sections: [
      {
        h: 'Characters, not styling',
        p: 'The output uses the Mathematical Alphanumeric Symbols block, encoded so that an italic ' +
           'variable in a formula is distinguishable from an upright one. Because the slant is part ' +
           'of the character rather than applied by markup, it survives a paste into LinkedIn, ' +
           'Instagram or X — none of which offer italics in posts, which is the whole reason these ' +
           'are used.',
      },
      {
        h: 'The accessibility and search cost',
        p: 'Screen readers handle these badly, often announcing each character by its formal Unicode ' +
           'name, and the text is invisible to search — platform search included. Since italics ' +
           'usually mark emphasis or a title, the cost lands precisely on the words that mattered. ' +
           'Keep names, keywords and calls to action in plain text and use the styling for a short ' +
           'decorative phrase.',
      },
      {
        h: 'Prefer real formatting where it exists',
        p: 'Slack, Discord, WhatsApp and Notion all support markdown-style italics, which are ' +
           'announced correctly and indexed properly. Reaching for Unicode characters on a platform ' +
           'that already has italics trades function for nothing. Use these only where the platform ' +
           'genuinely offers no alternative.',
      },
    ],
    steps: [
      'Type or paste your text.',
      'Copy the italic version.',
      'Use it for a short phrase, not a whole post.',
    ],
    notes: [
      'Only letters convert; punctuation and digits pass through unchanged.',
      'Unsearchable and poorly announced by screen readers.',
      'Use the platform\'s own italics wherever they exist.',
    ],
    faq: [
      ['Will italic text work on Instagram?',
       'Yes, in bios and captions, and on LinkedIn and X too. Keep it brief — a bio written ' +
       'entirely in Unicode italics cannot be found by search and is unreadable via a screen ' +
       'reader.'],
      ['Why do some characters not convert?',
       'Because Unicode\'s italic block covers letters only. Digits, punctuation and accented ' +
       'characters have no italic variant and are left as they are.'],
      ['Does this affect SEO?',
       'On a website, yes and badly — use CSS italics there. On social platforms it makes the ' +
       'styled words unsearchable, so keep keywords plain.'],
    ],
  },
  ...
  'gradient-gen': {
    intro:
      'Generates gradient backgrounds with a live preview and the CSS to copy. Gradients are ' +
      'where small numeric changes make the difference between looking designed and looking ' +
      'default.',
    sections: [
      {
        h: 'Keep the hues close',
        p: 'The most reliable gradients move a short distance around the colour wheel — blue to ' +
           'indigo, orange to pink — while varying lightness and saturation. Distant hues have to ' +
           'travel through the middle of the colour space, which in sRGB passes near grey. If you ' +
           'want a bold two-colour blend, add a midpoint stop in a saturated colour you choose ' +
           'rather than letting the interpolation pick one.',
      },
      {
        h: 'Angle and stop placement do the work',
        p: 'Evenly spaced stops at a 45-degree angle is the default that makes gradients look ' +
           'generic. Moving the stops so one colour occupies most of the area, with the transition ' +
           'in the last third, reads as light falling across a surface rather than as a colour wash. ' +
           'A near-vertical angle suggests a horizon; a radial gradient suggests a light source. ' +
           'These are small changes with large effects.',
      },
      {
        h: 'Text on a gradient needs a contrast check',
        p: 'A gradient crosses a range of luminance values, so text that passes contrast at one end ' +
           'will fail at the other. Check the worst case rather than the average — and if a gradient ' +
           'must carry text, either keep both ends dark enough for white text or put the text on a ' +
           'solid panel over the gradient.',
      },
    ],
    steps: [
      'Pick two or three colours, keeping the hues reasonably close.',
      'Adjust the angle and move the stops off even spacing.',
      'Copy the CSS — and check contrast if any text will sit on it.',
    ],
    notes: [
      'Complementary colours blend through grey in sRGB; add a chosen midpoint stop.',
      'A gradient is a background-image in CSS, so it can be layered with commas.',
      'Check text contrast at the darkest and lightest points, not the average.',
    ],
    faq: [
      ['Why does my gradient look muddy?',
       'The two colours are far apart on the wheel, so the blend passes near grey in sRGB. Add a ' +
       'saturated midpoint stop, or use colours closer in hue.'],
      ['What angle should a gradient use?',
       'Something other than the 45 degrees everything defaults to. Near-vertical reads as light ' +
       'from above and is the most natural; the specific angle matters less than moving the ' +
       'stops off even spacing.'],
      ['Can I put text on a gradient background?',
       'Yes, if you check contrast at the extremes rather than the middle. A gradient spans a ' +
       'range of luminance, so text readable at one end may fail at the other.'],
    ],
  },
  'svg-wave-gen': {
    intro:
      'Generates SVG wave shapes for section dividers — the curved transitions between coloured ' +
      'bands that replaced straight edges in web design.',
    sections: [
      {
        h: 'Why SVG rather than an image',
        p: 'A wave is a few curve commands, so the SVG is typically well under a kilobyte, scales to ' +
           'any width without blurring, and can be recoloured in CSS. A PNG of the same shape is ' +
           'orders of magnitude larger, fixed in resolution, and needs regenerating whenever the ' +
           'brand colour changes. There is no case where the raster version is better.',
      },
      {
        h: 'Making it span any viewport',
        p: 'Set preserveAspectRatio="none" and give the SVG width: 100% with a fixed height, so the ' +
           'wave stretches horizontally rather than scaling proportionally and leaving gaps. Without ' +
           'that, a divider that looks right at 1440px will show background at 2560px — the most ' +
           'common implementation error with these shapes.',
      },
      {
        h: 'Keep them decorative',
        p: 'A divider carries no information, so give it aria-hidden="true" and no accessible name; ' +
           'otherwise a screen reader announces a graphic that means nothing. Also watch the height ' +
           'on phones: a wave sized for a desktop hero can eat a third of a small screen. Either ' +
           'scale it down at narrow widths or accept a straighter edge there.',
      },
    ],
    steps: [
      'Choose a wave style and adjust the amplitude.',
      'Set the colour to match the section it divides.',
      'Copy the SVG and mark it aria-hidden.',
    ],
    notes: [
      'Use preserveAspectRatio="none" with width: 100% so it spans any viewport.',
      'Mark it aria-hidden="true" — it is decorative and carries no meaning.',
      'Inline the SVG rather than base64-encoding it; it is text and compresses well already.',
    ],
    faq: [
      ['Why is there a gap beside my wave on wide screens?',
       'The SVG is scaling proportionally instead of stretching. Set preserveAspectRatio="none" ' +
       'and width: 100% with a fixed height.'],
      ['Should I use SVG or a PNG for a section divider?',
       'SVG, without exception here. It is a fraction of the size, scales to any resolution, and ' +
       'can be recoloured in CSS when your palette changes.'],
      ['Do wave dividers affect accessibility?',
       'Only if you leave them exposed to assistive technology. Add aria-hidden="true" so screen ' +
       'readers skip a decorative shape that conveys nothing.'],
    ],
  },
  ...
  'fake-email-gen': {
    intro:
      'Generates placeholder email addresses for test data and mockups, using domains reserved ' +
      'for exactly that purpose.',
    sections: [
      {
        h: 'example.com exists for this',
        p: 'RFC 2606 reserves example.com, example.net, example.org and the .test, .invalid, ' +
           '.example and .localhost top-level domains so they can be used in documentation and ' +
           'testing without ever reaching a real mailbox. Using a plausible-looking real domain ' +
           'instead means your test suite may genuinely send mail to a stranger — which happens, and ' +
           'is a recurring embarrassment in bug reports and screenshots.',
      },
      {
        h: 'Test addresses that break your validation',
        p: 'Most email validation is too strict and rejects valid addresses. Real addresses contain ' +
           'plus signs (user+tag@), dots in the local part, apostrophes, hyphens, and increasingly ' +
           'non-ASCII characters and new top-level domains longer than three letters. Addresses can ' +
           'legally be quite long. If your form rejects any of those, it rejects real customers — ' +
           'seed your test data with them deliberately.',
      },
      {
        h: 'Never use these to sign up for anything',
        p: 'A generated address is not a disposable inbox — nothing receives mail at it, so account ' +
           'verification and password reset will both fail, and providing false details typically ' +
           'breaches terms of service. If you want a real throwaway address, use a disposable mail ' +
           'service or your provider\'s plus-addressing, which routes to your actual inbox while ' +
           'letting you filter and trace who leaked it.',
      },
    ],
    steps: [
      'Choose how many addresses you need.',
      'Copy them into your seed data or mockup.',
      'Add awkward valid formats by hand to test your validation.',
    ],
    notes: [
      'example.com and .test are reserved by RFC 2606 and never deliver mail.',
      'Plus-addressing, dots and long TLDs are all valid — test that your form accepts them.',
      'Not usable for signing up to anything; nothing receives mail at these addresses.',
    ],
    faq: [
      ['Can I receive email at a generated address?',
       'No. These use domains reserved for documentation, which have no mail servers. For a real ' +
       'throwaway address use a disposable mail service or plus-addressing on your own account.'],
      ['What domain should test email addresses use?',
       'example.com, example.net, example.org, or anything under .test — all reserved by RFC ' +
       '2606 precisely so test mail can never reach a real person.'],
      ['What email formats should I test with?',
       'Plus-addressing, dots in the local part, apostrophes and hyphens, long top-level ' +
       'domains, and non-ASCII characters. Over-strict validation rejecting these is one of the ' +
       'most common form bugs there is.'],
    ],
  },
  ...
  'video-merger': {
    intro:
      'Joins several video files into one, in your browser. Works best when the clips share the ' +
      'same format, resolution and frame rate — which is the condition most merge failures come ' +
      'down to.',
    sections: [
      {
        h: 'Matching clips join losslessly; mismatched ones must be re-encoded',
        p: 'If every clip uses the same codec, resolution and frame rate, the streams can be ' +
           'concatenated without re-encoding — instant, and no quality lost. Mix a 1080p30 clip with ' +
           'a 720p60 one and everything has to be decoded and re-encoded to a common format, which ' +
           'is slow in a browser and costs a generation of quality. Normalising clips before merging ' +
           'is almost always faster than merging mismatched ones.',
      },
      {
        h: 'Audio is where it goes wrong quietly',
        p: 'Clips with different audio sample rates or channel counts can produce output that drifts ' +
           'out of sync partway through, and a clip with no audio track at all can silence ' +
           'everything after it depending on how the join is done. Check the whole output, not just ' +
           'the joins — sync problems accumulate and are often only obvious several minutes in.',
      },
      {
        h: 'Order and the limits of a browser tab',
        p: 'Clips join in the order given, so check it before merging — filename sorting puts clip10 ' +
           'before clip2, which is the usual cause of a jumbled result. And every clip is held in ' +
           'memory during processing, so merging several large files can exhaust the tab. Trim each ' +
           'clip first: everything downstream runs on less material, and the trade for browser ' +
           'processing is that nothing is uploaded.',
      },
    ],
    steps: [
      'Add your clips in the order you want them.',
      'Check they share resolution and frame rate, or expect a re-encode.',
      'Merge, then watch the whole result for audio drift.',
    ],
    notes: [
      'Matching format, resolution and frame rate allows a lossless join.',
      'Filename order is not numeric order — check the sequence before merging.',
      'Processing runs in your browser; files are never uploaded.',
    ],
    faq: [
      ['Why did my merged video lose sync?',
       'Usually mismatched audio sample rates or channel counts between clips, or a clip with no ' +
       'audio track. Normalise the audio across clips before joining, and check the whole output ' +
       'rather than just the join points.'],
      ['Do the clips need to be the same format?',
       'Not strictly, but matching format, resolution and frame rate allows a fast lossless ' +
       'join. Mismatched clips require a full re-encode, which is slow in a browser and costs ' +
       'quality.'],
      ['Why is merging so slow?',
       'Because mismatched clips are being re-encoded, in a browser tab, without hardware ' +
       'acceleration. Normalising the clips first, or trimming them, makes a large difference.'],
    ],
  },
  'video-speed': {
    intro:
      'Changes video playback speed — faster for time-lapse, slower for detail — and writes out ' +
      'a new file at that speed.',
    sections: [
      {
        h: 'Speeding up drops frames; slowing down repeats them',
        p: 'Doubling the speed discards every other frame, which is fine for a screen recording and ' +
           'produces visible stutter in footage with motion. Halving the speed repeats each frame, ' +
           'so the result looks choppy rather than smooth — genuine slow motion requires footage ' +
           'shot at a high frame rate in the first place. 60fps source slowed to half gives you ' +
           'smooth 30fps output; 30fps source slowed to half does not.',
      },
      {
        h: 'What happens to the audio',
        p: 'Changing speed without correction shifts the pitch, which is the chipmunk effect. Pitch ' +
           'correction keeps the voice natural and is what podcast apps do at 1.5×. For a time-lapse ' +
           'you usually want the audio removed entirely, since sped-up ambient sound is unpleasant ' +
           'rather than atmospheric.',
      },
      {
        h: 'What each speed is for',
        p: '1.25× to 2× for tutorials and lectures, where it saves real time and comprehension ' +
           'holds. 8× and beyond for time-lapse of a long process. 0.5× for reviewing technique — a ' +
           'golf swing, a keyboard shortcut, a mechanism — where you are looking at detail rather ' +
           'than wanting cinematic slow motion. Anything faster than about 3× makes speech ' +
           'unintelligible, so drop the audio there.',
      },
    ],
    steps: [
      'Choose your video and set the speed multiplier.',
      'Decide whether to keep, pitch-correct or drop the audio.',
      'Process and download.',
    ],
    notes: [
      'Slowing footage repeats frames — smooth slow motion needs high-frame-rate source.',
      'Speed changes shift audio pitch unless corrected.',
      'Processing runs in your browser; the file is never uploaded.',
    ],
    faq: [
      ['Why does my slowed video look choppy?',
       'Because slowing repeats existing frames rather than creating new ones. Smooth slow ' +
       'motion requires footage shot at a high frame rate — 60 or 120fps — so there are real ' +
       'frames to spread out.'],
      ['How do I speed up a video without the audio sounding odd?',
       'Use pitch correction, which keeps voices natural at higher speeds — the same technique ' +
       'podcast apps use. Above about 3× speech becomes unintelligible regardless, so drop the ' +
       'audio for time-lapses.'],
      ['What speed should I use for a time-lapse?',
       'It depends on the length of the original: 8× to 60× is typical. Aim for a final duration ' +
       'of 20–60 seconds and work backwards from there.'],
    ],
  },
  'gif-to-video': {
    intro:
      'Converts an animated GIF into MP4 or WebM, which is almost always smaller and better ' +
      'quality — often by an order of magnitude.',
    sections: [
      {
        h: 'Why the video is so much smaller',
        p: 'GIF stores each frame almost independently and supports only 256 colours. Video codecs ' +
           'encode the differences between frames and use the full colour range, so an 8 MB GIF ' +
           'routinely becomes a 300 KB MP4 with better colour and no banding. This is why X, Reddit ' +
           'and Discord silently convert uploaded GIFs to video — the bandwidth saving is enormous ' +
           'at their scale.',
      },
      {
        h: 'Replicating GIF behaviour in video',
        p: 'A GIF autoplays, loops and has no sound. To match that with a video tag, use autoplay, ' +
           'loop, muted and playsinline — and muted is not optional: browsers block autoplay with ' +
           'sound, so the video will simply not start without it. playsinline stops iOS opening it ' +
           'fullscreen. With those four attributes a video behaves exactly like a GIF and weighs a ' +
           'fraction as much.',
      },
      {
        h: 'When to keep the GIF',
        p: 'Email, where video does not play in most clients. Some documentation contexts — GitHub ' +
           'renders GIFs inline in README files and handles video less well. And chat platforms ' +
           'where a GIF drops in and plays without a click. Outside those, converting is close to ' +
           'free improvement.',
      },
    ],
    steps: [
      'Choose your GIF.',
      'Pick MP4 for maximum compatibility or WebM for smaller size.',
      'Convert, then embed with autoplay, loop, muted and playsinline.',
    ],
    notes: [
      'Expect a size reduction of 90% or more with better colour fidelity.',
      'muted is required or browsers will block autoplay entirely.',
      'Conversion runs in your browser; the file is never uploaded.',
    ],
    faq: [
      ['Why convert a GIF to video?',
       'Size and quality. GIF has no inter-frame compression and only 256 colours, so an ' +
       'equivalent MP4 is frequently a tenth the size and looks better. Most major platforms ' +
       'convert uploaded GIFs to video anyway.'],
      ['How do I make a video loop like a GIF?',
       'Use autoplay, loop, muted and playsinline on the video element. muted is essential — ' +
       'browsers block autoplay with sound, so without it nothing plays at all.'],
      ['Should I ever keep a GIF instead?',
       'For email, where video does not play in most clients, and for GitHub README files, where ' +
       'GIFs render inline. Elsewhere video is better on every measure.'],
    ],
  },
  ...
  'coin-flip-batch': {
    intro:
      'Flips many coins at once and reports the totals. More interesting than a single flip, ' +
      'because a large batch is where probability stops being intuitive and starts being ' +
      'visible.',
    sections: [
      {
        h: 'The proportion converges; the gap does not',
        p: 'Flip a thousand coins and the proportion of heads will sit close to 50%. The absolute ' +
           'difference between heads and tails, however, tends to grow — roughly with the square ' +
           'root of the number of flips. So 1,000 flips typically ends 30 or 40 apart, and 10,000 ' +
           'flips ends further apart still in absolute terms while being proportionally closer. This ' +
           'is the law of large numbers, and it is routinely misremembered as the gap closing.',
      },
      {
        h: 'There is no correction',
        p: 'A run of ten heads does not make tails more likely next. Each flip is independent, and ' +
           'the belief that the sequence somehow balances itself is the gambler\'s fallacy — named ' +
           'after a night at Monte Carlo in 1913 when black came up twenty-six times in a row and ' +
           'players lost fortunes betting on red. What actually happens is not correction but ' +
           'dilution: later flips swamp an early imbalance in proportion without ever reversing it.',
      },
      {
        h: 'Streaks are longer than people expect',
        p: 'In 100 flips, a run of six or seven identical results is more likely than not. Asked to ' +
           'fake a random sequence, people produce far shorter streaks — which is how statisticians ' +
           'detect fabricated data. A batch here will contain runs that look wrong and are not, ' +
           'which makes this a better demonstration of randomness than any explanation of it.',
      },
    ],
    steps: [
      'Choose how many coins to flip.',
      'Flip, and read the totals and the proportion.',
      'Run it again at a larger count and watch the proportion tighten while the gap widens.',
    ],
    notes: [
      'Each flip is independent and drawn from the browser\'s cryptographic random source.',
      'The proportion approaches 50%; the absolute difference tends to grow with √n.',
      'Runs of six or more in a hundred flips are normal.',
    ],
    faq: [
      ['If I flip enough coins, will heads and tails even out?',
       'In proportion, yes — the percentage approaches 50%. In absolute numbers, no: the ' +
       'expected gap grows roughly with the square root of the number of flips. Both statements ' +
       'are true and people usually only know the first.'],
      ['Does a long run of heads make tails more likely?',
       'No. Each flip is independent and has no memory. That intuition is the gambler\'s fallacy, ' +
       'and it has cost people a great deal of money.'],
      ['How long a streak is normal?',
       'In 100 flips, six or seven in a row is more likely than not. People asked to invent ' +
       'random sequences produce much shorter runs, which is one way fabricated data gets ' +
       'caught.'],
    ],
  },
  'dice-roller-3d': {
    intro:
      'Rolls animated dice in any combination — d4 through d100 — with the total and each ' +
      'individual result. For tabletop games when the dice are in the wrong bag.',
    sections: [
      {
        h: 'Adding dice changes the shape of the outcome',
        p: 'One d20 is flat: every number equally likely, which is why it produces dramatic swings ' +
           'and why critical hits feel like events. Two or more dice cluster toward the middle — 2d6 ' +
           'produces a seven six times as often as a twelve. That is why 3d6 for a character ' +
           'statistic yields mostly average characters, and why systems using multiple dice feel ' +
           'more predictable than d20 systems even at the same average.',
      },
      {
        h: 'Advantage, disadvantage and the numbers behind them',
        p: 'Rolling two d20 and taking the higher shifts the average from 10.5 to about 13.8 — ' +
           'equivalent to roughly a +3 or +4 bonus, but weighted toward the middle of the range ' +
           'where it matters most. Taking the lower does the reverse. It is an elegant mechanic ' +
           'precisely because its effect is largest when the outcome is genuinely uncertain and ' +
           'smallest when the roll was never going to matter.',
      },
      {
        h: 'Physical dice are not perfectly fair',
        p: 'Cheap moulded dice have rounded edges, air bubbles and hollowed pips that bias them ' +
           'measurably; casino dice are machined flat, sharp-edged and transparent for exactly that ' +
           'reason. A d20 balance test — floating it in salt water and flicking it — reveals the ' +
           'heavier side on many sets. Virtual dice have no geometry to be wrong, which makes them ' +
           'fairer and, most players would say, considerably less fun.',
      },
    ],
    steps: [
      'Choose the dice type and how many to roll.',
      'Add a modifier if your system uses one.',
      'Roll, and read the individual results and total.',
    ],
    notes: [
      'Notation is NdS — 2d6 is two six-sided dice — with any modifier after it.',
      'Results come from the browser\'s cryptographic random source.',
      'Works offline once loaded.',
    ],
    faq: [
      ['What does advantage do to the odds?',
       'Rolling two d20 and taking the higher raises the average from 10.5 to about 13.8, ' +
       'roughly a +3 to +4 bonus — and it helps most in the middle of the range, where rolls are ' +
       'genuinely in doubt.'],
      ['Why does 2d6 not behave like 1d12?',
       'Both average 7, but 2d6 clusters: there are six ways to roll a seven and one to roll a ' +
       'twelve. 1d12 is flat. That difference in shape is why game designers pick one over the ' +
       'other.'],
      ['Are virtual dice fairer than real ones?',
       'Measurably, yes. Physical dice have manufacturing bias from rounded edges, air bubbles ' +
       'and hollowed pips; virtual dice have no geometry to go wrong.'],
    ],
  },
  'random-number-generator': {
    intro:
      'Generates random numbers within a range, singly or in bulk, from the browser\'s ' +
      'cryptographic random source rather than an ordinary pseudo-random generator.',
    sections: [
      {
        h: 'Cryptographic against pseudo-random',
        p: 'Math.random is a deterministic algorithm seeded once per page — statistically fine for a ' +
           'shuffle and predictable in principle to anyone who observes enough output. ' +
           'crypto.getRandomValues draws from the operating system\'s entropy pool, seeded by ' +
           'physical unpredictability. For a giveaway or anything anyone might question, the ' +
           'cryptographic source costs nothing and removes the argument entirely.',
      },
      {
        h: 'Modulo bias, and why careful code rejects samples',
        p: 'Mapping a random 32-bit value into a range with a remainder operation is very slightly ' +
           'unfair whenever the range does not divide evenly into 2³² — low values in the range come ' +
           'up marginally more often. For dice and draws the effect is unobservable; for ' +
           'cryptographic key material it is a genuine weakness. The correct fix is rejection ' +
           'sampling: draw, discard anything landing in the uneven tail, draw again.',
      },
      {
        h: 'Expect repeats, especially in bulk',
        p: 'Independent draws mean duplicates. In twenty numbers drawn from 1 to 100, a repeat is ' +
           'more likely than not — the birthday problem, which surprises almost everyone. That is ' +
           'correct behaviour. If you need distinct values, shuffle the range and take from the ' +
           'front, which is how a lottery draw works and a fundamentally different operation.',
      },
    ],
    steps: [
    ...
    notes: [
      ...
      'Bulk draws are independent, so duplicates are expected.',
      'Generated in your browser; nothing is transmitted.',
    ],
    faq: [
      ['Are these numbers truly random?',
       'They come from the operating system\'s entropy pool via the browser\'s cryptographic ' +
       'generator — unpredictable in practice and not reproducible from any observable seed. ' +
       'That is as good as software randomness gets.'],
      ['How do I get unique numbers with no repeats?',
       'Not from a range draw, where each pick is independent. Shuffle the whole range and take ' +
       'from the front, or draw extra and remove duplicates.'],
      ['Why did I get the same number twice?',
       'Because draws are independent. With twenty numbers from 1 to 100, a repeat is more ' +
       'likely than not — a sequence that never repeated would be evidence the generator was not ' +
       'random.'],
    ],
  },
  ...
  'html-boilerplate-generator': {
    intro:
      'Generates a starting HTML document with the head tags a page actually needs — charset, ' +
      'viewport, title, description and the Open Graph set — rather than the bare skeleton an ' +
      'editor inserts.',
    sections: [
      {
        h: 'The two tags that must come first',
        p: 'charset must appear within the first 1024 bytes, or the browser may start parsing with ' +
           'the wrong encoding and re-parse when it finds out — which is why it is the first thing ' +
           'in the head. The viewport tag is what makes a page respond to phone widths at all: ' +
           'without it mobile browsers render at a virtual 980px and scale down, so a perfectly ' +
           'responsive stylesheet produces a tiny, zoomed-out page. Those two omissions account for ' +
           'most “my site looks wrong on mobile” reports.',
      },
      {
        h: 'What belongs in the head and what does not',
        p: 'Title, description, canonical, viewport, charset and the Open Graph tags earn their ' +
           'place. The keywords meta tag has been ignored since 2009. A long block of ' +
           'render-blocking scripts does not belong there either — defer them, or move them before ' +
           'the closing body tag, because anything blocking in the head delays the first paint of ' +
           'the entire page.',
      },
      {
        h: 'lang is an accessibility requirement, not a formality',
        p: 'The lang attribute on the html element tells a screen reader which pronunciation rules ' +
           'to use. Without it, English text may be read with the wrong phonetics, which for a blind ' +
           'user ranges from irritating to incomprehensible. It is one attribute, it is required by ' +
           'WCAG, and it is missing from a remarkable number of production sites.',
      },
    ],
    steps: [
      'Enter your page title and description.',
      'Generate the document and copy it.',
      'Set the lang attribute to your page\'s actual language.',
    ],
    notes: [
      'charset must be within the first 1024 bytes of the document.',
      'Without a viewport tag, mobile browsers render at 980px and scale down.',
      'The lang attribute is a WCAG requirement, not an optional extra.',
    ],
    faq: [
      ['What does the viewport meta tag do?',
       'It tells mobile browsers to render at the device\'s actual width rather than a virtual ' +
       '980px. Without it, a responsive stylesheet has nothing to respond to and the page ' +
       'appears zoomed out.'],
      ['Do I still need the charset declaration?',
       'Yes, and it must come first. HTML5 defaults to UTF-8, but declaring it explicitly within ' +
       'the first 1024 bytes avoids a re-parse and any ambiguity about encoding.'],
      ['What should not go in the head?',
       'Render-blocking scripts. Anything synchronous there delays the first paint of the whole ' +
       'page — use defer, or move scripts before the closing body tag.'],
    ],
  },
  ...
  'audio-converter': {
    intro:
      'Converts audio between MP3, WAV, OGG and M4A in your browser. Which format you want ' +
      'depends on whether the file is being archived, edited or listened to.',
    sections: [
      {
        h: 'Lossy and lossless, and when each matters',
        p: 'WAV and FLAC are lossless: every sample preserved, files large. MP3, AAC and Opus ' +
           'discard detail the ear is unlikely to notice, at a fraction of the size. Archive and ' +
           'edit in lossless; distribute in lossy. The mistake that costs you is editing a lossy ' +
           'file and re-exporting it lossy, which compounds the loss with every pass — keep a ' +
           'lossless master and export from it each time.',
      },
      {
        h: 'Converting up gains nothing',
        p: 'A 128 kbps MP3 converted to WAV is a large file containing exactly the detail the MP3 ' +
           'already discarded. Quality is only ever lost, never restored, and no converter can ' +
           'reconstruct information that is not there. If you need better quality, you need a better ' +
           'source — which is worth knowing before spending an evening re-encoding a music library.',
      },
      {
        h: 'Choosing a bitrate',
        p: 'For speech, 64–96 kbps mono is entirely adequate and keeps a long recording small. For ' +
           'music, 192 kbps AAC or 256 kbps MP3 is transparent to most listeners on most equipment. ' +
           'Opus outperforms both at low bitrates and is the right choice where support allows. ' +
           'Beyond 320 kbps you are storing file size rather than fidelity.',
      },
    ],
    steps: [
      'Choose your audio file and the target format.',
      'Set a bitrate appropriate to the content.',
      'Convert and download.',
    ],
    notes: [
      'Converting from lossy to lossless does not restore quality — it only grows the file.',
      'Speech is fine at 64–96 kbps mono; music wants 192 kbps or above.',
      'Conversion runs in your browser; nothing is uploaded.',
    ],
    faq: [
      ['Does converting MP3 to WAV improve quality?',
       'No. The detail was discarded when the MP3 was made and cannot be recovered. You get a ' +
       'much larger file containing exactly the same audio.'],
      ['What bitrate should I use for music?',
       '192 kbps AAC or 256 kbps MP3 is transparent for most listeners. Opus does better at low ' +
       'bitrates where it is supported. Above 320 kbps you are paying in file size for nothing ' +
       'audible.'],
      ['Which audio format is best?',
       'For archiving and editing, a lossless one — WAV or FLAC. For distribution, AAC or MP3 ' +
       'for compatibility, Opus for efficiency. The right answer depends entirely on what the ' +
       'file is for.'],
    ],
  },
  'audio-trimmer': {
    intro:
      'Cuts a section from an audio file between a start and end point, in your browser. For ' +
      'removing the silence before a recording starts, or extracting the part you need.',
    sections: [
      {
        h: 'Trim on a zero crossing to avoid the click',
        p: 'An audio waveform oscillates around zero. Cut at a point where the wave is partway ' +
           'through its swing and the sudden jump to silence produces an audible click at the join. ' +
           'Cutting where the waveform crosses zero avoids it entirely. A short fade of a few ' +
           'milliseconds at each end achieves the same thing and is more forgiving — which is why ' +
           'editors apply one by default.',
      },
      {
        h: 'Trimming can be lossless, depending on the format',
        p: 'Cutting an uncompressed WAV is a straightforward removal of samples and loses nothing. ' +
           'Cutting a compressed format usually means decoding and re-encoding, which costs a ' +
           'generation of quality — unless the cut lands on a frame boundary, which specialised MP3 ' +
           'editors can do. For a single edit the loss is negligible; across repeated edits it ' +
           'accumulates.',
      },
      {
        h: 'Leave the room tone',
        p: 'Trimming right up to the first word sounds abrupt. Leave a fraction of a second of room ' +
           'tone — the ambient sound of the space — at the start and end. It makes the edit sound ' +
           'natural rather than clipped, and it gives you something to fade. Cutting all ambient ' +
           'sound to digital silence is one of the clearest markers of an amateur edit.',
      },
    ],
    steps: [
      'Choose your audio file.',
      'Set the start and end points, leaving a little room tone at each end.',
      'Trim and download.',
    ],
    notes: [
      'Cut on a zero crossing, or apply a short fade, to avoid a click at the join.',
      'Trimming compressed audio usually re-encodes; WAV does not.',
      'Processing runs in your browser; the file is never uploaded.',
    ],
    faq: [
      ['Why is there a click at the start of my trimmed audio?',
       'The cut landed mid-waveform, so the signal jumps abruptly to silence. Move the cut to a ' +
       'zero crossing or apply a few milliseconds of fade.'],
      ['Does trimming reduce audio quality?',
       'Not for uncompressed formats such as WAV, where samples are simply removed. Compressed ' +
       'formats usually need re-encoding, which costs a small amount of quality per edit.'],
      ['How much silence should I leave at the start?',
       'A fraction of a second of room tone rather than absolute silence. It makes the edit ' +
       'sound natural and gives you material to fade — cutting straight to digital silence ' +
       'sounds abrupt.'],
    ],
  },
  'audio-merger': {
    intro:
      'Joins several audio files end to end into one. Useful for combining recorded segments, ' +
      'chapters or takes into a single file.',
    sections: [
      {
        h: 'Match the files before joining',
        p: 'Clips with different sample rates or channel counts have to be resampled to a common ' +
           'format, which costs quality and occasionally produces artefacts at the joins. Mono and ' +
           'stereo files joined together give inconsistent output. Check that your files match ' +
           'before merging — and if they came from different devices or sessions, they very likely ' +
           'do not.',
      },
      {
        h: 'Level differences are the audible problem',
        p: 'Two recordings made on different days will differ in volume, and the jump between them ' +
           'is obvious to a listener in a way it is not to someone watching a waveform. Normalise ' +
           'the levels before merging, or the result sounds like what it is: separate recordings ' +
           'stuck together. Loudness normalisation to a target LUFS level is the professional ' +
           'approach; matching peaks by eye is the quick one.',
      },
      {
        h: 'Crossfades hide the seam',
        p: 'A hard cut between two clips is audible whenever the room tone differs even slightly. A ' +
           'short crossfade — anywhere from 10 milliseconds to half a second depending on the ' +
           'material — blends the transition so it passes unnoticed. For music the fade usually ' +
           'needs to be longer and placed musically; for speech, short is better, since a long fade ' +
           'on dialogue sounds like a mistake.',
      },
    ],
    steps: [
      'Add your audio files in the order you want them.',
      'Check they share sample rate and channel count.',
      'Merge and listen through the joins.',
    ],
    notes: [
      'Mismatched sample rates or channel counts require resampling, which costs quality.',
      'Normalise levels before merging or the volume will jump at each join.',
      'Files are processed in your browser and never uploaded.',
    ],
    faq: [
      ['Why does the volume jump between my merged clips?',
       'Because the source recordings were made at different levels. Normalise them to a common ' +
       'loudness before merging — the jump is far more obvious to a listener than it looks on a ' +
       'waveform.'],
      ['Do the files need to be the same format?',
       'They need matching sample rate and channel count for a clean join. Mismatched files are ' +
       'resampled, which costs a little quality and can produce artefacts at the transitions.'],
      ['How do I avoid a click between clips?',
       'Use a short crossfade — 10 milliseconds is enough for speech, longer for music. A hard ' +
       'cut is audible whenever the room tone differs between recordings.'],
    ],
  },
  'video-audio-extractor': {
    intro:
      'Pulls the audio track out of a video file and saves it separately, in your browser. For ' +
      'lectures, interviews and anything recorded on video that you would rather listen to.',
    sections: [
      {
        h: 'Copying the stream is lossless; converting is not',
        p: 'A video file already contains an encoded audio stream. Copying it out unchanged loses ' +
           'nothing and takes seconds. Converting it to a different format decodes and re-encodes, ' +
           'which costs a generation of quality — so if the source audio is AAC and you want an M4A, ' +
           'copy rather than convert. Converting to MP3 out of habit is a loss for no benefit unless ' +
           'something downstream specifically needs MP3.',
      },
      {
        h: 'What bitrate a recording actually needs',
        p: 'Speech is comfortable at 64–96 kbps mono, which matters when a lecture runs two hours. ' +
           'Music wants 192 kbps or more. Re-encoding above the source bitrate cannot add ' +
           'information that was discarded at capture — it just produces a larger file. Check the ' +
           'source before choosing a target.',
      },
      {
        h: 'Copyright does not change because it is easy',
        p: 'Extracting a soundtrack from material you did not create and redistributing it is ' +
           'infringement, regardless of the tool. The defensible uses are your own recordings, ' +
           'licensed material, permissively licensed content, and personal-use extraction where ' +
           'local law allows it. Worth stating plainly, because for this tool the obvious use case ' +
           'is often the impermissible one.',
      },
    ],
    steps: [
      'Choose your video file.',
      'Copy the existing audio stream where possible, rather than converting.',
      'Download the audio.',
    ],
    notes: [
      'Copying the stream is lossless; converting formats is not.',
      'Speech needs only 64–96 kbps mono — useful for long recordings.',
      'Processing runs in your browser; nothing is uploaded.',
    ],
    faq: [
      ['Does extracting audio lose quality?',
       'Not if the existing stream is copied unchanged. Converting to a different format decodes ' +
       'and re-encodes, which costs a little — keep the original format where your player ' +
       'supports it.'],
      ['What bitrate for a lecture recording?',
       '64–96 kbps mono is plenty for speech and keeps a two-hour file manageable. Stereo and ' +
       'higher bitrates gain nothing audible on a single voice.'],
      ['Is it legal to extract audio from a video?',
       'From your own or licensed material, yes. From copyrighted content you do not own, ' +
       'redistribution is infringement and personal-use rules vary by country. The tool does not ' +
       'change the copyright position.'],
    ],
  },
  ...
  'vcard-generator': {
    intro:
      'Creates a vCard — the .vcf contact file every phone and address book understands — from ' +
      'your details, ready to share or encode into a QR code.',
    sections: [
      {
        h: 'One format, understood everywhere',
        p: 'vCard has been the contact interchange standard since 1995, and iOS, Android, Outlook, ' +
           'Google Contacts and macOS all import it without conversion. That is why an emailed .vcf ' +
           'adds itself to someone\'s address book in one tap, where a signature block has to be ' +
           'typed out. Version 3.0 is the most widely compatible; 4.0 adds fields that some older ' +
           'clients silently drop.',
      },
      {
        h: 'Put it behind a QR code',
        p: 'A vCard encoded as a QR code is the modern business card: point a camera, tap once, ' +
           'contact saved with no typing and no transcription errors. Keep the content short — a ' +
           'vCard with a long address, several phone numbers and a note produces a dense code that ' +
           'scans poorly at small print sizes. Name, one number, one email and a URL is usually the ' +
           'right amount.',
      },
      {
        h: 'Fields worth filling and fields worth leaving',
        p: 'Name, organisation, title, one phone, one email and a URL cover nearly every use. A full ' +
           'postal address is rarely needed and bloats a QR code considerably. The URL field is the ' +
           'most underused: pointing it at a profile page means the contact record stays current ' +
           'when your number changes, which a printed card never does.',
      },
    ],
    steps: [
      'Enter your name, organisation and contact details.',
      'Download the .vcf file, or encode it as a QR code.',
      'Test it by scanning with your own phone before sharing it.',
    ],
    notes: [
      'vCard 3.0 has the widest compatibility; 4.0 fields may be dropped by older clients.',
      'Keep the content short if it is going into a QR code — dense codes scan badly when ' +
       'printed small.',
      'Generated in your browser; your details are not transmitted.',
    ],
    faq: [
      ['What is a .vcf file?',
       'A vCard — the standard contact file format, understood by iOS, Android, Outlook, Google ' +
       'Contacts and macOS. Opening one offers to add the contact to the address book directly.'],
      ['How do I share my contact details as a QR code?',
       'Encode the vCard into a QR code. Scanning it offers to save the contact in one tap. Keep ' +
       'the fields minimal so the code stays sparse enough to scan reliably.'],
      ['Which vCard version should I use?',
       '3.0 for maximum compatibility. Version 4.0 is more capable but some older clients drop ' +
       'the fields it adds, which is worse than not including them.'],
    ],
  },
  'qr-code-studio': {
    intro:
      'Generates QR codes for URLs, text, contacts, WiFi networks and more, with control over ' +
      'size and error correction. One tool for the several things a QR code can carry.',
    sections: [
      {
        h: 'The content type determines the format',
        p: 'A QR code holds text, and applications recognise particular formats: a bare URL opens a ' +
           'browser, WIFI:T:WPA;S:name;P:pass;; joins a network, a vCard saves a contact, mailto: or ' +
           'tel: open the relevant app. Getting the prefix right is what turns a code from a string ' +
           'of text into an action — a URL without its https:// is just text to many scanners.',
      },
      {
        h: 'Error correction and quiet zone',
        p: 'Levels L, M, Q and H recover roughly 7%, 15%, 25% and 30% of a damaged code. Higher ' +
           'levels pack in more modules, so at the same physical size each module is smaller and the ' +
           'code is harder to scan, not easier. M is right unless you are overlaying a logo, which ' +
           'is exactly what the redundancy at H pays for. And always leave the quiet zone — four ' +
           'modules of clear margin — or scanners will fail on an otherwise perfect code.',
      },
      {
        h: 'Size it for the scanning distance',
        p: 'A workable rule is that the code should be at least a tenth of the distance it will be ' +
           'scanned from: about 3 cm for arm\'s length, 30 cm for a poster read across a room. ' +
           'Shorter content produces a sparser code that scans far more forgivingly, so shorten long ' +
           'URLs before encoding — the improvement is visible in the pattern itself.',
      },
      {
        h: 'A code gives no preview of where it leads',
        p: 'That is its security weakness. Malicious codes pasted over legitimate ones on parking ' +
           'meters and restaurant tables are now a common scam, because a person cannot see the ' +
           'destination before tapping. If you deploy codes publicly, check them periodically for ' +
           'tampering, and prefer a short branded domain so the destination at least looks right ' +
           'when the phone shows it.',
      },
    ],
    steps: [
      'Choose what the code should contain and enter the details.',
      'Set error correction to M unless you are adding a logo.',
      'Generate, scan it with your own phone, then download at print size.',
    ],
    notes: [
      'Always leave the four-module quiet zone — a code without it will not scan.',
      'Shorter content makes a sparser, more forgiving code.',
      'Generated in your browser; contents are not transmitted.',
    ],
    faq: [
      ['What error correction level should I use?',
       'M for most uses. Higher levels make the code denser and harder to scan at a given size, ' +
       'so go to Q or H only when covering part of the code with a logo or printing on something ' +
       'that will be scuffed.'],
      ['How big should a printed QR code be?',
       'Roughly a tenth of the scanning distance — about 3 cm for arm\'s length, 30 cm for a ' +
       'poster read from three metres. Test the printed size rather than judging it on screen.'],
      ['Why will my QR code not scan?',
       'Most often a missing quiet zone — the clear margin around it is required. After that: ' +
       'too small for the distance, too much content making the modules tiny, or low contrast.'],
    ],
  },
  'signature-pad': {
    intro:
      'Draw a signature with a mouse, trackpad or finger and download it as a transparent PNG ' +
      'for dropping into documents.',
    sections: [
      {
        h: 'What a drawn signature is legally worth',
        p: 'In most jurisdictions an electronic signature is valid and enforceable — the US ESIGN ' +
           'Act and UETA, the EU\'s eIDAS regulation, India\'s IT Act. What varies is the standard of ' +
           'proof if it is disputed. A drawn image proves very little on its own; a signing platform ' +
           'that records identity, timestamp, IP address and an audit trail proves considerably ' +
           'more. For routine documents an image is fine; for anything with real value, use a ' +
           'service that produces evidence.',
      },
      {
        h: 'Some documents still cannot be signed this way',
        p: 'Wills and codicils, many property transfers, powers of attorney, and some court filings ' +
           'require a wet signature and sometimes a witness or notary, and the rules differ by ' +
           'jurisdiction. eIDAS also distinguishes simple, advanced and qualified electronic ' +
           'signatures, with only the last carrying the same legal weight as handwriting across the ' +
           'EU. Check before assuming an image suffices.',
      },
      {
        h: 'Getting a usable image',
        p: 'Draw larger than you need and scale down — the result is smoother, because the stroke is ' +
           'averaged over more pixels. A finger on a touchscreen produces a better line than a ' +
           'mouse; a stylus is better than either. Keep the background transparent so it sits on any ' +
           'document without a white box around it, which is the giveaway of a pasted signature.',
      },
      {
        h: 'Treat the image file as sensitive',
        p: 'A signature image can be copied onto any document by anyone who has it. Do not email it ' +
           'around, do not leave it in a shared drive, and be wary of sending it to anyone who asks ' +
           'for one separately from a document — that request is itself a warning sign. Drawing it ' +
           'here is safe because it never leaves your browser; what happens to the file afterwards ' +
           'is the risk.',
      },
    ],
    steps: [
      'Draw your signature, larger than the final size.',
      'Clear and redraw until it looks right.',
      'Download the transparent PNG and store it somewhere private.',
    ],
    notes: [
      'The drawing never leaves your browser — nothing is uploaded.',
      'Transparent background so it sits on any document without a white box.',
      'Wills, property transfers and some court filings may still require a wet signature.',
    ],
    faq: [
      ['Is a drawn electronic signature legally binding?',
       'Generally yes — electronic signatures are recognised under ESIGN and UETA in the US, ' +
       'eIDAS in the EU and the IT Act in India. What differs is evidentiary weight: an image ' +
       'alone proves little if challenged, where a signing platform provides an audit trail.'],
      ['What documents cannot be signed electronically?',
       'It varies by jurisdiction, but wills, many property transfers, powers of attorney and ' +
       'some court filings commonly require a wet signature and sometimes a witness. Check the ' +
       'local rule rather than assuming.'],
      ['Is it safe to store a signature image?',
       'Treat it like a credential — anyone with the file can place it on any document. Keep it ' +
       'somewhere private, do not email it around, and be suspicious of anyone asking for one ' +
       'outside the context of a specific document.'],
    ],
  },
  'certificate-maker': {
    intro:
      'Designs a printable certificate — course completion, achievement, appreciation — with ' +
      'the recipient\'s name, the reason and a date, ready to print or save as a PDF.',
    sections: [
      {
        h: 'What a certificate has to say',
        p: 'The recipient\'s name as they would write it, what it is for stated specifically, the ' +
           'date, the issuing organisation, and a signature. The part most templates get wrong is ' +
           'specificity: “Certificate of Achievement” says nothing, while “Completed 40 hours of ' +
           'Advanced Data Analysis, March 2026” is something a recipient can put on a CV and someone ' +
           'else can verify. The value of a certificate is entirely in what it attests to.',
      },
      {
        h: 'Design that survives printing',
        p: 'Landscape A4 or Letter is conventional. Keep at least 15 mm of margin, since home ' +
           'printers cannot print to the edge and will either clip the border or shrink the page. ' +
           'Use one or two typefaces — a serif for the name and something plain for the body reads ' +
           'better than five decorative fonts. And print a test copy before doing thirty: screen and ' +
           'paper differ, and borders that look elegant on a monitor often look heavy in ink.',
      },
      {
        h: 'Make it verifiable if it matters',
        p: 'A printable certificate cannot be verified by a third party, which is fine for a ' +
           'workshop and inadequate for a professional qualification. If the certificate needs to ' +
           'mean something to an employer, add a unique identifier and a URL where it can be ' +
           'checked, or issue through a platform that supports verifiable credentials. Otherwise ' +
           'expect it to be treated as decorative — which, for most certificates, is honestly what ' +
           'it is.',
      },
    ],
    steps: [
      'Enter the recipient\'s name and what the certificate is for — specifically.',
      'Add the date, the issuing organisation and a signature.',
      'Print a test copy, then produce the set.',
    ],
    notes: [
      'Landscape orientation with at least 15 mm of margin prints reliably on home printers.',
      'State specifically what was achieved — a generic title carries no information.',
      'Add a reference number and verification URL if the certificate needs to be checkable.',
    ],
    faq: [
      ['What should a certificate of completion include?',
       'The recipient\'s name, a specific statement of what was completed, the date, the issuing ' +
       'organisation and a signature. Specificity is what makes it useful — hours, course name ' +
       'and level mean something where “achievement” does not.'],
      ['What size should a certificate be?',
       'A4 or Letter in landscape, which is conventional and fits standard frames. Keep 15 mm of ' +
       'margin so home printers do not clip the design.'],
      ['Can a printed certificate be verified?',
       'Not by itself. Add a unique reference number and a URL where it can be checked, or issue ' +
       'through a verifiable credential platform, if it needs to carry weight with an employer.'],
    ],
  },
  'todo-list-maker': {
    intro:
      'Builds a printable to-do or checklist from items you enter, with checkboxes. For the ' +
      'lists that work better on paper than in an app.',
    sections: [
      {
        h: 'Where a paper checklist genuinely outperforms software',
        p: 'Procedures under pressure, repeated processes, and anything where the cost of missing a ' +
           'step is high. Atul Gawande\'s work on surgical checklists found a printed nineteen-item ' +
           'list reduced complications substantially across eight hospitals — not because surgeons ' +
           'did not know the steps, but because knowing and reliably doing are different things. ' +
           'Aviation has run on the same principle for decades.',
      },
      {
        h: 'Write items as actions with a clear done state',
        p: '“Website” is not a task. “Send the homepage copy to Priya” is, and you can tell ' +
           'unambiguously whether it is finished. Anything that cannot be completed in one sitting ' +
           'is a project rather than a task, and belongs broken into its next concrete action — ' +
           'which is the single most useful idea in any productivity system, and the one people ' +
           'skip.',
      },
      {
        h: 'Keep a daily list short',
        p: 'A list of forty items is a source of guilt rather than a plan. Three to five things that ' +
           'must happen today, with everything else on a separate someday list you review weekly, is ' +
           'the structure that survives contact with a real day. A printed list has a useful ' +
           'property here: it cannot silently grow, because you would have to reprint it.',
      },
    ],
    steps: [
      'Enter your items, written as specific actions.',
      'Keep a daily list to three to five must-do items.',
      'Print it, and tick things off by hand.',
    ],
    notes: [
      'Write each item so you can tell unambiguously when it is done.',
      'Anything needing more than one sitting is a project — list its next action instead.',
      'Items stay in your browser and are not saved; print or note them down.',
    ],
    faq: [
      ['Why use a paper checklist instead of an app?',
       'For repeated procedures and high-stakes processes, paper wins — it is always visible, ' +
       'needs no unlocking, and cannot be dismissed with a swipe. The surgical checklist ' +
       'research found measurable improvements from exactly this.'],
      ['How many items should a daily list have?',
       'Three to five that genuinely must happen. Longer lists become a record of everything you ' +
       'are not doing, which is demotivating and makes the important items harder to find.'],
      ['What makes a good to-do item?',
       'A specific action with an unambiguous finish. “Call the supplier about the March ' +
       'invoice” works; “invoices” does not, because there is no point at which it is done.'],
    ],
  },
};
