...
//     true only after DNS for that domain is pointing at its Vercel project.
//
...
const BRANDS = [
  brand({
    id: 'text', slug: 'text', domain: 'toolsrifttext.com',
    ...
    android: { packageId: 'com.toolsrift.text.twa', appName: 'ToolsRift Text Tools', shortName: 'Text Tools', playCategory: 'PRODUCTIVITY', shortDesc: 'Word counter, case converter, lorem ipsum & 60+ free text tools. Private.' },
  ...
  brand({
    id: 'image', slug: 'images', domain: 'toolsriftimage.com',
    ...
    android: { packageId: 'com.toolsrift.image', appName: 'ToolsRift Image Tools', shortName: 'Image Tools', playCategory: 'PHOTOGRAPHY', shortDesc: 'Resize, compress, crop & convert images offline. 60+ free tools, no uploads.' },
    seo: { keywords: 'image resizer, image compressor, crop image, convert image, png to jpg, webp converter, photo editor online' },
  }),

  brand({
    id: 'pdf', slug: 'pdf', domain: 'toolsriftpdf.com',
    ...
    android: { packageId: 'com.toolsrift.pdf', appName: 'ToolsRift PDF Tools', shortName: 'PDF Tools', playCategory: 'PRODUCTIVITY', shortDesc: 'Merge, split, compress, sign & convert PDFs offline. 40 free tools, no uploads.' },
    seo: { keywords: 'pdf tools, merge pdf, split pdf, compress pdf, pdf to image, sign pdf, pdf converter online free' },
  }),

  brand({
    id: 'code', slug: 'json', domain: 'toolsriftjson.com',
    ...
    android: { packageId: 'com.toolsrift.json', appName: 'ToolsRift JSON Tools', shortName: 'JSON Tools', playCategory: 'TOOLS', shortDesc: 'JSON formatter, validator, minifier, diff & converters. 30 free tools, offline.' },
    seo: { keywords: 'json formatter, json validator, json minifier, json to csv, json to yaml, json diff, jsonpath tester' },
  }),

  brand({
    id: 'encoders', slug: 'encoders', domain: 'toolsriftencoders.com',
    ...
    android: { packageId: 'com.toolsrift.encoders', appName: 'ToolsRift Encoders', shortName: 'Encoders', playCategory: 'TOOLS', shortDesc: 'Base64, URL, HTML, JWT & hex encoders and decoders. 40+ free tools, offline.' },
    seo: { keywords: 'base64 encode, base64 decode, url encoder, url decoder, html entity encoder, jwt decoder, hex converter' },
  }),

  brand({
    id: 'colors', slug: 'colors', domain: 'toolsriftcolors.com',
    ...
    android: { packageId: 'com.toolsrift.colors', appName: 'ToolsRift Color Tools', shortName: 'Color Tools', playCategory: 'ART_AND_DESIGN', shortDesc: 'Color picker, palette generator, HEX/RGB/HSL converter & contrast checker. Free.' },
  ...
  brand({
    id: 'css', slug: 'css', domain: 'toolsriftcss.com',
    ...
    android: { packageId: 'com.toolsrift.css', appName: 'ToolsRift CSS Generators', shortName: 'CSS Gen', playCategory: 'TOOLS', shortDesc: 'CSS gradient, shadow, border-radius, animation & grid generators. 38 free tools.' },
  ...
  brand({
    id: 'html', slug: 'html', domain: 'toolsrifthtml.com',
    ...
    android: { packageId: 'com.toolsrift.html', appName: 'ToolsRift HTML Tools', shortName: 'HTML Tools', playCategory: 'TOOLS', shortDesc: 'HTML formatter, minifier, validator, encoder & generators. 43 free tools.' },
    seo: { keywords: 'html formatter, html minifier, html validator, html encoder, html table generator, meta tag generator' },
  }),

  brand({
    id: 'js', slug: 'js', domain: 'toolsriftjs.com',
    ...
    android: { packageId: 'com.toolsrift.js', appName: 'ToolsRift JavaScript Tools', shortName: 'JS Tools', playCategory: 'TOOLS', shortDesc: 'JavaScript formatter, minifier, validator & obfuscator. 24 free tools, offline.' },
    seo: { keywords: 'javascript formatter, js minifier, javascript beautifier, js validator, javascript obfuscator, json to js' },
  }),

  brand({
    id: 'formatters', slug: 'formatters', domain: 'toolsriftformatters.com',
    ...
    android: { packageId: 'com.toolsrift.formatters', appName: 'ToolsRift Code Formatters', shortName: 'Formatters', playCategory: 'TOOLS', shortDesc: 'Format & minify CSS, SQL, XML, YAML, Markdown and 20+ languages. Free, offline.' },
    seo: { keywords: 'code formatter, sql formatter, xml formatter, yaml formatter, css beautifier, markdown formatter, code beautifier' },
  }),

  brand({
    id: 'hash', slug: 'hash', domain: 'toolsrifthash.com',
    ...
    android: { packageId: 'com.toolsrift.hash', appName: 'ToolsRift Hash & Crypto', shortName: 'Hash Tools', playCategory: 'TOOLS', shortDesc: 'MD5, SHA-256, SHA-512, HMAC, bcrypt & UUID generators. 31 free tools, offline.' },
    seo: { keywords: 'sha256 generator, md5 hash, sha512, hmac generator, bcrypt generator, uuid generator, checksum calculator' },
  }),

  brand({
    id: 'fancy', slug: 'fancy', domain: 'toolsriftfancy.com',
    ...
    android: { packageId: 'com.toolsrift.fancy', appName: 'ToolsRift Fancy Text', shortName: 'Fancy Text', playCategory: 'SOCIAL', shortDesc: 'Fancy fonts for bios & posts: bold, cursive, gothic, bubble & 30 Unicode styles.' },
    seo: { keywords: 'fancy text generator, cursive text, bold text generator, unicode fonts, instagram fonts, cool text generator' },
  }),

  brand({
    id: 'encoding', slug: 'encoding', domain: 'toolsriftencoding.com',
    ...
    android: { packageId: 'com.toolsrift.encoding', appName: 'ToolsRift Text Encoding', shortName: 'Encoding', playCategory: 'EDUCATION', shortDesc: 'Morse code, binary, NATO alphabet, Caesar & ROT13 translators. 28 free tools.' },
    seo: { keywords: 'morse code translator, binary translator, caesar cipher, rot13, nato phonetic alphabet, text to binary' },
  }),

  brand({
    id: 'everyday', slug: 'everyday', domain: 'toolsrifteveryday.com',
    ...
    android: { packageId: 'com.toolsrift.everyday', appName: 'ToolsRift Everyday Tools', shortName: 'Everyday', playCategory: 'TOOLS', shortDesc: 'Age calculator, timers, stopwatch, typing test, dice & 25+ daily tools. Free.' },
    seo: { keywords: 'age calculator, online timer, stopwatch, typing test, dice roller, countdown timer, everyday tools' },
  }),

  brand({
    id: 'generators', slug: 'generators', domain: 'toolsriftgenerators.com',
    ...
    android: { packageId: 'com.toolsrift.generators', appName: 'ToolsRift Generators', shortName: 'Generators', playCategory: 'TOOLS', shortDesc: 'Password, UUID, QR code, barcode & fake data generators. 43 free tools, offline.' },
  ...
  brand({
    id: 'gen-content', slug: 'generators2', domain: 'toolsriftcontent.com',
    ...
    android: { packageId: 'com.toolsrift.content', appName: 'ToolsRift Content Generators', shortName: 'Content Gen', playCategory: 'BUSINESS', shortDesc: 'Privacy policy, terms, SVG art, ad copy & bio generators. 48 free content tools.' },
    seo: { keywords: 'privacy policy generator, terms of service generator, svg pattern generator, ad copy generator, bio generator' },
  }),

  brand({
    id: 'devgen', slug: 'devgen', domain: 'toolsriftdevgen.com',
    ...
    android: { packageId: 'com.toolsrift.devgen', appName: 'ToolsRift Dev Config Gen', shortName: 'DevGen', playCategory: 'TOOLS', shortDesc: '.gitignore, Dockerfile, nginx, package.json & .env generators. 43 free tools.' },
    seo: { keywords: 'gitignore generator, dockerfile generator, nginx config generator, package.json generator, env file generator' },
  }),

  brand({
    id: 'devtools', slug: 'devtools', domain: 'toolsriftdevtools.com',
  ...
  brand({
    id: 'mathcalc', slug: 'mathcalc', domain: 'toolsriftmath.com',
    ...
    android: { packageId: 'com.toolsrift.math', appName: 'ToolsRift Math Calculators', shortName: 'Math Calc', playCategory: 'EDUCATION', shortDesc: 'Geometry, algebra, trig, matrix & statistics calculators. 56 free solvers.' },
  ...
  brand({
    id: 'financecalc', slug: 'financecalc', domain: 'toolsriftfinance.com',
    siteName: 'ToolsRift Finance', wordmark: ['ToolsRift', 'Finance'],
    tagline: 'Numbers that matter.',
    concept: {
      name: 'Ledger',
      headline: 'Know the number before you sign.',
      sub: 'EMI, SIP, loan, tax, retirement, BMI, TDEE and calorie calculators — private, precise and free.',
    ...
    android: { packageId: 'com.toolsrift.finance', appName: 'ToolsRift Finance & Health', shortName: 'Finance', playCategory: 'FINANCE', shortDesc: 'EMI, SIP, loan, tax, BMI, TDEE & calorie calculators. 64 free tools, offline.' },
  ...
  brand({
    id: 'units', slug: 'units', domain: 'toolsriftunits.com',
    ...
    android: { packageId: 'com.toolsrift.units', appName: 'ToolsRift Unit Converter', shortName: 'Units', playCategory: 'TOOLS', shortDesc: 'Length, weight, temperature, speed, area & volume converter. 37 free tools.' },
  ...
  brand({
    id: 'converters2', slug: 'converters2', domain: 'toolsriftconverters.com',
    ...
    android: { packageId: 'com.toolsrift.converters', appName: 'ToolsRift Specialty Converters', shortName: 'Converters', playCategory: 'TOOLS', shortDesc: 'Electrical, clothing size, paper size & physics converters. 31 free tools.' },
  ...
  brand({
    id: 'business', slug: 'business', domain: 'toolsriftbusiness.com',
    ...
    android: { packageId: 'com.toolsrift.business', appName: 'ToolsRift Business Tools', shortName: 'Business', playCategory: 'BUSINESS', shortDesc: 'Invoice, quotation, receipt, resume & cover letter generators. 41 free tools.' },
  ...
  brand({
    id: 'random', slug: 'random', domain: 'toolsriftrandom.com',
    ...
    android: { packageId: 'com.toolsrift.random', appName: 'ToolsRift Random & Games', shortName: 'Random', playCategory: 'ENTERTAINMENT', shortDesc: 'Spinner wheel, dice, coin flip, name picker & party games. 40 free randomizers.' },
    seo: { keywords: 'spinner wheel, random name picker, dice roller, coin flip, random number generator, team generator, magic 8 ball' },
  }),

  brand({
    id: 'audio', slug: 'audio', domain: 'toolsriftaudio.com',
    ...
    android: { packageId: 'com.toolsrift.audio', appName: 'ToolsRift Audio Tools', shortName: 'Audio', playCategory: 'MUSIC_AND_AUDIO', shortDesc: 'Trim, convert, record & normalize audio plus text-to-speech. 30 free tools.' },
    seo: { keywords: 'audio trimmer, audio converter, mp3 cutter, voice recorder, text to speech, audio normalizer, wav to mp3' },
  }),

  brand({
    id: 'office', slug: 'office', domain: 'toolsriftoffice.com',
    ...
    android: { packageId: 'com.toolsrift.office', appName: 'ToolsRift Office Tools', shortName: 'Office', playCategory: 'PRODUCTIVITY', shortDesc: 'vCard, calendar invite, QR, notes, labels & signature tools. 25 free tools.' },
  ...
  brand({
    id: 'data', slug: 'data', domain: 'toolsriftdata.com',
    ...
    android: { packageId: 'com.toolsrift.data', appName: 'ToolsRift Charts & Data', shortName: 'Charts', playCategory: 'PRODUCTIVITY', shortDesc: 'Chart maker, CSV cleaner, pivot table & statistics tools. 25 free tools.' },
    seo: { keywords: 'chart maker, bar chart generator, pie chart maker, csv cleaner, pivot table online, statistics calculator' },
  }),

  brand({
    id: 'study', slug: 'study', domain: 'toolsriftstudy.com',
    ...
    concept: {
      ...
      sub: 'Flashcards, quizzes, citation generators, periodic table, Pomodoro timers and revision planners — free for every student.',
    ...
    android: { packageId: 'com.toolsrift.study', appName: 'ToolsRift Study Tools', shortName: 'Study', playCategory: 'EDUCATION', shortDesc: 'Flashcards, quizzes, citations, periodic table & study timers. 30 free tools.' },
    seo: { keywords: 'flashcard maker, quiz generator, citation generator, apa citation, periodic table, pomodoro timer, study planner' },
  }),

  brand({
    id: 'video', slug: 'video', domain: 'toolsriftvideo.com',
    ...
    android: { packageId: 'com.toolsrift.video', appName: 'ToolsRift Video Tools', shortName: 'Video', playCategory: 'VIDEO_PLAYERS', shortDesc: 'Trim, compress, convert video & make GIFs on-device. 25 free tools, no uploads.' },
