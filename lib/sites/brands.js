...
const BRANDS = [
  brand({
    ...
    android: { packageId: 'com.toolsrift.text.twa', appName: 'Word Counter & Text Tools', shortName: 'Text Tools', playCategory: 'PRODUCTIVITY', shortDesc: 'Word counter, case converter, lorem ipsum & 60+ text tools. Private.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.image', appName: 'Image Resizer & Compressor', shortName: 'Image Tools', playCategory: 'PHOTOGRAPHY', shortDesc: 'Resize, compress, crop & convert images offline. 60+ tools, no uploads.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.pdf', appName: 'PDF Tools: Merge & Split', shortName: 'PDF Tools', playCategory: 'PRODUCTIVITY', shortDesc: 'Merge, split, compress, sign & convert PDFs offline. 40 tools, no uploads.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.json', appName: 'JSON Formatter & Validator', shortName: 'JSON Tools', playCategory: 'TOOLS', shortDesc: 'JSON formatter, validator, minifier, diff & converters. 30 tools, offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.encoders', appName: 'Base64 Encoder & Decoder', shortName: 'Encoders', playCategory: 'TOOLS', shortDesc: 'Base64, URL, HTML, JWT & hex encoders and decoders. 40+ tools, offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.colors', appName: 'Color Picker & Converter', shortName: 'Color Tools', playCategory: 'ART_AND_DESIGN', shortDesc: 'Color picker, palette generator, HEX/RGB/HSL converter & contrast checker.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.css', appName: 'CSS Gradient & Shadow Maker', shortName: 'CSS Gen', playCategory: 'TOOLS', shortDesc: 'CSS gradient, shadow, border-radius, animation & grid generators. 38 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.html', appName: 'HTML Formatter & Viewer', shortName: 'HTML Tools', playCategory: 'TOOLS', shortDesc: 'HTML formatter, minifier, validator, encoder & generators. 43 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.js', appName: 'JS Formatter & Minifier', shortName: 'JS Tools', playCategory: 'TOOLS', shortDesc: 'JavaScript formatter, minifier, validator & obfuscator. 24 tools, offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.formatters', appName: 'Code Formatter & Beautifier', shortName: 'Formatters', playCategory: 'TOOLS', shortDesc: 'Format & minify CSS, SQL, XML, YAML, Markdown and 20+ languages. Works offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.hash', appName: 'MD5 & SHA256 Hash Generator', shortName: 'Hash Tools', playCategory: 'TOOLS', shortDesc: 'MD5, SHA-256, SHA-512, HMAC, bcrypt & UUID generators. 31 tools, offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.fancy', appName: 'Fancy Text & Font Generator', shortName: 'Fancy Text', playCategory: 'ART_AND_DESIGN', shortDesc: 'Fancy fonts for bios & posts: bold, cursive, gothic, bubble & 30 Unicode styles.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.encoding', appName: 'Morse Code & Binary Converter', shortName: 'Encoding', playCategory: 'EDUCATION', shortDesc: 'Morse code, binary, NATO alphabet, Caesar & ROT13 translators. 28 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.everyday', appName: 'Age Calculator & Timers', shortName: 'Everyday', playCategory: 'TOOLS', shortDesc: 'Age calculator, timers, stopwatch, typing test, dice & 25+ daily tools. Offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.generators', appName: 'Password & QR Code Maker', shortName: 'Generators', playCategory: 'TOOLS', shortDesc: 'Password, UUID, QR code, barcode & fake data generators. 43 tools, offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.content', appName: 'Privacy Policy Generator', shortName: 'Content Gen', playCategory: 'BUSINESS', shortDesc: 'Privacy policy, terms, SVG art, ad copy & bio generators. 48 content tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.devgen', appName: 'Gitignore & Dockerfile Maker', shortName: 'DevGen', playCategory: 'TOOLS', shortDesc: '.gitignore, Dockerfile, nginx, package.json & .env generators. 43 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.devtools', appName: 'Regex Tester & Dev Tools', shortName: 'DevTools', playCategory: 'TOOLS', shortDesc: 'Regex tester, JSON diff, JWT debugger, cron builder & 50+ dev tools. Offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.math', appName: 'Math & Geometry Calculator', shortName: 'Math Calc', playCategory: 'EDUCATION', shortDesc: 'Geometry, algebra, trig, matrix & statistics calculators. 56 solvers.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.finance', appName: 'EMI & Finance Calculator', shortName: 'Finance', playCategory: 'FINANCE', shortDesc: 'EMI, SIP, loan, tax, BMI, TDEE & calorie calculators. 64 tools, offline.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.units', appName: 'Unit Converter: All Units', shortName: 'Units', playCategory: 'TOOLS', shortDesc: 'Length, weight, temperature, speed, area & volume converter. 37 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.converters', appName: 'Electrical Unit Converter', shortName: 'Converters', playCategory: 'TOOLS', shortDesc: 'Electrical, clothing size, paper size & physics converters. 31 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.business', appName: 'Invoice & Resume Generator', shortName: 'Business', playCategory: 'BUSINESS', shortDesc: 'Invoice, quotation, receipt, resume & cover letter generators. 41 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.random', appName: 'Spinner Wheel & Randomizer', shortName: 'Random', playCategory: 'ENTERTAINMENT', shortDesc: 'Spinner wheel, dice, coin flip, name picker & party games. 40 randomizers.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.audio', appName: 'Audio Trimmer & Converter', shortName: 'Audio', playCategory: 'MUSIC_AND_AUDIO', shortDesc: 'Trim, convert, record & normalize audio plus text-to-speech. 30 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.office', appName: 'QR Code Generator & vCard', shortName: 'Office', playCategory: 'PRODUCTIVITY', shortDesc: 'vCard, calendar invite, QR, notes, labels & signature tools. 25 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.data', appName: 'Chart Maker: Bar, Line, Pie', shortName: 'Charts', playCategory: 'PRODUCTIVITY', shortDesc: 'Chart maker, CSV cleaner, pivot table & statistics tools. 25 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.study', appName: 'Flashcards & Quiz Maker', shortName: 'Study', playCategory: 'EDUCATION', shortDesc: 'Flashcards, quizzes, citations, periodic table & study timers. 30 tools.' },
  ...
  brand({
    ...
    android: { packageId: 'com.toolsrift.video', appName: 'Video Trimmer & Converter', shortName: 'Video', playCategory: 'VIDEO_PLAYERS', shortDesc: 'Trim, compress, convert video & make GIFs on-device. 25 tools, no uploads.' },
