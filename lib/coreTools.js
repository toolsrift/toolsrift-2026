...
export const CORE_TOOL_IDS = [
  ...
  // pdf (10)
  // word-to-pdf, pdf-password-protect and pdf-bookmarks used to be excluded here
  // because they rendered a "not available in your browser yet" notice and did no
  // work. They have since been removed from the PDF tool listing altogether -- a
  // card promising "formatting preservation", and an FAQ claiming AES-256
  // encryption, in front of a tool that does nothing is the same thin/unhelpful
  // pattern behind the Aug 2026 action. Re-add them to the listing, and here, if
  // and when they are actually implemented.
  "pdf-merger", "pdf-splitter", "pdf-compressor", "pdf-to-jpg", "jpg-to-pdf", "pdf-to-text",
  "pdf-unlock", "pdf-watermark", "pdf-rotator", "pdf-page-numbering",
  // text (16)
