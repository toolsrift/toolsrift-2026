...
export const CORE_TOOL_IDS = [
  ...
  // pdf (10)
  // NOT listed, deliberately: word-to-pdf, pdf-password-protect and pdf-bookmarks
  // render an "not available in your browser yet" notice and do no work. Indexing a
  // page that ranks for "word to pdf" and then does nothing earns an immediate bounce
  // on a high-intent query -- the thin/unhelpful pattern behind the Aug 2026 action.
  // Re-add them here if and when they are implemented.
