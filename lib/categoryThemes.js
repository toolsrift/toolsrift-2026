...
const RAW = [
  { id:'text',        name:'Text Tools',                  slug:'text',        icon:'✍️', motif:'Aa', description:'Word counter, case converter, lorem ipsum, readability and more', tagline:'Type, transform, refine.',           toolCount:54, color:'#3B82F6', colorDark:'#2563EB', accent2:'#60A5FA', pageRoute:'/text',        appPackage:'com.toolsrift.text',        fontStack:'editorial',  animStyle:'smooth' },
  ...
  { id:'js',          name:'JavaScript Tools',            slug:'js',          icon:'⚙️', motif:'JS', description:'Format, minify, validate and obfuscate JavaScript code',           tagline:'Tame your scripts.',                toolCount:14, color:'#EAB308', colorDark:'#CA8A04', accent2:'#FACC15', pageRoute:'/js',          appPackage:'com.toolsrift.js',          fontStack:'monoFirst',  animStyle:'precise', textOnColor:'#0a0a0a' },
