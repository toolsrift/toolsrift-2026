...
const RAW = [
  { id:'text',        name:'Text Tools',                  slug:'text',        icon:'✍️', motif:'Aa', description:'Word counter, case converter, lorem ipsum, readability and more', tagline:'Type, transform, refine.',           toolCount:48, color:'#3B82F6', colorDark:'#2563EB', accent2:'#60A5FA', pageRoute:'/text',        appPackage:'com.toolsrift.text',        fontStack:'editorial',  animStyle:'smooth' },
  ...
  { id:'code',        name:'JSON Tools',                  slug:'json',        icon:'{}', motif:'{ }', description:'Format, validate, minify and convert JSON in one click',           tagline:'Structured data, simplified.',      toolCount:29, color:'#10B981', colorDark:'#059669', accent2:'#34D399', pageRoute:'/json',        appPackage:'com.toolsrift.code',        fontStack:'monoFirst',  animStyle:'precise' },
  ...
  { id:'colors',      name:'Color Tools',                 slug:'colors',      icon:'🎨', motif:'◉',  description:'HEX/RGB/HSL converter, palette generator, contrast checker',       tagline:'Every shade, every space.',         toolCount:23, color:'#A855F7', colorDark:'#9333EA', accent2:'#C084FC', pageRoute:'/colors',      appPackage:'com.toolsrift.colors',      fontStack:'expressive', animStyle:'liquid' },
  { id:'css',         name:'CSS Generators',              slug:'css',         icon:'🎭', motif:'◇',  description:'Gradient, box-shadow, border-radius, animation and grid generators',tagline:'Style, generated.',                 toolCount:24, color:'#06B6D4', colorDark:'#0891B2', accent2:'#22D3EE', pageRoute:'/css',         appPackage:'com.toolsrift.css',         fontStack:'expressive', animStyle:'liquid' },
  ...
  { id:'hash',        name:'Hash & Crypto',               slug:'hash',        icon:'🔐', motif:'#',  description:'MD5, SHA-1, SHA-256, HMAC, bcrypt and UUID generators',             tagline:'Cryptographically secure.',         toolCount:28, color:'#7C3AED', colorDark:'#6D28D9', accent2:'#A78BFA', pageRoute:'/hash',        appPackage:'com.toolsrift.hash',        fontStack:'monoFirst',  animStyle:'glitch' },
  { id:'fancy',       name:'Fancy Text',                  slug:'fancy',       icon:'🪄', motif:'𝓕',  description:'Bold, italic, cursive, gothic and 15+ Unicode text styles',         tagline:'Style your words.',                 toolCount:24, color:'#D946EF', colorDark:'#C026D3', accent2:'#E879F9', pageRoute:'/fancy',       appPackage:'com.toolsrift.fancy',       fontStack:'expressive', animStyle:'bouncy' },
  { id:'encoding',    name:'Text Encoding',               slug:'encoding',    icon:'🔡', motif:'01', description:'Morse code, binary, NATO alphabet, Caesar cipher, ROT13 and more', tagline:'Encode anything.',                  toolCount:14, color:'#6366F1', colorDark:'#4F46E5', accent2:'#818CF8', pageRoute:'/encoding',    appPackage:'com.toolsrift.encoding',    fontStack:'monoFirst',  animStyle:'glitch' },
  { id:'everyday',    name:'Everyday Tools',              slug:'everyday',    icon:'🧰', motif:'✦',  description:'Age calculator, timers, stopwatch, typing test, dice and daily utilities', tagline:'Daily essentials.',                 toolCount:13, color:'#F97316', colorDark:'#EA580C', accent2:'#FB923C', pageRoute:'/everyday',    appPackage:'com.toolsrift.everyday',    fontStack:'default',    animStyle:'bouncy' },
