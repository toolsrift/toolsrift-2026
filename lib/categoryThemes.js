...
// Single source of truth for all 34 categories. Each entry = a micro-brand.
...
const RAW = [
  ...
  { id:'generators',  name:'Security Generators',         slug:'generators',  icon:'🛡️', motif:'◆',  description:'Password, UUID, QR code, barcode and secure ID generators',        tagline:'Secrets, generated safely.',        toolCount:35, color:'#84CC16', colorDark:'#65A30D', accent2:'#A3E635', pageRoute:'/generators',  appPackage:'com.toolsrift.generators',  fontStack:'monoFirst',  animStyle:'precise', textOnColor:'#0a0a0a' },
  { id:'gen-content', name:'Content Generators',          slug:'generators2', icon:'📢', motif:'¶',  description:'Privacy policy, terms of service, SVG art and ad copy generators', tagline:'Boilerplate, beautifully.',         toolCount:35, color:'#0EA5E9', colorDark:'#0284C7', accent2:'#38BDF8', pageRoute:'/generators2', appPackage:'com.toolsrift.gen-content', fontStack:'editorial',  animStyle:'smooth' },
  { id:'devgen',      name:'Dev Config Generators',       slug:'devgen',      icon:'🗂️', motif:'$_', description:'.gitignore, Dockerfile, nginx, package.json and .env generators',  tagline:'Configs, on demand.',               toolCount:30, color:'#8B5CF6', colorDark:'#7C3AED', accent2:'#A78BFA', pageRoute:'/devgen',      appPackage:'com.toolsrift.devgen',      fontStack:'monoFirst',  animStyle:'glitch' },
  { id:'devtools',    name:'Developer Tools',             slug:'devtools',    icon:'🔧', motif:'>_', description:'Regex tester, JSON diff, JWT debugger, cron builder, chmod calc',  tagline:'Your daily dev arsenal.',           toolCount:40, color:'#22D3EE', colorDark:'#06B6D4', accent2:'#67E8F9', pageRoute:'/devtools',    appPackage:'com.toolsrift.devtools',    fontStack:'monoFirst',  animStyle:'glitch' },
  { id:'mathcalc',    name:'Math Calculators',            slug:'mathcalc',    icon:'📐', motif:'∑',  description:'Geometry, algebra, trigonometry, matrices and statistics solvers', tagline:'Solve, instantly.',                 toolCount:35, color:'#6366F1', colorDark:'#4F46E5', accent2:'#818CF8', pageRoute:'/mathcalc',    appPackage:'com.toolsrift.mathcalc',    fontStack:'editorial',  animStyle:'precise' },
  { id:'financecalc', name:'Finance & Health Calculators',slug:'financecalc', icon:'💰', motif:'₹',  description:'EMI, TDEE, tax estimator, investment returns and calorie calculators', tagline:'Numbers that matter.',           toolCount:35, color:'#22C55E', colorDark:'#16A34A', accent2:'#4ADE80', pageRoute:'/financecalc', appPackage:'com.toolsrift.financecalc', fontStack:'editorial',  animStyle:'precise' },
  ...
  { id:'checker',     name:'Checkers & Analyzers',        slug:'checker',     icon:'🔍', motif:'✓',  description:'SEO checker, plagiarism detector, grammar checker and validators', tagline:'Audit before you ship.',            toolCount:10, color:'#F59E0B', colorDark:'#D97706', accent2:'#FBBF24', pageRoute:'/checker',     appPackage:'com.toolsrift.checker',     fontStack:'editorial',  animStyle:'smooth', textOnColor:'#0a0a0a' },
];
