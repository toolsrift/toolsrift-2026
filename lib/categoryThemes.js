...
const RAW = [
  ...
  { id:'html',        name:'HTML Tools',                  slug:'html',        icon:'🌐', motif:'</>',description:'Format, minify, validate, encode and generate HTML markup',       tagline:'Markup, mastered.',                 toolCount:29, color:'#F97316', colorDark:'#EA580C', accent2:'#FB923C', pageRoute:'/html',        appPackage:'com.toolsrift.html',        fontStack:'monoFirst',  animStyle:'precise' },
  ...
  { id:'generators',  name:'Security Generators',         slug:'generators',  icon:'🛡️', motif:'◆',  description:'Password, UUID, QR code, barcode and secure ID generators',        tagline:'Secrets, generated safely.',        toolCount:29, color:'#84CC16', colorDark:'#65A30D', accent2:'#A3E635', pageRoute:'/generators',  appPackage:'com.toolsrift.generators',  fontStack:'monoFirst',  animStyle:'precise', textOnColor:'#0a0a0a' },
