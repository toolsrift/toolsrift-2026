...
// pages/[slug]/[tool].js used to WRITE that hash before mounting the widget
...
// Published by pages/[slug]/[tool].js during render. Carries `path` so the
...
/**
 * True when the current page is a /[slug]/[tool] route, which server-renders
