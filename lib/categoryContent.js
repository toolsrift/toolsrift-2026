...
const CONTENT = {
  ...
  pdf: {
    ...
    intro: [
      "PDFs are how the world shares documents — contracts, invoices, study notes, legal filings, scanned forms. And the workflows around them are some of the most-searched online: merging multiple files into one, splitting a long PDF into chapters, compressing a scan to email, converting to or from images, extracting specific pages. ToolsRift offers 28+ PDF tools that handle every common task, completely in your browser, without ever uploading your sensitive documents to a third-party server.",
