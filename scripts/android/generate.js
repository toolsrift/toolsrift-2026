...
function twaManifest(b, tools) {
  ...
  return {
    ...
    startUrl: '/?source=twa',
    iconUrl: `https://${host}/brands/${b.id}/icon-512.png`,
    maskableIconUrl: `https://${host}/brands/${b.id}/icon-maskable-512.png`,
    splashScreenFadeOutDuration: 300,
    // One keystore per app — generated by scripts/android/keystore.sh <id>.
    signingKey: { path: `../../keys/${b.id}.keystore`, alias: b.id },
    ...
    shortcuts: tools.slice(0, 4).map(t => ({
      ...
      chosenIconUrl: `https://${host}/brands/${b.id}/icon-192.png`,
    })),
