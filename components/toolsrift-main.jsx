...
const STEPS = [
  { n: '01', icon: '🔍', title: 'Pick a tool',     desc: 'Browse 29 categories or search by name.' },
...
const FREE_PILLARS = [
  { icon: '🛠️', tint: '#3B82F6', title: '1,136+ Free Tools', desc: 'Every tool is free. No daily limits, no paywalls, no sign-up required.' },
      ...
      <motion.div style={{ y, opacity, position: 'relative', zIndex: 2, maxWidth: 880, margin: '0 auto' }}>
        <BlurUp delay={0.05}>
          ...
          >
            ...
            <CountUp to={1136} suffix="+" /> Free Tools · 29 Categories · No signup
          </motion.div>
        </BlurUp>
        ...
        <FadeUp delay={0.4}>
          <p style={{
            ...
            1,136+ free online tools — calculators, PDF, image, code, design, dev. Instant results, fully in your browser.
          </p>
        </FadeUp>
        ...
        <FadeUp delay={0.85}>
          <div style={{
            ...
            {[
              { v: 1136, suffix: '+', label: 'Tools' },
              { v: 29,   suffix: '',  label: 'Categories' },
      ...
      <FadeUp>
        <h2 style={{
          ...
          Start using <span style={{
            backgroundImage: 'linear-gradient(135deg,#22D3EE,#A78BFA,#F472B6)',
            WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text',
          }}>1,136 free tools</span> right now.
        </h2>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: '#94A3B8', fontSize: 14, lineHeight: 1.6, margin: 0, maxWidth: 280 }}>
              1,136+ free online tools. No signup. No limits. Built with ♥ in India.
            </p>
          </div>
          {cols.map((c, ci) => (
            <div key={ci}>
