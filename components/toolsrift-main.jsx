...
const FREE_PILLARS = [
  { icon: '🛠️', tint: '#3B82F6', title: '767+ Free Tools', desc: 'Every tool is free. No daily limits, no paywalls, no sign-up required.' },
      ...
      <motion.div style={{ y, opacity, position: 'relative', zIndex: 2, maxWidth: 880, margin: '0 auto' }}>
        <BlurUp delay={0.05}>
          ...
          >
            ...
            <CountUp to={767} suffix="+" /> Free Tools · 23 Categories · No signup
          </motion.div>
        </BlurUp>
        ...
        <FadeUp delay={0.4}>
          <p style={{
            ...
            767+ free online tools — calculators, PDF, image, code, design, dev. Instant results, fully in your browser.
          </p>
        </FadeUp>
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ color: '#94A3B8', fontSize: 14, lineHeight: 1.6, margin: 0, maxWidth: 280 }}>
              767+ free online tools. No signup. No limits. Built with ♥ in India.
            </p>
          </div>
          {cols.map((c, ci) => (
            <div key={ci}>
