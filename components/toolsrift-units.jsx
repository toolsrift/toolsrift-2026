...
const UNITS = {
  ...
  area:[
    ...
    {id:"acre", label:"Acre",                     toBase:v=>v*4046.8564224,fromBase:b=>b/4046.8564224},
    {id:"mi2",  label:"Square Mile (mi²)",        toBase:v=>v*2589988.110336, fromBase:b=>b/2589988.110336},
    {id:"yd2",  label:"Square Yard (yd²)",        toBase:v=>v*0.83612736,  fromBase:b=>b/0.83612736},
    {id:"ft2",  label:"Square Foot (ft²)",        toBase:v=>v*0.09290304,  fromBase:b=>b/0.09290304},
    {id:"in2",  label:"Square Inch (in²)",        toBase:v=>v*0.00064516,  fromBase:b=>b/0.00064516},
  ],
  ...
  energy:[
    ...
    {id:"ev",   label:"Electronvolt (eV)",      toBase:v=>v*1.602176634e-19, fromBase:b=>b/1.602176634e-19},
...
const TOOL_META = mergeHowTo({
  ...
  "area-converter":         {title:"Area Converter – m², Acres, Hectares, Sq Ft", desc:"Convert area between square meters, square kilometers, acres, hectares, square feet, square miles and more.", faq:[["How many square feet in an acre?","1 acre = 43,560 square feet = 4,046.86 square meters."],["How many acres in a hectare?","1 hectare = 2.47105 acres = 10,000 square meters."],["How do I convert m² to sq ft?","Multiply square meters by 10.7639 to get square feet."]]},
  "volume-converter":       {title:"Volume Converter – Liters, Gallons, m³, Cups", desc:"Convert volume between liters, US and UK gallons, cubic meters, cubic feet, cups and fluid ounces.", faq:[["How many liters in a US gallon?","1 US gallon = 3.78541 liters, while 1 UK (imperial) gallon = 4.54609 liters."],["How many cubic feet in a cubic meter?","1 cubic meter = 35.3147 cubic feet."],["What is the difference between US and UK gallons?","A US gallon is smaller than a UK gallon — 1 UK gallon ≈ 1.20095 US gallons."]]},
  "speed-converter":        {title:"Speed Converter – km/h, mph, Knots, Mach", desc:"Convert speed between meters per second, km/h, mph, knots, Mach and a fraction of the speed of light.", faq:[["How do I convert km/h to mph?","Divide km/h by 1.60934, or multiply by 0.62137. So 100 km/h ≈ 62.14 mph."],["What is a knot in km/h?","1 knot (nautical mile per hour) = 1.852 km/h = 1.15078 mph."],["What speed is Mach 1?","Mach 1 is the local speed of sound, about 1,225 km/h (761 mph) at sea level and 15°C — it varies with altitude and temperature."]]},
  "pressure-converter":     {title:"Pressure Converter – Pa, Bar, PSI, atm, Torr", desc:"Convert pressure between pascals, kilopascals, bar, PSI, standard atmospheres, Torr and inches of mercury.", faq:[["How many PSI in a bar?","1 bar = 14.5038 PSI (pounds per square inch)."],["What is standard atmospheric pressure?","1 standard atmosphere (atm) = 101,325 Pa = 1.01325 bar = 14.696 PSI."],["How do I convert kPa to PSI?","Multiply kilopascals by 0.145038 to get PSI."]]},
  "energy-converter":       {title:"Energy Converter – Joules, kWh, BTU, Calories", desc:"Convert energy between joules, kilojoules, kilowatt-hours, BTU, calories, kilocalories and electronvolts.", faq:[["How many joules in a kWh?","1 kilowatt-hour = 3,600,000 joules (3.6 megajoules)."],["How many calories in a joule?","1 calorie (small cal) = 4.184 joules; 1 kilocalorie (food Calorie) = 4,184 joules."],["What is a BTU?","A British Thermal Unit equals about 1,055.06 joules — commonly used for air conditioner and heater ratings."]]},
  "power-converter":        {title:"Power Converter – Watts, kW, Horsepower, BTU/hr", desc:"Convert power between watts, kilowatts, megawatts, mechanical and metric horsepower, and BTU per hour.", faq:[["How many watts in a horsepower?","1 mechanical horsepower = 745.7 watts; 1 metric horsepower (PS) = 735.5 watts."],["How do I convert kW to horsepower?","Multiply kilowatts by 1.34102 to get mechanical horsepower."],["What is BTU/hr used for?","BTU per hour rates the heating or cooling power of air conditioners and furnaces; 1 BTU/hr ≈ 0.293 watts."]]},
  "time-converter":         {title:"Time Converter – Seconds, Hours, Days, Years", desc:"Convert time between nanoseconds, seconds, minutes, hours, days, weeks, months, years and centuries.", faq:[["How many seconds in a day?","1 day = 86,400 seconds = 1,440 minutes = 24 hours."],["How many days in a year?","A calendar year is 365 days (366 in a leap year); this tool uses 365.25 days for the average year."],["How do I convert minutes to hours?","Divide the number of minutes by 60."]]},
  "angle-converter":        {title:"Angle Converter – Degrees, Radians, Gradians", desc:"Convert angles between degrees, radians, gradians, arcminutes, arcseconds and full turns.", faq:[["How do I convert degrees to radians?","Multiply degrees by π/180 (≈0.0174533). So 180° = π radians ≈ 3.14159 radians."],["What is a gradian?","A gradian (or gon) divides a right angle into 100 units, so a full circle is 400 gradians."],["How many arcminutes in a degree?","1 degree = 60 arcminutes = 3,600 arcseconds."]]},
  "frequency-converter":    {title:"Frequency Converter – Hz, kHz, MHz, GHz, RPM", desc:"Convert frequency between hertz, kilohertz, megahertz, gigahertz, RPM and radians per second.", faq:[["How many Hz in a kHz?","1 kilohertz (kHz) = 1,000 hertz (Hz)."],["How do I convert RPM to Hz?","Divide RPM by 60. For example, 1,200 RPM = 20 Hz (rotations per second)."],["What frequency is human hearing?","Humans typically hear from about 20 Hz to 20,000 Hz (20 kHz)."]]},
  "fuel-converter":         {title:"Fuel Economy Converter – MPG, km/L, L/100km", desc:"Convert fuel economy between US MPG, UK (imperial) MPG, kilometers per liter and liters per 100 km.", faq:[["How do I convert MPG to L/100km?","Divide 235.215 by the US MPG value. For example, 30 US MPG ≈ 7.84 L/100km."],["Why are US and UK MPG different?","A US gallon (3.785 L) is smaller than a UK gallon (4.546 L), so the same car shows a higher UK MPG number than US MPG for identical fuel use."],["What does lower L/100km mean?","L/100km measures fuel used per distance, so a lower number means better fuel economy — unlike MPG, where higher is better."]]},
  "torque-converter":       {title:"Torque Converter – N·m, lb·ft, lb·in, kg·m", desc:"Convert torque between newton-meters, pound-feet, pound-inches, kilogram-meters and ounce-inches.", faq:[["How many lb·ft in a N·m?","1 newton-meter (N·m) = 0.737562 pound-feet (lb·ft)."],["How do I convert lb·ft to N·m?","Multiply pound-feet by 1.35582 to get newton-meters."],["Where is torque commonly specified?","Engine and wheel-nut torque specs commonly use N·m or lb·ft — always check which unit your torque wrench uses."]]},
  "force-converter":        {title:"Force Converter – Newtons, lbf, kgf, Dynes", desc:"Convert force between newtons, pound-force, kilogram-force, dynes, kilonewtons and poundals.", faq:[["How many newtons in a pound-force?","1 pound-force (lbf) = 4.44822 newtons (N)."],["What is kilogram-force?","Kilogram-force (kgf) is the force exerted by gravity on a 1 kg mass, equal to 9.80665 newtons."],["What is a dyne?","A dyne is the CGS unit of force, equal to 0.00001 newtons (10⁻⁵ N)."]]},
  "illuminance-converter":  {title:"Illuminance Converter – Lux, Foot-candles, Phot", desc:"Convert illuminance between lux, foot-candles, phot and kilolux for photography and lighting design.", faq:[["How many lux in a foot-candle?","1 foot-candle = 10.7639 lux."],["What lux level is typical office lighting?","Office lighting is typically 300–500 lux; direct sunlight can exceed 100,000 lux."],["What is a phot?","A phot is the CGS unit of illuminance, equal to 10,000 lux."]]},
  "density-converter":      {title:"Density Converter – kg/m³, g/cm³, lb/ft³", desc:"Convert density between kilograms per cubic meter, grams per cubic centimeter, grams per milliliter and pounds per cubic foot.", faq:[["How many kg/m³ in a g/cm³?","1 g/cm³ = 1,000 kg/m³. Water's density is 1 g/cm³ = 1,000 kg/m³."],["How do I convert lb/ft³ to kg/m³?","Multiply pounds per cubic foot by 16.0185 to get kg/m³."],["What is the density of water?","Fresh water is about 1,000 kg/m³ (1 g/cm³ or 1 g/mL) at 4°C, its temperature of maximum density."]]},
  "flow-converter":         {title:"Flow Rate Converter – m³/s, L/min, GPM, CFM", desc:"Convert volumetric flow rate between cubic meters per second, liters per minute, US gallons per minute and cubic feet per minute.", faq:[["How many L/min in a GPM?","1 US gallon per minute (GPM) = 3.78541 liters per minute (L/min)."],["What is CFM used for?","Cubic feet per minute (CFM) commonly rates air flow from fans, compressors and HVAC systems."],["How do I convert m³/s to L/min?","Multiply cubic meters per second by 60,000 to get liters per minute."]]},
  "typography-converter":   {title:"Typography / CSS Unit Converter – px, pt, em, rem", desc:"Convert typography and CSS units between pixels, points, em, rem, millimeters, centimeters, vw and vh, based on a chosen root font size.", faq:[["How many pixels in a point?","At the standard 96 DPI screen resolution, 1 point (pt) = 1.333 pixels (px)."],["What is the difference between em and rem?","1em is relative to the parent element's font size, while 1rem is always relative to the root (html) font size — commonly 16px by default."],["How do I convert px to rem?","Divide pixels by the root font size (usually 16). So 24px = 1.5rem at a 16px root."]]},
  ...
  return (
    <section style={{marginTop:32}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(2,1fr)",gap:10}}>
        {related.map(t=>(
          <a key={t.id} href={`/units/${t.id}`} style={{display:"flex",alignItems:"center",gap:10,padding:"10px 14px",background:"rgba(255,255,255,0.02)",border:`1px solid ${C.border}`,borderRadius:8,textDecoration:"none",transition:"border-color .15s"}}
  ...
  return (
    <div style={{maxWidth:860,margin:"0 auto",padding:"24px 20px 60px"}}>
      ...
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(240px,1fr))",gap:12}}>
        {tools.map(t=>(
          <a key={t.id} href={`/units/${t.id}`} style={{display:"flex",gap:12,padding:"14px 16px",background:C.surface,border:`1px solid ${C.border}`,borderRadius:10,textDecoration:"none",alignItems:"flex-start",transition:"all .15s"}}
