...
const SEO = {
  "invoice-gen":{title:"Free Invoice Generator Online",desc:"Create professional invoices online with line items, tax and totals calculated automatically. Add your logo, export as PDF, and send free — no signup required.",howTo:"Fill in your business and client details, add line items with quantity and price, and set your tax rate. Subtotal, tax and total recalculate live. Download or print the finished invoice as a PDF.",faq:[["What should an invoice include?","An invoice should include your business name, client details, invoice number, date, line items with descriptions, quantities, prices, subtotal, tax, and total amount."],["Is this invoice legally valid?","This tool generates a formatted invoice. For legal validity, consult your local business regulations."]]},
  "receipt-gen":{title:"Free Receipt Generator Online",desc:"Generate payment receipts online with itemized details, business name and payment method. Free, instant, and ready to download as a PDF for your customer.",howTo:"Enter your business name, the customer's details, items and amounts, and the payment method used. The tool totals everything automatically — download or print the finished receipt.",faq:[["What's the difference between an invoice and a receipt?","An invoice is a request for payment sent before payment. A receipt is confirmation that payment has been received."],["Can I customize the receipt?","Yes, add your business name, payment method, items, and notes."]]},
  "quotation-gen":{title:"Free Quotation Generator Online",desc:"Build professional price quotations for clients online with line items, validity period and totals. Free, instant, and ready to export as a PDF.",howTo:"Enter your business and client details, add line items with quantities and prices, and set a validity period for the quote. The tool totals everything — download or print the finished quotation.",faq:[["What is a quotation?","A quotation is a formal document that offers a price for goods or services before a buyer commits to purchase."],["How long should a quote be valid?","Typically 15-30 days, but it depends on your industry and pricing stability."]]},
  "business-card-gen":{title:"Free Business Card Generator",desc:"Design business cards online with a live preview — set your name, title, company and contact details. Free, instant, and ready to download or print.",howTo:"Enter your name, title, company, and contact details, and choose a layout and colors. The card preview updates live — download the finished design when it looks right.",faq:[["What size is a standard business card?","Standard size is 3.5 × 2 inches (89 × 51 mm)."],["What information should be on a business card?","Name, title, company, phone, email, website, and optionally social media handles."]]},
  "resume-builder":{title:"Free Resume Builder Online",desc:"Build a professional resume online with structured sections for experience, education and skills. Free, instant, ATS-friendly, and ready to download as a PDF.",howTo:"Fill in your contact info, summary, work experience, education, and skills section by section. The layout updates live as you type — download the finished resume as a PDF.",faq:[["How long should a resume be?","1 page for early career, 2 pages for experienced professionals. Keep it concise and relevant."],["What sections should a resume include?","Contact info, summary, experience, education, skills, and optionally certifications and projects."]]},
  "cover-letter-gen":{title:"Free Cover Letter Generator",desc:"Generate a tailored cover letter online for any job application — enter the role, company and your highlights. Free, instant, and ready to download.",howTo:"Enter the job title, company name, and a few key qualifications you want to highlight, and the tool drafts a structured cover letter you can edit and download.",faq:[["How long should a cover letter be?","3-4 paragraphs, roughly 250-400 words. Keep it focused and specific to the role."],["Should I always include a cover letter?","Yes, unless the job posting explicitly says not to. It shows initiative and lets you highlight key qualifications."]]},
  "swot-gen":{title:"Free SWOT Analysis Generator",desc:"Create a 4-quadrant SWOT matrix online for strategic planning — Strengths, Weaknesses, Opportunities and Threats. Free, instant, and ready to export.",howTo:"Enter your points under each of the four quadrants — Strengths, Weaknesses, Opportunities, Threats — and the tool lays them out in a clean, exportable matrix.",faq:[["What is SWOT analysis?","SWOT stands for Strengths, Weaknesses, Opportunities, and Threats. It's a strategic planning framework."],["When should I use SWOT?","For business planning, competitive analysis, project evaluation, or personal career planning."]]},
  "marketing-plan-gen":{title:"Free Marketing Plan Generator",desc:"Build a structured marketing plan online covering goals, audience, budget, channels and KPIs. Free, instant, and ready to export as a document.",howTo:"Fill in your goals, target audience, budget, channels, and timeline section by section, and the tool assembles them into a structured marketing plan document.",faq:[["What should a marketing plan include?","Goals, target audience, budget, channels, timeline, KPIs, and competitive analysis."],["How often should I update my marketing plan?","Review quarterly and update annually, or whenever significant market changes occur."]]},
  "persona-gen":{title:"Free Buyer Persona Generator",desc:"Create detailed buyer persona profiles online — demographics, goals, pain points and behavior. Free, instant, and ready to share with your team.",howTo:"Fill in the persona's demographics, goals, pain points, and buying behavior, and the tool assembles them into a structured, shareable persona profile.",faq:[["What is a buyer persona?","A semi-fictional profile of your ideal customer based on research and data about demographics, behavior, and goals."],["How many personas should I create?","Most businesses need 3-5 personas to cover their main customer segments."]]},
  "utm-builder":{title:"Free UTM Campaign URL Builder",desc:"Build UTM-tagged campaign URLs online for accurate analytics tracking — source, medium, campaign and more. Free, instant, no signup required.",howTo:"Enter your destination URL and fill in the source, medium, campaign, and optional term/content fields, and the tool builds the complete UTM-tagged URL live.",faq:[["What are UTM parameters?","UTM (Urchin Tracking Module) parameters are tags added to URLs to track the effectiveness of marketing campaigns in analytics tools."],["Which UTM parameters are required?","utm_source, utm_medium, and utm_campaign are the essential three. utm_term and utm_content are optional."]]},
  "ad-copy-gen":{title:"Free Ad Copy Generator",desc:"Generate persuasive ad copy online for Google, Facebook, Instagram and more, sized to each platform's limits. Free, instant, no signup required.",howTo:"Enter your product, key benefit, and target platform, and the tool generates ad copy options sized to that platform's character limits.",faq:[["What makes good ad copy?","Clear value proposition, emotional triggers, urgency, social proof, and a strong call-to-action."],["How long should ad copy be?","Google Ads: 30-90 characters per line. Facebook: under 125 characters primary text. Adapt to each platform."]]},
  "sales-copy-gen":{title:"Free Sales Copy Generator",desc:"Create compelling sales copy online using proven frameworks like AIDA and PAS. Free, instant, ready to paste into your page or email.",howTo:"Enter your product, audience, and main benefit, choose a copywriting framework like AIDA, and the tool drafts sales copy built around it.",faq:[["What is the AIDA framework?","Attention, Interest, Desire, Action — a proven copywriting framework that guides readers through a persuasion journey."],["What's the difference between sales copy and ad copy?","Sales copy is longer-form, focused on conversion. Ad copy is short, focused on clicks and attention."]]},
  "landing-copy-gen":{title:"Free Landing Page Copy Generator",desc:"Generate landing page sections online — hero, features, social proof and CTA — from your product details. Free, instant, ready to paste into your page.",howTo:"Enter your product name, main benefit, and key features, and the tool drafts a hero headline, feature bullets, and a CTA section ready to paste into your page.",faq:[["What sections does a landing page need?","Hero with headline, value proposition, features/benefits, social proof, FAQ, and a clear CTA."],["What is a good landing page conversion rate?","Average is 2-5%. Top performers hit 10%+. Focus on one clear CTA."]]},
  "roi-calculator":{title:"Free Marketing ROI Calculator",desc:"Calculate marketing return on investment online from your campaign cost and revenue generated. Free, instant, with a clear percentage result.",howTo:"Enter your total campaign cost and the revenue it generated, and the tool calculates your ROI percentage instantly.",faq:[["How is marketing ROI calculated?","ROI = ((Revenue - Cost) / Cost) × 100. It shows the percentage return on your marketing investment."],["What is a good marketing ROI?","A 5:1 ratio (500% ROI) is considered strong. 10:1 is exceptional. Below 2:1 is generally not profitable."]]},
  "break-even-calc":{title:"Free Break Even Calculator",desc:"Find your break-even point online in units and revenue from your fixed costs, price and variable cost. Free, instant, no signup required.",howTo:"Enter your fixed costs, selling price per unit, and variable cost per unit, and the tool calculates your break-even point in both units and revenue.",faq:[["What is the break-even point?","The point where total revenue equals total costs — no profit, no loss."],["How is break-even calculated?","Break-even units = Fixed Costs / (Selling Price - Variable Cost per Unit)."]]},
  "purchase-order-gen":{title:"Free Purchase Order Generator",desc:"Create purchase orders online with line items, tax and totals for your suppliers. Free, instant, and ready to download as a PDF.",howTo:"Enter your business and supplier details, add line items with quantities and prices, and set your tax rate. The tool totals everything — download the finished purchase order.",faq:[["What is a purchase order?","A purchase order (PO) is a buyer-issued document authorizing a purchase, listing items, quantities, agreed prices, and delivery details."],["How is a PO different from an invoice?","A purchase order is sent by the buyer to order goods. An invoice is sent by the seller to request payment for those goods."]]},
  "packing-slip-gen":{title:"Free Packing Slip Generator",desc:"Generate itemized packing slips online for shipments and orders — items, quantities and order details. Free, instant, ready to print or download.",howTo:"Enter the order details and list the items and quantities being shipped, and the tool assembles a printable packing slip ready to include with the shipment.",faq:[["What is a packing slip?","A packing slip is a document included with a shipment that lists the items and quantities being sent, but usually omits prices."],["Do I need a packing slip and an invoice?","A packing slip helps the recipient verify the contents of a shipment, while an invoice handles billing. Many businesses include both."]]},
  "timesheet-gen":{title:"Free Timesheet Generator",desc:"Build a weekly timesheet online with hours, overtime and pay calculated automatically. Free, instant, and ready to download or print for payroll.",howTo:"Enter the hours worked each day and the hourly rate, and the tool calculates regular hours, overtime at 1.5x, and gross pay for the week automatically.",faq:[["How is overtime calculated?","This tool treats hours over 40 in a week as overtime, paid at 1.5× the base rate by default. Regular hours are paid at the base rate."],["Can I use this for payroll?","It gives a clear breakdown of regular hours, overtime, and gross pay. Confirm figures against your local labor laws before payroll."]]},
  "expense-report-gen":{title:"Free Expense Report Generator",desc:"Create expense reports online with category breakdowns and totals for reimbursement. Free, instant, and ready to download as a PDF.",howTo:"Enter each expense with its date, category, description, and amount, and the tool totals them by category and produces a complete expense report.",faq:[["What should an expense report include?","Date, category, description, and amount for each expense, plus subtotals per category and an overall total for reimbursement."],["Can I group expenses by category?","Yes. This generator automatically totals each spending category (travel, meals, supplies, etc.) and sums the grand total."]]},
  "markup-margin-calc":{title:"Free Markup & Margin Calculator",desc:"Calculate markup, profit margin and selling price online from your cost and target numbers. Free, instant, with both directions supported.",howTo:"Enter your cost and either your selling price or your target margin, and the tool calculates the matching markup percentage, margin percentage, and price.",faq:[["What is the difference between markup and margin?","Markup is profit as a percentage of cost: (Price − Cost) / Cost. Margin is profit as a percentage of price: (Price − Cost) / Price."],["How do I set a price for a target margin?","Price = Cost / (1 − Margin%). This tool shows the required price for any target margin you enter."]]},
  "cagr-calc":{title:"Free CAGR Calculator",desc:"Compute compound annual growth rate online over any period from your start value, end value and years. Free, instant, no signup required.",howTo:"Enter your starting value, ending value, and the number of years between them, and the tool calculates the compound annual growth rate instantly.",faq:[["What is CAGR?","Compound Annual Growth Rate is the smoothed annual rate at which a value grows over multiple periods: (End/Start)^(1/Years) − 1."],["Why use CAGR instead of average growth?","CAGR accounts for compounding and gives a single, comparable annual rate, whereas a simple average can overstate volatile returns."]]},
  "clv-calc":{title:"Free Customer Lifetime Value Calculator",desc:"Estimate customer lifetime value online from order value, purchase frequency and margin data. Free, instant, no signup required.",howTo:"Enter your average order value, purchase frequency per year, customer lifespan, and gross margin percentage, and the tool calculates the customer lifetime value.",faq:[["How is customer lifetime value calculated?","LTV = Average Order Value × Purchase Frequency (per year) × Customer Lifespan (years) × Gross Margin %."],["Why does CLV matter?","CLV tells you how much revenue a customer generates over time, so you can set a sensible customer acquisition cost (CAC) budget."]]},
  "business-hours-gen":{title:"Free Business Hours Schema Generator",desc:"Generate schema.org opening-hours JSON-LD online for local SEO from your weekly hours. Free, instant, ready to paste into your site.",howTo:"Enter your opening and closing time for each day of the week, and the tool generates the matching schema.org openingHoursSpecification JSON-LD to paste into your page.",faq:[["What is opening-hours structured data?","It is schema.org JSON-LD markup that tells Google your open and close times, helping your hours appear in search and maps."],["Where do I put the generated code?","Paste the JSON-LD script into the <head> of your website's homepage or contact page so search engines can read it."]]},
  "meeting-agenda-gen":{title:"Free Meeting Agenda Generator",desc:"Build a structured meeting agenda online with timed discussion items and owners. Free, instant, and ready to share before your meeting.",howTo:"Enter your meeting objective, attendees, and discussion items with a time allotment and owner for each, and the tool assembles a structured, timed agenda.",faq:[["What makes a good meeting agenda?","A clear objective, timed discussion topics with an owner for each, attendee list, and a defined start and end time to keep things focused."],["How long should each agenda item be?","Assign realistic time blocks. This tool sums the minutes so you can keep the total within your scheduled meeting length."]]},
  "memo-gen":{title:"Free Business Memo Generator",desc:"Create a formatted business memorandum online with the standard TO/FROM/DATE/SUBJECT header. Free, instant, ready to download or print.",howTo:"Fill in the To, From, Date, and Subject fields and your message body, and the tool formats it into a standard business memo ready to download.",faq:[["What is a business memo?","A memorandum is a short internal document with a standard TO / FROM / DATE / SUBJECT header used to share information within an organization."],["How long should a memo be?","Keep it concise — usually under one page. State the purpose in the first line and end with any required action."]]},
  "press-release-gen":{title:"Free Press Release Generator",desc:"Draft a professional press release online from a few key details — headline, dateline and quote. Free, instant, ready to send to media.",howTo:"Enter your headline, dateline, key announcement details, and a quote, and the tool drafts a structured press release with a boilerplate section.",faq:[["What is the structure of a press release?","Headline, dateline (city and date), an opening paragraph answering who/what/when/where/why, supporting body, a quote, and boilerplate."],["What is a boilerplate?","A short standard paragraph about your company placed at the end of every press release describing what your organization does."]]},
  "job-description-gen":{title:"Free Job Description Generator",desc:"Generate a structured job description online for any role — responsibilities, qualifications and how to apply. Free, instant, ready to post.",howTo:"Enter the job title, key responsibilities, and required qualifications, and the tool assembles a structured job description ready to post.",faq:[["What should a job description include?","Job title, company overview, responsibilities, required qualifications, preferred skills, location, employment type, and how to apply."],["How do I write an effective job description?","Use clear, inclusive language, list concrete responsibilities, and separate must-have requirements from nice-to-have skills."]]},
